...
docker pull ghcr.io/gvenzl/oracle-xe:18.4.0
...
docker run --rm -p 1521:1521 --name geotools -h geotools -e ORACLE_PASSWORD=oracle -d ghcr.io/gvenzl/oracle-xe:18.4.0
