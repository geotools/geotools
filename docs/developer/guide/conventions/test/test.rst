...
We have isolated long running tests so they are not part of the day to day grind. You can use a maven profile to increase the amount of testing performed.
