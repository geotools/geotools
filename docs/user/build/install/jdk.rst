...
GeoTools 34.x built with Java 17 can only be used in a Java 17 environment (and is not compatible with Java 11). Each jar includes an automatic module name for use on the Java 17 module path.
...
.. note:: 
   ...
   \*\* Eclipse Adoptium provides free updates as long as upstream OpenJDK 17 is actively maintained (expected through 2029).
