...
+-------+------------------------------------------------+-----------------------+
| 1.    | Define an interface                            | Foo                   |
+-------+------------------------------------------------+-----------------------+
| 2.    | Define factory interface                       | FooFactory            |
+-------+------------------------------------------------+-----------------------+
| 3.    | Define FactoryFinder                           | FooFactoryFinder      |
+-------+------------------------------------------------+-----------------------+
| 4.    | Define an Abstract class for implementors      | AbstractFoo           |
+-------+------------------------------------------------+-----------------------+
|       | **To allow client code access to plug-ins**    |                       |
+-------+------------------------------------------------+-----------------------+
| 1.    | Make your FactoryFinder public                 | FooFinder             |
+-------+------------------------------------------------+-----------------------+
|       | **When implementing a Plugin**                 |                       |
+-------+------------------------------------------------+-----------------------+
| 1.    | Create you extention                           | MyFoo                 |
+-------+------------------------------------------------+-----------------------+
| 2.    | Create you extension factory                   | MyFooFactory          |
+-------+------------------------------------------------+-----------------------+
| 3.    | Register with META-INF/services                | META-INF/services/Foo |
+-------+------------------------------------------------+-----------------------+
