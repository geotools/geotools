...
/**
 * This is to test functions that convert numeric values to geometry types. This is required when the data store doesn't
 * have geometry columns, but geometry types are needed.
 *
