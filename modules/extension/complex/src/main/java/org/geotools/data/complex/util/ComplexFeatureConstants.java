...
public class ComplexFeatureConstants {
    ...
    /**
     * Static attribute descriptor used to link different feature types. This attribute won't appear in the output
     * document as it doesn't exist in the schema. Specifying the index would allow more than one instances to be used
     * in one type that can be chained by different parent feature types.
     */
     ...
     *
     * <p>The constant represents to the local part of the qualified attribute name; the namespace URI is generated at
     * runtime and will be the same as the namespace URI of the feature containing the geometry attribute.
     */
    ...
    /**
     * User data key to indicate the specified attribute index in the mapping file for the case of multi-valued
     * properties, e.g. gml:name[2]
     */
