...
/**
 * Contructs a graph based on relationships between the entities (objects) modelled by the graph. <br>
 * <br>
 * The underlying graph is generated by continually adding objects to the generator. The Generator determines the
 * relationships between the objects and decides how to model the relationship and the objects themselves in the graph.
 * <br>
 * <br>
 * The GraphGenerator is the upper level of the graph construction process. It is a wrapper around the GraphBuilder
 * class that is intended to instruct the builder how to build the underyling graph structure.
 *
 * @see GraphBuilder
