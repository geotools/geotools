...
public class PriorityQueue implements Collection, Queue {
    ...
    public Object extract() {
        if (m_count == 0) throw new NoSuchElementException("Heap empty.");
    ...
    public void update(Object value) {
        ...
        if (index != null) update(index.intValue());
    }
    ...
    public Object[] toArray(Object[] a) {
        if (a.length < m_values.length)
            a = (Object[]) Array.newInstance(a.getClass().getComponentType(), m_values.length);
