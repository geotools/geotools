...
public class DepthFirstIteratorTest extends TestCase {
   ...
   * <br>
   * <br>
   * Expected: 1. Every node should be visited. 2. Nodes should be visited in
   * order.
   */
  public void test_0() {
    int nnodes = 100;
   ...
   *
   * <p>
   * Expected: After suspend: 1. Every node of with an id greater than the id of
   * the suspending node should not be visited. After continue: 1. First node
   * visited after continue should have id = id + suspend node + 1 2. Every node
   * should be visited.
   */
  public void test_1() {
    int nnodes = 100;
   ...
   *
   * <p>
   * Expected: After kill: 1. Every node of with an id greater than the id of
   * the killing node should not be visited. After continue: 2. No more nodes
   * should be visited.
   */
  public void test_2() {
    int nnodes = 100;
   ...
   * <br>
   * <br>
   * Expected: 1. Every node should be visited. 2. For each node, every node in
   * one of its two subtrees should have been visited before every node in the
   * other subtree.
   */
  public void test_3() {
    int k = 4;
   ...
   * child). Then continue the traversal. <br>
   * <br>
   * Expected: After suspend: 1. Only root and first non root should be visited.
   *
   * <p>
   * After continue: 1. First node visited should be child of suspending node.
   ...
   * Then continue the traversal. <br>
   * <br>
   * Expected: After kill: 1. All nodes should be visited except for sub nodes
   * of first child of root visited. (the kill node)
   *
   * <p>
   * After continue: 1. Same as after kill.
   */
  public void test_5() {
    int k = 4;
    Object[] obj = GraphTestUtil.buildPerfectBinaryTree(builder(), k);
