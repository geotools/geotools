 ...
 * <p>
 *
 * <p>Image loading is an important performance factor to tile clients. Tests have shown that image loading is more
 * important than image rendering. The risk is, however, to fill your disk with tile images, so make sure to empty the
 * directory from time to time. Also note that some tile service may not allow you to save tile locally. If you do so,
 * you might be breaching licenses. So, be nice.
 *
 * @author Ugo Taddei
 * @since 12
 */
