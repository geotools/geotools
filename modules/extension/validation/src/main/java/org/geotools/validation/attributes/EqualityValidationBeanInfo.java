        ...
        try {
            pd[i] =
                    createPropertyDescriptor(
                            "attributeName", EqualityValidation.class, resourceBundle);
            pd[i].setExpert(false);
            pd[i + 1] =
                    createPropertyDescriptor("expected", EqualityValidation.class, resourceBundle);
            pd[i + 1].setExpert(false);
            pd[i + 2] =
                    createPropertyDescriptor("filter", EqualityValidation.class, resourceBundle);
