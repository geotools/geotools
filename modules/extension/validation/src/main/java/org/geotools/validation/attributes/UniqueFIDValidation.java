 ...
 *
 * <p>Please note that featureIDs are not attributes. Attributes may be checked with the
 * UniquityValidation class.
 *
 * <p>The FeatureTypes it checks against are defined by typeNames[]. If a duplicate ID is detected,
 * an error message returned via a Validation Result used as a visitor in the validation() method.
 *
 * <p>Example Use:
 *
 * <pre><code>
...
public class UniqueFIDValidation extends DefaultIntegrityValidation {
     ...
     *
     * <p>An empty constructor placed here for Java Beans
     */
