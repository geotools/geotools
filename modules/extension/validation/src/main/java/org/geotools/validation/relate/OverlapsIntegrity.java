 ...
 *     <p>If only one layer is provided, the geometries of that layer are compared with each other.
 *     If two layers are provided, then the geometries are compared across the layers. <b>Usage:</b>
 *     <br>
...
public class OverlapsIntegrity extends RelationIntegrity {
     ...
     *
     * <p>This validation tests for a geometry overlaps another geometry. Uses JTS'
