 ...
 *
 * <p>Tests to see if a LineString is made of only one segment, meaning it only has two points. If
 * the LineString has more than two points, the test fails.
 *
 * <p>This method has been extended to work with MultiLineStrings - this is the most common format
 * that shapefile appears in and as such is forcing our hand.
 *
 * <p>Example Use:
 *
 * <pre><code>
