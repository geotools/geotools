 ...
 *
 * <p>Tests to see if a geometry crosses itself. It does not detect if a segment of a LineString
 * doubles back on itself for one segment, then terminates. A different validation is needed to test
 * overlapping. Uses JTS' crosses routine.
 *
 * <p>Example Use:
 *
 * <pre><code>
...
public class LineNoSelfIntersectValidation extends DefaultFeatureValidation {
     ...
     *
     * <p>Sets the priority level of this validation. This is set by the programmer and is a measure
     * of the expense of this plugin
     *
     ...
     * Override validate.
     *
     * <p>Tests to see if a geometry intersects itself. It does not detect if a segment of a
     * LineString doubles back on itself for one segment, then terminates. A different validation is
     * needed to test overlapping. Uses JTS' intersect routine.
     *
