 ...
 *
 * <p>Tests to see if a LineString overlaps itself. It does this by breaking up the LineString into
...
public class LineNoSelfOverlappingValidation extends DefaultFeatureValidation {
     ...
     *
     * <p>It does this by breaking up the LineString into two point segments then intersects them
