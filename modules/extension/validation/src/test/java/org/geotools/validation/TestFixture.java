 ...
 *
 * <p>For geoserver developers this environment is similar to confDemo. Where possible names have
 * been forced to agree with geoserver.
 *
 * <p>In the interests of saving space the contents of confDemo have been reduced to:
 *
 * <ul>
...
public class TestFixture {
     ...
     *
     * <p>The shapefiles are copied into MemoryDataStores - allowing tests to be more abusive.
     */
