...
public class WMSLayerCrsTest {
    ...
    /**
     * We test the layer declared native CRS is returned as first item on getSrs() and getBoundinboxes() method. This
     * makes the cascaded WMS layers use by default the declared native CRS form the source WMS layer.
     */
    @Test
