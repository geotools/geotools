...
public class WMTSCapabilitiesTest extends TestCase {
    ...
    // This particular capabilities response does not contain a ServiceProvider section
    // or a ServiceIdentifier section. Make sure things still work
    public void testParser5() throws Exception {
        WMTSCapabilities capabilities = createCapabilities("noServiceIDsection.xml");
        try {
            assertNull(capabilities.getVersion());
