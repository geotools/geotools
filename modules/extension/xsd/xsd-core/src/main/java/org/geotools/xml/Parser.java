 ...
 *
 * See {@link org.geotools.xml.Configuration} javadocs for instructions on how to customize schema
 * resolution. This is often desirable in the case that the instance document being parsed contains
...
public class Parser {
     ...
     * error. Otherise the error will be stored, retreivable from {@link #getValidationErrors()}.
     *
