 ...
 * execution mode as {@link org.geotools.xml.Binding#OVERRIDE}. Therefore it must process the raw
 * text of the instance being parsed, and transform it into the specific object, in this case an
 * object of type BigDecimal.
 *
 * <p>The integer strategy extends the decimal strategy as it declares its execution mode as {@link
 * org.geotools.xml.Binding#AFTER}. Therefore the integer strategy has access to the result of the
 * decimal strategy, and can simply transform the result of the decimal strategy into its specific
