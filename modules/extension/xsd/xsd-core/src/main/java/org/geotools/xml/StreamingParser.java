 ...
 *
 * <p>Performs the same task as {@link org.geotools.xml.Parser}, with the addition that objects are
 * streamed back to the client. Streaming can occur in a number of different modes.
 *
