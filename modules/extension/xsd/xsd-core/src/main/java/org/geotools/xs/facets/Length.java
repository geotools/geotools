 ...
 * </ul>
 *
 * This is xml so length string applies to datatypes derrived from string. Simon the spec says:
 * <quote> For string and datatypes ???derived??? from string, length will not always coincide with
 * "string length" as perceived by some users or with the number of storage units in some digital
 * representation. Therefore, care should be taken when specifying a value for length and in
 * attempting to infer storage requirements from a given value for length. </quote>
 *
 * <p>Example:
 *
 * <pre><code>
...
public abstract class Length {
     ...
     *
     * <p>So if you are checking a custom object please pass in an Integer representing the size of
     * your object.
     */
