...
public class CSWConfiguration extends Configuration {
    ...
    protected void registerBindings(Map<QName, Object> bindings) {
         ...
         * bindings.put(CSW.DescribeRecordResponse, new ComplexEMFBinding(Csw20Factory.eINSTANCE,
         * CSW.DescribeRecordResponse)); bindings.put(CSW.ElementSetName, new ComplexEMFBinding(Csw20Factory.eINSTANCE,
         * CSW.ElementSetName)); bindings.put(CSW.GetCapabilities, new ComplexEMFBinding(Csw20Factory.eINSTANCE,
         * CSW.GetCapabilities)); bindings.put(CSW.GetDomain, new ComplexEMFBinding(Csw20Factory.eINSTANCE,
         * CSW.GetDomain)); bindings.put(CSW.GetDomainResponse, new ComplexEMFBinding(Csw20Factory.eINSTANCE,
         * CSW.GetDomainResponse)); bindings.put(CSW.GetRecordById, new ComplexEMFBinding(Csw20Factory.eINSTANCE,
         * CSW.GetRecordById)); bindings.put(CSW.GetRecordByIdResponse, new ComplexEMFBinding(Csw20Factory.eINSTANCE,
         * CSW.GetRecordByIdResponse)); bindings.put(CSW.GetRecords, new ComplexEMFBinding(Csw20Factory.eINSTANCE,
         * CSW.GetRecords)); bindings.put(CSW.GetRecordsResponse, new ComplexEMFBinding(Csw20Factory.eINSTANCE,
         * CSW.GetRecordsResponse)); bindings.put(CSW.Harvest, new ComplexEMFBinding(Csw20Factory.eINSTANCE,
         * CSW.Harvest)); bindings.put(CSW.HarvestResponse, new ComplexEMFBinding(Csw20Factory.eINSTANCE,
         * CSW.HarvestResponse)); bindings.put(CSW.Query, new ComplexEMFBinding(Csw20Factory.eINSTANCE, CSW.Query));
