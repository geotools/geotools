...
public class GMXSchema extends SchemaImpl {
    ...
    private static ComplexType build_ANCHOR_TYPE_TYPE() {
        ComplexType builtType =
                new AbstractLazyComplexTypeImpl(
                        new NameImpl("http://www.isotc211.org/2005/gmx", "Anchor_Type"), false, false, null, null) {
                    @Override
                    public AttributeType buildSuper() {
                ...
                new AbstractLazyComplexTypeImpl(
                    ...
                    public Collection<PropertyDescriptor> buildDescriptors() {
                        ...
                        descriptors.add(new AttributeDescriptorImpl(
                                ...
                                null));
                        descriptors.add(new AttributeDescriptorImpl(
                                XSSchema.ANYURI_TYPE, new NameImpl("codeSpace"), 0, 1, true, null));
                        return descriptors;
                    }
                };
        return builtType;
                ...
                new AbstractLazyComplexTypeImpl(
                    ...
                    public Collection<PropertyDescriptor> buildDescriptors() {
                        ...
                        descriptors.add(new AttributeDescriptorImpl(
                                ...
                                null));
                        descriptors.add(new AttributeDescriptorImpl(
                                GMLSchema.AGGREGATIONTYPE_TYPE, new NameImpl("aggregationType"), 0, 1, true, null));
                        descriptors.add(new AttributeDescriptorImpl(
                                XSSchema.ANYURI_TYPE, new NameImpl("codeSpace"), 0, 1, true, null));
                        return descriptors;
                    }
    ...
    private static ComplexType build_CRSALT_TYPE_TYPE() {
        ComplexType builtType =
                new AbstractLazyComplexTypeImpl(
                        new NameImpl("http://www.isotc211.org/2005/gmx", "CrsAlt_Type"), false, false, null, null) {
                    @Override
                    public AttributeType buildSuper() {
    ...
    private static ComplexType build_DATUMALT_TYPE_TYPE() {
        ComplexType builtType =
                new AbstractLazyComplexTypeImpl(
                        new NameImpl("http://www.isotc211.org/2005/gmx", "DatumAlt_Type"), false, false, null, null) {
                    @Override
                    public AttributeType buildSuper() {
    ...
    private static ComplexType build_FILENAME_TYPE_TYPE() {
        ComplexType builtType =
                new AbstractLazyComplexTypeImpl(
                        new NameImpl("http://www.isotc211.org/2005/gmx", "FileName_Type"), false, false, null, null) {
                    @Override
                    public AttributeType buildSuper() {
                        return XSSchema.STRING_TYPE;
                    }
                    ...
                    public Collection<PropertyDescriptor> buildDescriptors() {
                        List<PropertyDescriptor> descriptors = new ArrayList<>();
                        descriptors.add(new AttributeDescriptorImpl(
                                XSSchema.ANYURI_TYPE, new NameImpl("src"), 0, 1, true, null));
                        return descriptors;
                    }
                };
        return builtType;
    ...
    private static ComplexType build_ML_POLARCS_TYPE_TYPE() {
        ComplexType builtType =
                new AbstractLazyComplexTypeImpl(
                        new NameImpl("http://www.isotc211.org/2005/gmx", "ML_PolarCS_Type"), false, false, null, null) {
                    @Override
                    public AttributeType buildSuper() {
    ...
    private static ComplexType build_ML_TIMECS_TYPE_TYPE() {
        ComplexType builtType =
                new AbstractLazyComplexTypeImpl(
                        new NameImpl("http://www.isotc211.org/2005/gmx", "ML_TimeCS_Type"), false, false, null, null) {
                    @Override
                    public AttributeType buildSuper() {
    ...
    private static ComplexType build_MX_DATASET_TYPE_TYPE() {
        ComplexType builtType =
                new AbstractLazyComplexTypeImpl(
                        new NameImpl("http://www.isotc211.org/2005/gmx", "MX_DataSet_Type"), false, false, null, null) {
                    @Override
                    public AttributeType buildSuper() {
        ...
        ComplexType builtType =
                new AbstractLazyComplexTypeImpl(
                    ...
                    public Collection<PropertyDescriptor> buildDescriptors() {
                        List<PropertyDescriptor> descriptors = new ArrayList<>();
                        descriptors.add(new AttributeDescriptorImpl(
                                XSSchema.STRING_TYPE, new NameImpl("type"), 0, 1, true, null));
                        return descriptors;
                    }
                };
        return builtType;
