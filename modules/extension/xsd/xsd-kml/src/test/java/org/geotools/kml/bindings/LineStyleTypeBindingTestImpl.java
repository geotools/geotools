...
public class LineStyleTypeBindingTestImpl extends KMLTestSupport {
    @Test
    public void testType() {
        assertEquals(LineSymbolizerImpl.class, binding(KML.LineStyleType).getType());
    }
