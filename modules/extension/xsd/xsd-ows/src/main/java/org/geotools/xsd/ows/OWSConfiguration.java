...
public class OWSConfiguration extends Configuration {
    ...
    protected final void registerBindings(MutablePicoContainer container) {
        ...
        container.registerComponentInstance(
                OWS.AcceptVersionsType, new ComplexEMFBinding(Ows10Factory.eINSTANCE, OWS.AcceptVersionsType));
        ...
        container.registerComponentInstance(
                OWS.BoundingBoxType, new BoundingBoxTypeBinding(Ows10Factory.eINSTANCE, OWS.BoundingBoxType));
        container.registerComponentImplementation(OWS.CapabilitiesBaseType, CapabilitiesBaseTypeBinding.class);
        container.registerComponentInstance(
                OWS.CodeType, new SimpleContentComplexEMFBinding(Ows10Factory.eINSTANCE, OWS.CodeType));
        ...
        container.registerComponentImplementation(OWS._ExceptionReport, _ExceptionReportBinding.class);
        ...
        container.registerComponentImplementation(OWS._OperationsMetadata, _OperationsMetadataBinding.class);
        container.registerComponentImplementation(OWS._ServiceIdentification, _ServiceIdentificationBinding.class);
        container.registerComponentImplementation(OWS._ServiceProvider, _ServiceProviderBinding.class);
    }
}
