...
public class SLDFillBindingTestImpl extends SLDTestSupport {
    @Test
    public void testType() throws Exception {
        assertEquals(FillImpl.class, new SLDFillBinding(null, null).getType());
    }
