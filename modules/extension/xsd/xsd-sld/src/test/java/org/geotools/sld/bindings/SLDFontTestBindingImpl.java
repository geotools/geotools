...
public class SLDFontTestBindingImpl extends SLDTestSupport {
    @Test
    public void testType() throws Exception {
        assertEquals(FontImpl.class, new SLDFontBinding(null, null).getType());
    }
