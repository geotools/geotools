...
public class SLDHaloBindingTestImpl extends SLDTestSupport {
    @Test
    public void testType() throws Exception {
        assertEquals(HaloImpl.class, new SLDHaloBinding(null, null).getType());
    }
