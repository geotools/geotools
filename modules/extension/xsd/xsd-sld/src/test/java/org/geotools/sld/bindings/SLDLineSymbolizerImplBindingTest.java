...
public class SLDLineSymbolizerImplBindingTest extends SLDTestSupport {
    @Test
    public void testType() throws Exception {
        assertEquals(LineSymbolizerImpl.class, new SLDLineSymbolizerBinding(null).getType());
    }
    ...
    public void test() throws Exception {
        ...
        LineSymbolizerImpl lineSymbolizer = (LineSymbolizerImpl) parse();
