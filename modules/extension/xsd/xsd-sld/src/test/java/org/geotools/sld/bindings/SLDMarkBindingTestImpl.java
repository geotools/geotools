...
public class SLDMarkBindingTestImpl extends SLDTestSupport {

    @Test
    public void testType() throws Exception {
        assertEquals(MarkImpl.class, new SLDMarkBinding(null, null, null).getType());
    }
