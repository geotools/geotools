...
public class SLDPointSymbolizerImplBindingTest extends SLDTestSupport {
    @Test
    public void testType() throws Exception {
        assertEquals(PointSymbolizerImpl.class, new SLDPointSymbolizerBinding(null).getType());
    }
    ...
    public void test() throws Exception {
        ...
        PointSymbolizerImpl ps = (PointSymbolizerImpl) parse();
        assertNotNull(ps);
