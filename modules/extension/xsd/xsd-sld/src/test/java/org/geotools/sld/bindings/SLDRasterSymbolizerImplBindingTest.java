...
public class SLDRasterSymbolizerImplBindingTest extends SLDTestSupport {
    @Test
    public void testType() throws Exception {
        assertEquals(RasterSymbolizerImpl.class, new SLDRasterSymbolizerBinding(null).getType());
    }
    ...
    public void test() throws Exception {
        ...
        RasterSymbolizerImpl rs = (RasterSymbolizerImpl) parse();
        assertNotNull(rs);
