...
/**
 * &lt;complexType name="ComplexDataType" mixed="true"> &lt;annotation>
 * &lt;documentation>Complex data (such as an image), including a definition of
 * the complex value data structure (i.e., schema, format, and encoding). May be
 * an ows:Manifest data structure.&lt;/documentation> &lt;/annotation>
 * &lt;complexContent mixed="true"> &lt;extension base="anyType">
 * &lt;attributeGroup ref="wps:ComplexDataEncoding"/> &lt;/extension>
