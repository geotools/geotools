...
/**
 * A function from a spatial, temporal or spatiotemporal domain to an attribute range. A coverage associates a
 * {@linkplain Position position} within its domain to a record of values of defined data types. Examples include a
 * raster image, polygon overlay, or digital elevation matrix. The essential property of coverage is to be able to
 * generate a value for any point within its domain. How coverage is represented internally is not a concern.
 *
 ...
 *   <li>A coverage may be represented by a grid of values (a {@linkplain DiscreteGridPointCoverage Discrete Grid Point
 *       Coverage}). If the coverage is a {@linkplain ContinuousQuadrilateralGridCoverage Continuous Quadrilateral Grid
 *       Coverage} using {@linkplain InterpolationMethod#NEAREST_NEIGHBOUR Nearest Neighbour} interpolation method, then
 *       the value returned by the coverage for a point is that of the grid value whose location is nearest the point.
...
public interface Coverage {
    ...
    /**
     * Return the value vector for a given point in the coverage. A value for each sample dimension is included in the
     * vector. The default interpolation type used when accessing grid values for points which fall between grid cells
     * is nearest neighbor.
     *
     * <p>The coordinate reference system of the point is the same as the grid coverage coordinate reference system
     * (specified by the {@link #getCoordinateReferenceSystem} method).
     *
     * <p><strong>WARNING:</strong> This method is inherited from the legacy OGC 01-004 specification and may be
     * deprecated in a future version. We are for more experience and feedbacks on the value of this method.
     *
     * @param point Point at which to find the grid values.
     * @return The value vector for a given point in the coverage.
     * @throws PointOutsideCoverageException if the point is outside the coverage {@linkplain #getEnvelope envelope}.
     * @throws CannotEvaluateException If the point can't be evaluated for some other reason.
    ...
    /**
     * Return a sequence of boolean values for a given point in the coverage. A value for each sample dimension is
     * included in the sequence. The default interpolation type used when accessing grid values for points which fall
     * between grid cells is nearest neighbor.
     *
     * <p>The coordinate reference system of the point is the same as the grid coverage coordinate reference system
     * (specified by the {@link #getCoordinateReferenceSystem} method).
     *
     * @param point Point at which to find the coverage values.
     * @param destination An optionally preallocated array in which to store the values, or {@code null} if none.
     * @return A sequence of boolean values for a given point in the coverage. If {@code destination} was non-null, then
     *     it is returned. Otherwise, a new array is allocated and returned.
     * @throws PointOutsideCoverageException if the point is outside the coverage {@linkplain #getEnvelope envelope}.
     * @throws CannotEvaluateException if the point can't be evaluated for some othe reason.
     * @throws ArrayIndexOutOfBoundsException if the {@code destination} array is not null and too small to hold the
     *     output.
     */
    ...
    /**
     * Return a sequence of unsigned byte values for a given point in the coverage. A value for each sample dimension is
     * included in the sequence. The default interpolation type used when accessing grid values for points which fall
     * between grid cells is nearest neighbor.
     *
     * <p>The coordinate reference system of the point is the same as the grid coverage coordinate reference system
     ...
     * @param point Point at which to find the coverage values.
     * @param destination An optionally preallocated array in which to store the values, or {@code null} if none.
     * @return A sequence of unsigned byte values for a given point in the coverage. If {@code destination} was
     *     non-null, then it is returned. Otherwise, a new array is allocated and returned.
     * @throws PointOutsideCoverageException if the point is outside the coverage {@linkplain #getEnvelope envelope}.
     * @throws CannotEvaluateException if the point can't be evaluated for some othe reason.
     * @throws ArrayIndexOutOfBoundsException if the {@code destination} array is not null and too small to hold the
     *     output.
    ...
    /**
     * Return a sequence of integer values for a given point in the coverage. A value for each sample dimension is
     * included in the sequence. The default interpolation type used when accessing grid values for points which fall
     * between grid cells is nearest neighbor.
     *
     * <p>The coordinate reference system of the point is the same as the grid coverage coordinate reference system
     ...
     * @param point Point at which to find the grid values.
     * @param destination An optionally preallocated array in which to store the values, or {@code null} if none.
     * @return A sequence of integer values for a given point in the coverage. If {@code destination} was non-null, then
     *     it is returned. Otherwise, a new array is allocated and returned.
     * @throws PointOutsideCoverageException if the point is outside the coverage {@linkplain #getEnvelope envelope}.
     * @throws CannotEvaluateException if the point can't be evaluated for some othe reason.
     * @throws ArrayIndexOutOfBoundsException if the {@code destination} array is not null and too small to hold the
    ...
    /**
     * Return a sequence of float values for a given point in the coverage. A value for each sample dimension is
     * included in the sequence. The default interpolation type used when accessing grid values for points which fall
     * between grid cells is nearest neighbor.
     *
     * <p>The coordinate reference system of the point is the same as the grid coverage coordinate reference system
     ...
     * @param point Point at which to find the grid values.
     * @param destination An optionally preallocated array in which to store the values, or {@code null} if none.
     * @return A sequence of float values for a given point in the coverage. If {@code destination} was non-null, then
     *     it is returned. Otherwise, a new array is allocated and returned.
     * @throws PointOutsideCoverageException if the point is outside the coverage {@linkplain #getEnvelope envelope}.
     * @throws CannotEvaluateException if the point can't be evaluated for some othe reason.
     * @throws ArrayIndexOutOfBoundsException if the {@code destination} array is not null and too small to hold the
    ...
    /**
     * Return a sequence of double values for a given point in the coverage. A value for each sample dimension is
     * included in the sequence. The default interpolation type used when accessing grid values for points which fall
     * between grid cells is nearest neighbor.
     *
     * <p>The coordinate reference system of the point is the same as the grid coverage coordinate reference system
     ...
     * @param point Point at which to find the grid values.
     * @param destination An optionally preallocated array in which to store the values, or {@code null} if none.
     * @return A sequence of double values for a given point in the coverage. If {@code destination} was non-null, then
     *     it is returned. Otherwise, a new array is allocated and returned.
     * @throws PointOutsideCoverageException if the point is outside the coverage {@linkplain #getEnvelope envelope}.
     * @throws CannotEvaluateException If the point can't be evaluated for some othe reason.
     * @throws ArrayIndexOutOfBoundsException if the {@code destination} array is not null and too small to hold the
    ...
    /**
     * Returns the sources data for a coverage. This is intended to allow applications to establish what
     * {@code Coverage}s will be affected when others are updated, as well as to trace back to the "raw data".
     *
     * <p>This implementation specification does not include interfaces for creating collections of coverages therefore
     * the list size will usually be one indicating an adapted grid coverage, or zero indicating a raw grid coverage.
     *
     * <p><strong>WARNING:</strong> This method is inherited from the legacy OGC 01-004 specification and may be
     * deprecated in a future version. We are for more experience and feedbacks on the value of this method.
     *
     ...
     * {@link org.geotools.api.coverage.grid.GridCoverage} backed by a {@link java.awt.image.RenderedImage}, the
     * underlying image can be obtained with: <code>
