 ...
 *   <li>A coverage may be represented by a grid of values (a Discrete Grid Point Coverage). If the coverage is a
 *       Continuous Quadrilateral Grid Coverage using {@linkplain InterpolationMethod#NEAREST_NEIGHBOUR Nearest
 *       Neighbour} interpolation method, then the value returned by the coverage for a point is that of the grid value
 *       whose location is nearest the point.
