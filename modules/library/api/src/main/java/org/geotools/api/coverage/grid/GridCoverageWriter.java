 ...
 * through a call to {@link GridCoverageExchange#getWriter}. Grid coverages are usually added to the output stream in a
 * sequential order.
 *
...
public interface GridCoverageWriter {
    ...
    /**
     * Returns the output destination. This is the object passed to the {@link GridCoverageExchange#getWriter} method.
     * It can be a {@link java.lang.String}, an {@link java.io.OutputStream}, a {@link java.nio.channels.FileChannel},
     * etc.
     */
