...
public interface GridEnvelope {
    ...
    /**
     * Returns the minimal coordinate values for all grid points within the {@linkplain GridCoverage grid}.
     *
    ...
    /**
     * Returns the maximal coordinate values for all grid points within the {@linkplain GridCoverage grid}.
     *
