...
/**
 * Thrown to indicate that a {@code FeatureCollection} operation could not complete because of a failure in the backing
 * store, or a failure to contact the backing store. This exception is unchecked in order to allows its usage with the
 * Java collection framework. This exception usually have an {@link IOException} or a {@link SQLException} as its
 * {@linkplain #getCause cause}. The cause may also be a
