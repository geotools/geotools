 ...
 * See {@link Attribute#getID()}. The type of the attribute specifies wether it is identifiable or not
 * ({@link #isIdentified()}.
 *
...
public interface AttributeType extends PropertyType {
     ...
     * {@link Attribute#getID()} must return a value, and cannot be <code>
     * null</code>.
     *
