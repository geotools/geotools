...
/**
 * Filter operator that checks if an expression's value is {@code null}. A {@code null} is equivalent to no value
 * present. The value 0 is a valid value and is not considered {@code null}.
 *
