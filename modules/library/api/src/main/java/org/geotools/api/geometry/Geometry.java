...
public interface Geometry extends TransfiniteSet {
     ...
     * all {@linkplain org.geotools.api.geometry.primitive.Primitive primitive} elements and for all
     ...
     * subclasses of {@link org.geotools.api.geometry.aggregate.Aggregate}). This condition is
     ...
     * @see #getBoundary
     * @see #getBuffer
     * @see org.geotools.api.referencing.cs.CoordinateSystem#getAxis
     */
     ...
     * {@linkplain org.geotools.api.geometry.primitive.Surface surfaces} in 2D space and a
     * collection of {@linkplain org.geotools.api.geometry.primitive.Solid solids} in 3D space, but
     * this may be application defined.
     *
