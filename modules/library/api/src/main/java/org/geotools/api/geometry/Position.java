 ...
 * org.geotools.api.geometry.Geometry geometries}) that have references to {@linkplain
 ...
 *
 * <p><b>Note:</b> this interface does not extends {@link org.geotools.api.util.Cloneable} on
 * purpose, since {@code DirectPosition} implementations are most likely to be backed by references
 * to internal structures of the geometry containing this position. A direct position may or may not
 * be cloneable at implementor choice.
 *
