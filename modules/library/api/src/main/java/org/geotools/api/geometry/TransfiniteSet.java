...
public interface TransfiniteSet {
     ...
     * If the passed {@code TransfiniteSet} is a {@linkplain
     * org.geotools.api.geometry.primitive.Point point}, then this operation is the equivalent of a
     * set-element test for the {@linkplain DirectPosition direct position} of that point within
     * this {@code TransfiniteSet}.
     *
     * <blockquote>
     *
     * <font size=2> <strong>NOTE:</strong> {@code contains} is strictly a set theoretic
     * containment, and has no dimensionality constraint. In a {@linkplain
     * org.geotools.api.geometry.complex.Complex complex}, no {@linkplain
     * org.geotools.api.geometry.primitive.Primitive primitive} will contain another unless a
     * dimension is skipped. </font>
     *
     * </blockquote>
     *
     ...
     * TransfiniteSet}. Withing a {@linkplain org.geotools.api.geometry.complex.Complex complex},
     * the {@linkplain org.geotools.api.geometry.primitive.Primitive primitives} do not intersect
     * one another. In general, topologically structured data uses shared geometric objects to
     * capture intersection information.
     *
     * <blockquote>
     *
     * <font size=2> <strong>NOTE:</strong> This intersect is strictly a set theoretic common
     * containment of {@linkplain DirectPosition direct positions}. Two {@linkplain
     * org.geotools.api.geometry.primitive.Curve curves} do not intersect if they share a common end
     * point because {@linkplain org.geotools.api.geometry.primitive.Primitive primitives} are
     * considered to be open (do not contain their boundary). If two {@linkplain
     * org.geotools.api.geometry.complex.CompositeCurve composite curves} share a common end point,
     * then they intersect because {@linkplain org.geotools.api.geometry.complex.Complex complexes}
     * are considered to be closed (contain their boundary). </font>
     *
     * </blockquote>
     *
     ...
     * <blockquote>
     *
     * <font size=2> <strong>NOTE:</strong> Since an infinite set of direct positions cannot be
     ...
     * position in the passed {@code TransfiniteSet} and vice versa. </font>
     *
     * </blockquote>
     *
