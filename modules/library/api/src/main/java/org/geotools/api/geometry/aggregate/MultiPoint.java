 ...
 */
package org.geotools.api.geometry.aggregate;
...
/**
 * An aggregate class containing only instances of {@link Point}. The association role {@link
...
public interface MultiPoint extends MultiPrimitive {
    /**
     * Returns the set containing the elements that compose this {@code MultiPoint}. The set may be
