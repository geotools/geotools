 ...
 *
 * <p>A geometric complex can be thought of as a set in two distinct ways. First, it is a finite set
 ...
 *
 * <p>The "{@linkplain #getElements elements}" attribute allows {@code Complex} to inherit the
 * behavior of {@link Set Set&lt;Primitive&gt;} without confusing the same sort of behavior
 * inherited from {@link org.geotools.api.geometry.TransfiniteSet
 * TransfiniteSet&lt;DirectPosition&gt;} inherited through {@link Geometry}. Complexes shall be used
 * in application schemas where the sharing of geometry is important, such as in the use of
 * computational topology. In a complex, primitives may be aggregated many-to-many into composites
 * for use as attributes of features.
 *
...
public interface Complex extends Geometry {
    ...
    //    public org.geotools.api.topology.complex.TP_Complex topology[];
}
