...
public interface Composite extends Complex {
     ...
     * org.geotools.api.geometry.primitive.Point points} are included. Thus the {@code generators}
     * on {@code Composite} is a subset of the {@linkplain Complex#getElements elements} on
     * {@linkplain Complex complex}.
     *
