...
public interface CompositeCurve extends Composite, OrientableCurve {
    /**
     * Returns the list of orientable curves in this composite. To get a full representation of the
     * elements in the {@linkplain Complex complex}, the {@linkplain
     * org.geotools.api.geometry.primitive.Point points} on the boundary of the generator set of
     * {@linkplain org.geotools.api.geometry.primitive.Curve curve} would be added to the curves in
     * the generator list.
     *
