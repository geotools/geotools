...
/**
 * Common interface for {@linkplain org.geotools.api.geometry.primitive.Curve curve} and {@linkplain
 * org.geotools.api.geometry.primitive.CurveSegment curve segment}. {@code Curve} and {@code
...
public interface GenericCurve {
     ...
     * the boundary operator in {@link org.geotools.api.geometry.primitive.Primitive}, since it
     * returns only the values of this point, not representative objects.
     *
     ...
     * of a {@linkplain org.geotools.api.geometry.primitive.Curve curve} shall always be 0. For
     * {@linkplain org.geotools.api.geometry.primitive.CurveSegment curve segments} within a
     * {@linkplain org.geotools.api.geometry.primitive.Curve curve}, the start of the {@linkplain
     * org.geotools.api.geometry.primitive.CurveSegment curve segment} shall be equal to those of
     * the {@linkplain org.geotools.api.geometry.primitive.Curve curve} where this segment begins,
     ...
     * {@linkplain org.geotools.api.geometry.primitive.Curve curve} shall always be the arc length
     * of the curve. For {@linkplain org.geotools.api.geometry.primitive.CurveSegment curve
     * segments} within a {@linkplain org.geotools.api.geometry.primitive.Curve curve}, the end
     * parameters of the {@linkplain org.geotools.api.geometry.primitive.CurveSegment curve segment}
     * shall be equal to those of the {@linkplain org.geotools.api.geometry.primitive.Curve curve}
     * where this segment ends, so that the start parameter of any segment (except the first) shall
     * be equal to the end parameter of the previous segment.
     *
     ...
     * <blockquote>
     *
     * <font size=2> <strong>NOTE:</strong> Constructive parameters are often chosen for convenience
     ...
     * between a {@linkplain org.geotools.api.geometry.primitive.Curve curve} and its component
     * {@linkplain org.geotools.api.geometry.primitive.CurveSegment curve segments}. The most common
     * use of this operation is to expose the constructive equations of the underlying curve,
     * especially useful when that curve is used to construct a parametric surface.
     *
     ...
     * org.geotools.api.geometry.primitive.Curve curve}.
     *
     ...
     * segments) lie on this curve. If {@code maxSpacing} is given (not zero), then the distance
     * between control points along the generated curve shall be not more than {@code maxSpacing}.
     * If {@code maxOffset} is given (not zero), the distance between generated curve at any point
     * and the original curve shall not be more than the {@code maxOffset}. If both parameters are
     * set, then both criteria shall be met. If the original control points of the curve lie on the
     * curve, then they shall be included in the returned {@linkplain LineString line string}'s
     ...
     * <blockquote>
     *
     * <font size=2> <strong>NOTE:</strong> This function is useful in creating linear
     ...
     * about how the curves were constructed. </font>
     *
     * </blockquote>
     *
