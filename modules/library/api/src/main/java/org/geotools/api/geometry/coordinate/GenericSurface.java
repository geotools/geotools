...
/**
 * Common interface for {@linkplain org.geotools.api.geometry.primitive.Surface surface} and
 * {@linkplain org.geotools.api.geometry.primitive.SurfacePatch surface patch}. {@code Surface} and
 * {@code SurfacePatch} represent sections of surface geometry, and therefore share a number of
 ...
 *     difficulty with {@link org.geotools.api.coverage.Coverage}.
 */
...
public interface GenericSurface {
     ...
     * <blockquote>
     *
     * <font size=2> <strong>NOTE:</strong> The upNormal along a boundary of a solid always points
     ...
     * neutral concept of "interior" derived from mathematics (topology). </font>
     *
     * </blockquote>
     *
     ...
     * <blockquote>
     *
     * <font size=2> <strong>NOTE:</strong> The perimeter is defined as the sum of the lengths of
     ...
     * will contribute positively to the total perimeter. </font>
     *
     * </blockquote>
     *
