...
/**
 * Sequence of geodesic segments. The interface essentially combines a <code>
...
public interface GeodesicString extends CurveSegment {
     ...
     * using geodesics from the geoid or {@linkplain org.geotools.api.referencing.datum.Ellipsoid
     * ellipsoid} of the {@linkplain org.geotools.api.referencing.crs.CoordinateReferenceSystem
