 ...
 * <blockquote>
 *
 * c<sub>t</sub>(<var>s</var>) = c<sub>s</sub>(<var>t</var>) = {@code
 * surface}(<var>s</var>,<var>t</var>);
 *
 * </blockquote>
 *
 ...
 * </table>
 *
 * <p>The two partial derivatives of the surface parameterization, <b>i</b> and <b>j</b> are given
 * by:
 *
 * <blockquote>
 *
 ...
 * local coordinate axes given by &lt;<b>i</b>, <b>j</b>&gt;. A moving frame is defined to be a
 ...
 * <blockquote>
 *
 * <font size=2> <strong>NOTE:</strong> The existence of a viable moving frame is the definition of
 ...
 * space, but require 4D space for non-singular representations. </font>
 *
 * </blockquote>
 *
...
public interface ParametricCurveSurface extends SurfacePatch {
     ...
     * <blockquote>
     *
     * <font size=2> <strong>NOTE:</strong> The curve returned by this function or by the
