...
/**
 * A polynimal spline. An "<var>n</var><sup>th</sup> degree" polynomial spline shall be defined
 * piecewise as an <var>n</var>-degree polynomial, with up to C<sup><var>n</var>-1</sup> continuity
 ...
 * end point of the segment. {@link LineString} is equivalent to a 1<sup>st</sup> degree polynomial
 * spline. It has simple continuity at the {@linkplain #getControlPoints control points}
 * (C</sup>0</sup>), but does not require derivative information (degree - 2 = -1).
 *
 * <p>NOTE: The major difference between the polynomial splines and the b-splines (basis splines) is
...
public interface PolynomialSpline extends SplineCurve {
     ...
     *
     * <p>The {@linkplain List#size size} of the returned list is <code>
     * ({@linkplain #getDegree degree} - 2)</code>.
     */
