 ...
 * <code>c(t):(a,&nbsp;b) &rarr; E<sup>n</sup></code> where "t" is a real parameter and
 * E<sup>n</sup> is Euclidean space of dimension <var>n</var> (usually 2 or 3, as determined by the
 * coordinate reference system). Any other parameterization that results in the same image curve,
 * traced in the same direction, such as any linear shifts and positive scales such as <code>
 * e(t) = c(a&nbsp;+&nbsp;t(b-a)):(0,1) &rarr; E<sup>n</sup></code>,
 *
 * <p>is an equivalent representation of the same curve. For the sake of simplicity, {@code Curve}s
 ...
 * defined by <code>c(t):(a,&nbsp;b) &rarr; E<sup>n</sup></code> would be defined by a function of
 * the form <code>s(t) = c(a&nbsp;+&nbsp;b&nbsp;-&nbsp;t):(a,&nbsp;b) &rarr; E<sup>n</sup></code>.
 *
