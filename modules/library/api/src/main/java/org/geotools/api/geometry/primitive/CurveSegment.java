...
import org.geotools.api.geometry.coordinate.GenericCurve;
...
public interface CurveSegment extends GenericCurve {
    /**
     * Returns the curve which own this curve segment. This method is <em>optional</em> since the
     * association in ISO 19107 is navigable only from {@code Curve} to {@code CurveSegment}, not
     * the other way.
     *
     * <blockquote>
     *
     * <font size=2> <strong>NOTE:</strong> In the specification, curve segments do not appear
     ...
     * 19107 one to use curve segments in a more open-ended manner. </font>
     *
     * </blockquote>
     *
     ...
     * <blockquote>
     *
     * <font size=2> <strong>NOTE:</strong> Use of these values is only appropriate when the basic
     * curve definition is an underdetermined system. For example, line strings and segments cannot
     * support continuity above C<sup>0</sup>, since there is no spare control parameter to adjust
     ...
     * derivatives to support C<sup>1</sup> or higher continuity. </font>
     *
     * </blockquote>
     *
     ...
     * is referred to as "C<sup>0</sup>" in mathematical texts. A value of 1 means that the function
     * and its first derivative are continuous at the appropriate end point: "C<sup>1</sup>"
     * continuity. A value of "n" for any integer means the function and its first <var>n</var>
     * derivatives are continuous: "C<sup>n</sup>" continuity.
     *
     ...
     * <blockquote>
     *
     * <font size=2> <strong>NOTE:</strong> The above {@linkplain CurveBoundary curve boundary} will
     ...
     * org.geotools.api.geometry.complex.Complex complex}, will be represented as {@linkplain Point
     * points} in the same {@linkplain org.geotools.api.geometry.complex.Complex complex}. </font>
     *
     * </blockquote>
     *
