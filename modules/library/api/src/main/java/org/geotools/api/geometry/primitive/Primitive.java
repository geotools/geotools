 ...
 * of a primitive.
 *
 * <p>Any geometric object that is used to describe a feature is a collection of geometric
 ...
 * @since GeoAPI 1.0
 * @see PrimitiveFactory#createPrimitive(org.geotools.api.geometry.Envelope)
...
public interface Primitive extends Geometry {
     ...
     * applications to override the {@link org.geotools.api.geometry.TransfiniteSet
    ...
    /**
     * Returns the owner of this primitive. This method is <em>optional</em> since the association
    ...
    //    public org.geotools.api.topology.primitive.TP_Primitive topology[];
}
