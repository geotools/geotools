...
/**
 * Represents a single connected component of a {@linkplain SolidBoundary solid boundary}. A shell
 * consists of a number of references to {@linkplain OrientableSurface orientable surfaces}
 * connected in a topological cycle (an object whose boundary is empty). Unlike a {@linkplain Ring
