 ...
 * {@linkplain Obligation#OPTIONAL optional} arguments. The value must be non-null for {@linkplain Obligation#MANDATORY
 * mandatory} arguments.
 *
...
public interface CitationFactory extends Factory {
     ...
     * @param hoursOfService Time period (including time zone) when individuals can contact the organization or
     *     individual.
    ...
    /**
     * Identification of, and means of communication with, person(s) and organizations associated with the dataset. Only
     * one of {@code individualName}, {@code organisationName} and {@code positionName} should be provided.
     *
