...
/**
 * Thrown when a {@linkplain Factory factory} can't create an instance of the requested object. It
 * may be a failure to create a {@linkplain org.geotools.api.referencing.datum.Datum datum}, a
 * {@linkplain org.geotools.api.referencing.cs.CoordinateSystem coordinate system}, a {@linkplain
 * org.geotools.api.referencing.ReferenceSystem reference system} or a {@linkplain
 * org.geotools.api.referencing.operation.CoordinateOperation coordinate operation}.
 *
 * <p>If the failure is caused by an illegal authority code, then the actual exception should be
 * {@link NoSuchAuthorityCodeException}. Otherwise, if the failure is caused by some error in the
 * underlying database (e.g. {@link java.io.IOException} or {@link java.sql.SQLException}), then
