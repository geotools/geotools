 ...
 * org.geotools.api.referencing.crs.CRSAuthorityFactory} is used to create an object, the
 * {@linkplain ReferenceIdentifier#getAuthority authority} and {@linkplain
 * ReferenceIdentifier#getCode authority code} values should be set to the authority name of the
 * factory object, and the authority code supplied by the client, respectively. The other values may
 * or may not be set. If the authority is EPSG, the implementer may consider using the corresponding
 * metadata values in the EPSG tables.
 *
...
public interface IdentifiedObject {
     ...
     * (for example an {@linkplain org.geotools.api.referencing.crs.EngineeringCRS engineering CRS}
     * with different unit for each axis).
     *
