 ...
 *
 * <p>A Geographic CRS is not suitable for mapmaking on a planar surface, because it describes geometry on a curved
 * surface. It is impossible to represent such geometry in a Euclidean plane without introducing distortions. The need
 * to control these distortions has given rise to the development of the science of
 * {@linkplain org.geotools.api.referencing.operation.Projection map projections}.
 *
