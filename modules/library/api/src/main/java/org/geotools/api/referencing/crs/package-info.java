 ...
 * systems} ({@linkplain org.geotools.api.referencing.cs.CoordinateSystem coordinate systems} with a
 ...
 *
 * <P ALIGN="justify">A coordinate reference system consists of one coordinate system that is
 ...
 * versa.
 *
 * <P ALIGN="justify">A datum specifies the relationship of a coordinate system to the earth, thus
 ...
 *
 * <P ALIGN="justify">For the purposes of this specification, a coordinate reference system shall
 ...
 *
 * <P ALIGN="justify">Geodetic survey practice usually divides coordinate reference systems into a
 ...
 * <BLOCKQUOTE>
 *
 * <P ALIGN="justify"><B>Geocentric</B>: Type of coordinate reference system that deals with the
 ...
 *
 * <P ALIGN="justify"><B>Geographic</B>: Type of coordinate reference system based on an ellipsoidal
 ...
 *
 * <P ALIGN="justify"><B>Projected</B>: Type of coordinate reference system that is based on an
 ...
 * values.
 *
 * <P ALIGN="justify"><B>Engineering</B>: Type of coordinate reference system that is that is used
 ...
 * </UL>
 *
 * <P ALIGN="justify"><B>Image</B>: An Image CRS is an Engineering CRS applied to images. Image CRSs
 ...
 *
 * <P ALIGN="justify"><B>Vertical</B>: Type of coordinate reference system used for the recording of
 ...
 *
 * <P ALIGN="justify"><B>Temporal</B>: Used for the recording of time in association with any of the
 ...
 *
 * <P ALIGN="justify">In addition to the principal sub-types, so called because they represent
 ...
 * These additional sub-types are <A HREF="#CompoundCRS">Compound coordinate reference system</A>
 * and <A HREF="#DerivedCRS">Derived coordinate reference system</A>.
 *
 * <BLOCKQUOTE>
 *
 ...
 *
 * <P ALIGN="justify">In principle, all sub-types of coordinate reference system may take on the
 ...
 *
 * <P ALIGN="justify">An example of a Derived CRS: one of which the unit of measure has been
