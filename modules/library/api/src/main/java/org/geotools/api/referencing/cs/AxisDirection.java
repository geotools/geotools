 ...
 *
 * <p>Some coordinate systems use non-standard orientations. For example, the first axis in South African grids usually
 * points West, instead of East. This information is obviously relevant for algorithms converting South African grid
...
public final class AxisDirection extends CodeList<AxisDirection> {
    ...
    /**
     * Axis positive direction is north. In a geographic or projected CRS, north is defined through the geodetic datum.
     * In an engineering CRS, north may be defined with respect to an engineering object rather than a geographical
     * direction.
     */
    ...
    /**
     * Axis positive direction is &pi;/2 radians clockwise from north. This is usually used for Grid X coordinates and
     * Longitude.
     */
    ...
    /**
     * Axis positive direction is 3&pi;/2 radians clockwise from north. This is usually used for Grid X coordinates and
     * Longitude.
     */
    ...
    /**
     * Axis positive direction is up relative to gravity. This is used for
     * {@linkplain org.geotools.api.referencing.crs.VerticalCRS vertical} coordinate reference systems.
     */
    ...
    /**
     * Axis positive direction is down relative to gravity. This is used for
     * {@linkplain org.geotools.api.referencing.crs.VerticalCRS vertical} coordinate reference systems.
     */
    ...
    /**
     * Axis positive direction is in the equatorial plane from the centre of the modelled earth towards the intersection
     * of the equator with the prime meridian.
     *
     * @since GeoAPI 2.0
     */
    ...
    /**
     * Axis positive direction is in the equatorial plane from the centre of the modelled earth towards the intersection
     * of the equator and the meridian &pi;/2 radians eastwards from the prime meridian.
     *
     * @since GeoAPI 2.0
     */
    ...
    /**
     * Axis positive direction is from the centre of the modelled earth parallel to its rotation axis and towards its
     * north pole.
     *
     * @since GeoAPI 2.0
     */
    ...
    /**
     * Axis positive direction is towards the future. This is used for
     * {@linkplain org.geotools.api.referencing.crs.TemporalCRS temporal} coordinate reference systems.
     */
    ...
    /**
     * Axis positive direction is towards the past. This is used for
     * {@linkplain org.geotools.api.referencing.crs.TemporalCRS temporal} coordinate reference systems.
     */
    ...
    /** The opposite direction for this axis, or {@code null} if the opposite direction has not yet been specified. */
    ...
    /**
     * Returns the opposite direction of this axis. The opposite direction of {@linkplain #NORTH North} is
     * {@linkplain #SOUTH South}, and the opposite direction of {@linkplain #SOUTH South} is {@linkplain #NORTH North}.
     * The same applies to {@linkplain #EAST East}-{@linkplain #WEST West}, {@linkplain #UP Up}-{@linkplain #DOWN Down}
     * and {@linkplain #FUTURE Future}-{@linkplain #PAST Past}, <cite>etc.</cite> If this axis direction has no
     * opposite, then this method returns {@code null}.
     *
    ...
    /**
     * Returns the "absolute" direction of this axis. This "absolute" operation is similar to the {@code Math.abs(int)}
     * method in that "negative" directions like ({@link #SOUTH}, {@link #WEST}, {@link #DOWN}, {@link #PAST}) are
     * changed for their "positive" counterparts ({@link #NORTH}, {@link #EAST}, {@link #UP}, {@link #FUTURE}). More
     * specifically, the following conversion table is applied: <br>
     * &nbsp;
     *
