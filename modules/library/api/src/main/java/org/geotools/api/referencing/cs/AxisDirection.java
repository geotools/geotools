...
public final class AxisDirection extends CodeList<AxisDirection> {
    ...
    /**
     * Axis positive direction is north. In a geographic or projected CRS, north is defined through
     * the geodetic datum. In an engineering CRS, north may be defined with respect to an
    ...
    /**
     * Axis positive direction is &pi;/2 radians clockwise from north. This is usually used for Grid
     * X coordinates and Longitude.
     */
    ...
    public static final AxisDirection SOUTH_SOUTH_WEST =
            new AxisDirection("SOUTH_SOUTH_WEST", NORTH_NORTH_EAST);
    ...
    public static final AxisDirection WEST_SOUTH_WEST =
            new AxisDirection("WEST_SOUTH_WEST", EAST_NORTH_EAST);

    /**
     * Axis positive direction is 3&pi;/2 radians clockwise from north. This is usually used for
    ...
    public static final AxisDirection WEST_NORTH_WEST =
            new AxisDirection("WEST_NORTH_WEST", EAST_SOUTH_EAST);
    ...
    public static final AxisDirection NORTH_NORTH_WEST =
            new AxisDirection("NORTH_NORTH_WEST", SOUTH_SOUTH_EAST);

    /**
     * Axis positive direction is up relative to gravity. This is used for {@linkplain
     * org.geotools.api.referencing.crs.VerticalCRS vertical} coordinate reference systems.
     */
    ...
    /**
     * Axis positive direction is down relative to gravity. This is used for {@linkplain
     * org.geotools.api.referencing.crs.VerticalCRS vertical} coordinate reference systems.
     */
    ...
    /**
     * Axis positive direction is in the equatorial plane from the centre of the modelled earth
     * towards the intersection of the equator and the meridian &pi;/2 radians eastwards from the
     * prime meridian.
     *
     * @since GeoAPI 2.0
     */
    ...
    /**
     * Axis positive direction is towards the future. This is used for {@linkplain
     * org.geotools.api.referencing.crs.TemporalCRS temporal} coordinate reference systems.
     */
    ...
    /**
     * Axis positive direction is towards the past. This is used for {@linkplain
     * org.geotools.api.referencing.crs.TemporalCRS temporal} coordinate reference systems.
     */
    ...
    public static final AxisDirection COLUMN_NEGATIVE =
            new AxisDirection("COLUMN_NEGATIVE", COLUMN_POSITIVE);
    ...
    public static final AxisDirection ROW_NEGATIVE =
            new AxisDirection("ROW_NEGATIVE", ROW_POSITIVE);
    ...
    public static final AxisDirection DISPLAY_LEFT =
            new AxisDirection("DISPLAY_LEFT", DISPLAY_RIGHT);
    ...
    /**
     * The opposite direction for this axis, or {@code null} if the opposite direction has not yet
     * been specified.
     */
    ...
    /**
     * Returns the "absolute" direction of this axis. This "absolute" operation is similar to the
     * {@code Math.abs(int)} method in that "negative" directions like ({@link #SOUTH}, {@link
     * #WEST}, {@link #DOWN}, {@link #PAST}) are changed for their "positive" counterparts ({@link
     * #NORTH}, {@link #EAST}, {@link #UP}, {@link #FUTURE}). More specifically, the following
     * conversion table is applied: <br>
     * &nbsp;
     *
