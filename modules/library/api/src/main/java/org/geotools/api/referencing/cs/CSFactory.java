...
/**
 * Builds up complex {@linkplain CoordinateSystem coordinate systems} from simpler objects or values. {@code CSFactory}
 * allows applications to make {@linkplain CoordinateSystem coordinate systems} that cannot be created by a
 * {@link CSAuthorityFactory}. This factory is very flexible, whereas the authority factory is easier to use.
 *
 * <p>So {@link CSAuthorityFactory} can be used to make "standard" coordinate systems, and {@code CSFactory} can be used
 * to make "special" coordinate systems.
 *
 * @version <A HREF="http://www.opengis.org/docs/01-009.pdf">Implementation specification 1.0</A>
 * @author Martin Desruisseaux (IRD)
 * @since GeoAPI 1.0
 * @see org.geotools.api.referencing.crs.CRSFactory
...
public interface CSFactory extends ObjectFactory {
     ...
     * @throws FactoryException if the object creation failed.
     */
    CylindricalCS createCylindricalCS(
            Map<String, ?> properties,
            CoordinateSystemAxis axis0,
            CoordinateSystemAxis axis1,
            CoordinateSystemAxis axis2)
     ...
     * @throws FactoryException if the object creation failed.
     */
    UserDefinedCS createUserDefinedCS(
            Map<String, ?> properties,
            CoordinateSystemAxis axis0,
            CoordinateSystemAxis axis1,
            CoordinateSystemAxis axis2)
