 ...
 * {@linkplain org.geotools.api.referencing.cs.CoordinateSystemAxis axis}. The following is adapted
 ...
 *
 * <P ALIGN="justify">The coordinates of points are recorded in a coordinate system. A coordinate
 ...
 * <BLOCKQUOTE>
 *
 * <P ALIGN="justify"><FONT SIZE=2><STRONG>NOTE:</STRONG> The word "distances" is used loosely in
 ...
 * </BLOCKQUOTE>
 *
 * <P ALIGN="justify">One {@linkplain org.geotools.api.referencing.cs.CoordinateSystem coordinate
 * system} may be used by multiple {@linkplain
 * org.geotools.api.referencing.crs.CoordinateReferenceSystem coordinate reference systems}. A
 * coordinate system is composed of an ordered set of coordinate system axes, the number of axes
 * being equal to the dimension of the space of which it describes the geometry. Its axes can be
 * spatial, temporal, or mixed. Coordinates in coordinate tuples shall be supplied in the same order
 * as the coordinate axes are defined.
 *
 * <P ALIGN="justify">The dimension of the coordinate space, the names, the units of measure, the
 ...
 * coordinate tuple.
 *
 * <P ALIGN="justify">Coordinate systems are divided into subtypes by the geometric properties of
 ...
 * specific subtypes of coordinate reference system. <br>
 *
 * <H3>Coordinate system axis</H3>
 *
 * <P ALIGN="justify">A coordinate system is composed of an ordered set of coordinate system axes.
 ...
 *
 * <P ALIGN="justify">The concept of coordinate axis requires some clarification. Consider an
 * arbitrary <VAR>x</VAR>, <VAR>y</VAR>, <VAR>z</VAR> coordinate system. The <VAR>x</VAR>-axis may
 * be defined as the locus of points with <VAR>y</VAR>&nbsp;=&nbsp;<VAR>z</VAR>&nbsp;=&nbsp;0. This
 * is easily enough understood if the <VAR>x</VAR>, <VAR>y</VAR>, <VAR>z</VAR> coordinate system is
 ...
 * definition.
 *
 * <P ALIGN="justify">Bearing in mind that the order of the coordinates in a coordinate tuple must
 * be the same as the defined order of the coordinate axes, the "<VAR>i</VAR>-th" coordinate axis of
 * a coordinate system is defined as the locus of points for which all coordinates with sequence
 * number not equal to "<VAR>i</VAR>", have a constant value locally (whereby <VAR>i</VAR> =
 * 1...<VAR>n</VAR>, and <VAR>n</VAR> is the dimension of the coordinate space).
 *
 * <P ALIGN="justify">It will be evident that the addition of the word "locally" in this definition
 ...
 *
 * <P ALIGN="justify">Furthermore the specified direction of the coordinate axes is often only
 ...
 *
 * <P ALIGN="justify"><A NAME="AxisNames">Usage of coordinate system axis names is constrained by
 * geodetic custom in a number of cases, depending mainly on the coordinate reference system
 * type.</A> These constraints are shown in the table below. This constraint works in two
 ...
 * </TABLE>
 *
 * <P ALIGN="justify">Image and engineering coordinate reference systems may make use of names
