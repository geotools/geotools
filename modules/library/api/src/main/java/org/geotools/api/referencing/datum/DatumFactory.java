...
/**
 * Builds up complex {@linkplain Datum datums} from simpler objects or values. {@code DatumFactory} allows applications
 * to make {@linkplain Datum datums} that cannot be created by a {@link DatumAuthorityFactory}. This factory is very
 * flexible, whereas the authority factory is easier to use. So {@link DatumAuthorityFactory} can be used to make
 * "standard" datums, and {@code DatumFactory} can be used to make "special" datums.
 *
...
public interface DatumFactory extends ObjectFactory {
     ...
     */
    EngineeringDatum createEngineeringDatum(Map<String, ?> properties) throws FactoryException;
