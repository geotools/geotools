 ...
 *
 * <p>This code list is similar to {@link org.geotools.api.metadata.spatial.PixelOrientation} except
 * that the later is more clearly restricted to the two-dimensional case.
 *
