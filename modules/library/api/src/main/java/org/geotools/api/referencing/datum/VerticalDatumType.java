...
public final class VerticalDatumType extends CodeList<VerticalDatumType> {
     ...
     *     instantation of {@linkplain org.geotools.api.referencing.crs.VerticalCRS Vertical CRS}
     *     for ellipsoidal height. More specifically {@linkplain
     *     org.geotools.api.referencing.crs.GeographicCRS Geographic CRS} with ellipsoidal height
     *     shall be backed by a three-dimensional {@linkplain
     *     org.geotools.api.referencing.cs.EllipsoidalCS Ellipsoidal CS}; they should never be built
     *     as {@linkplain org.geotools.api.referencing.crs.CompoundCRS Compound CRS}.
     *     <p>However some API need to express the ellipsoidal height alone, e.g. for type safety in
     *     methods like {@link org.geotools.api.metadata.extent.VerticalExtent#getVerticalCRS}. The
