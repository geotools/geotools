...
public interface Conversion extends Operation {
    ...
    /**
     * Returns the target CRS. {@linkplain Conversion Conversions} may have a target CRS that is not specified here, but
     * through {@link org.geotools.api.referencing.crs.GeneralDerivedCRS} instead.
     *
