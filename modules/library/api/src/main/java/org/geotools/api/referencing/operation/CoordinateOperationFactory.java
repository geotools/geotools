...
public interface CoordinateOperationFactory extends ObjectFactory {
     ...
     * geographic CRS} using different {@linkplain org.geotools.api.datum.GeodeticDatum datum} requires a <cite>datum
     * shift</cite>. Many methods exist for this purpose, including interpolations in a grid, a
