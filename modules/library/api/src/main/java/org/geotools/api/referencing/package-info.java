...
/**
 * {@linkplain org.geotools.api.referencing.ReferenceSystem Reference systems}. The following is
 * adapted from <A HREF="http://portal.opengeospatial.org/files/?artifact_id=6716">OpenGIS&reg;
 * Spatial Referencing by Coordinates (Topic 2)</A> specification.
 *
 * <P ALIGN="justify">A reference system contains the metadata required to interpret spatial
 ...
 *
 * <P ALIGN="justify">The {@link org.geotools.api.referencing.IdentifiedObject} interface contains
 * attributes common to several objects used in spatial referencing by coordinates. For example, a
 * {@linkplain org.geotools.api.referencing.datum.Datum datum} name might be "North American Datum
 * of 1983". This may have alternative names or aliases, for example the abbreviation "NAD83".
 * Object {@linkplain org.geotools.api.referencing.IdentifiedObject#getName primary names} have a
 * data type {@link org.geotools.api.metadata.Identifier} whilst {@linkplain
 * org.geotools.api.referencing.IdentifiedObject#getAlias aliases} have a data type {@link
 * org.geotools.api.util.GenericName}.
 *
 * <P ALIGN="justify">Another attribute is {@linkplain
 * org.geotools.api.referencing.IdentifiedObject#getIdentifiers identifiers}. This is a unique code
 * used to reference an object in a given place. For example, an external geodetic register might
 * give the NAD83 datum a unique code of "6269". Identifiers have a data type of {@link
 * org.geotools.api.metadata.Identifier}. In addition to the use of an identifier as a reference to
