 ...
 * defined. This allows uses to make use of VendorOptions in the SLD (& CSS) to specify an algorithm to apply and named
 * parameters to control how that algorithm operates.
 *
 * @author Ian Turton.
 */
