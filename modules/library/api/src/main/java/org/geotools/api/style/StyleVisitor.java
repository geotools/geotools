 ...
 * would be to transcribe a style into a specific format, e.g. XML or SQL. Alternatively it may be to
...
public interface StyleVisitor {
     ...
     * @param style The style to visit
     */
    Object visit(org.geotools.api.style.Style style, Object data);
     ...
     */
    Object visit(org.geotools.api.style.FeatureTypeStyle featureTypeStyle, Object data);
     ...
     * @param rule the rule to visit
     */
    Object visit(org.geotools.api.style.Rule rule, Object data);
     ...
     */
    Object visit(org.geotools.api.style.PointSymbolizer pointSymbolizer, Object data);
     ...
     */
    Object visit(org.geotools.api.style.LineSymbolizer lineSymbolizer, Object data);
     ...
     */
    Object visit(org.geotools.api.style.PolygonSymbolizer polygonSymbolizer, Object data);
     ...
     */
    Object visit(org.geotools.api.style.TextSymbolizer textSymbolizer, Object data);
     ...
     */
    Object visit(org.geotools.api.style.RasterSymbolizer rasterSymbolizer, Object data);
     ...
     */
    Object visit(org.geotools.api.style.Displacement displacement, Object data);
     ...
     * @param fill the fill to be visited
     */
    Object visit(org.geotools.api.style.Fill fill, Object data);
     ...
     * @param stroke the stroke to visit
     */
    Object visit(org.geotools.api.style.Stroke stroke, Object data);
     ...
     */
    Object visit(org.geotools.api.style.Graphic graphic, Object data);
     ...
     * @param mark the mark to visit
     */
    Object visit(org.geotools.api.style.Mark mark, Object data);
     ...
     */
    Object visit(org.geotools.api.style.ExternalGraphic externalGraphic, Object data);
     ...
     */
    Object visit(org.geotools.api.style.PointPlacement pointPlacement, Object data);
     ...
     */
    Object visit(org.geotools.api.style.LinePlacement linePlacement, Object data);
     ...
     * @param halo the halo to visit
     */
    Object visit(org.geotools.api.style.Halo halo, Object data);
     ...
     * @param colorMap the color map to visit
     */
    Object visit(org.geotools.api.style.ColorMap colorMap, Object data);
     ...
     * Called when accept is called on a raster ContrastEnhancement element
     *
     * @param contrastEnhancement the {@link org.geotools.api.style.ContrastEnhancement} to visit.
     */
    Object visit(org.geotools.api.style.ContrastEnhancement contrastEnhancement, Object data);

    /**
     * Called when accept is called on a raster {@link org.geotools.api.style.ChannelSelection} element
     *
     * @param channelSelection the {@link org.geotools.api.style.ChannelSelection} to visit.
     */
    Object visit(org.geotools.api.style.ChannelSelection channelSelection, Object data);

    /**
     * Called when accept is called on a raster {@link org.geotools.api.style.SelectedChannelType} element
     *
     * @param selectChannelType the {@link org.geotools.api.style.SelectedChannelType} to visit.
     */
    Object visit(org.geotools.api.style.SelectedChannelType selectChannelType, Object data);

    /**
     * Called when accept is called on a raster {@link org.geotools.api.style.ShadedRelief} element
     *
     * @param shadedRelief the {@link org.geotools.api.style.ShadedRelief} to visit.
     */
    Object visit(org.geotools.api.style.ShadedRelief shadedRelief, Object data);
    ...
    Object visit(AnchorPoint anchorPoint, Object extraData);
}
