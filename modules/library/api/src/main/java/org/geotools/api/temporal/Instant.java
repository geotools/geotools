 ...
 * @author Alexander Petkov TODO There is a bit of a conflict in the spec document as to what should be returned for
 *     "position." The diagram shows that Position should be returned, while the text in the document demands that
 *     TemporalPosition should represent position in time.
 */
