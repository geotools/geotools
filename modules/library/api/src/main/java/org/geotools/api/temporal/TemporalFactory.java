...
public interface TemporalFactory {
    ...
    /**
     * @param frame : This is the TM_ReferenceSystem associated with this TM_TemporalPosition, if not specified, it is
     *     assumed to be an association to the Gregorian calendar and UTC.
     * @param indeterminatePosition : This attribute provides the only value for TM_TemporalPosition unless a subtype of
     ...
     * @param calendarDate : This is a sequence of positive integers in which the first integeridentifies a specific
     *     instance of the unit used at the highest level of the calendar hierarchy, the second integer identifies a
     *     specific instance of the unit used at the next lower level in the hierarchy, and so on. The format defined in
     *     ISO 8601 for dates in the Gregorian calendar may be used for any date that is composed of values for year,
     *     month and day.
     * @return CalendarDate
     */
     ...
     * @param referenceEvent : provide the name or description of a mythical or historic event which fixes the position
     *     of the base scale of the calendar era.
     * @param referenceDate : provide the date of the reference referenceEvent expressed as a date in the given
     *     calendar. In most calendars, this date is the origin (i.e the first day) of the scale, but this is not always
     *     true.
     * @param julianReference : provide the Julian date that corresponds to the reference date.
     * @param epochOfUse : identify the TM_Period for which the calendar era was used as a basis for dating, the
    ...
    /**
     * @param name : This is a name that uniquely identifies the temporal reference system.
     * @param referenceEvent : Provide the name or description of an event, such as solar noon or sunrise.
     * @param referenceTime : Provide the time of day associated with the reference event expressed as a time of day in
    ...
    /**
     * @param instant : This is the position of this TM_Instant, it shall be associated with a single temporal reference
     *     system.
     * @return Instant
     */
     ...
     * @param value : This is the length of the time interval as an integer multiple of one radix(exp -factor) of the
     *     specified unit.
     ...
     * @param indeterminatePosition : This attribute provides the only value for TM_TemporalPosition unless a subtype of
     *     TM_TemporalPosition is used as the data type.
     * @param coordinateValue : This is the distance from the scale origin expressed as a multiple of the standard
    ...
    /**
     * @param position : this object represents one of the data types listed as : Date, Time, DateTime, and
    ...
    /**
     * @param name : This is a name that uniquely identifies the temporal reference system.
     * @param origin : The origin of the scale, it must be specified in the Gregorian calendar with time of day in UTC.
     * @param interval : The name of a single unit of measure used as the base interval for the scale. it shall be one
     *     of those units of measure for time specified by ISO 31-1, or a multiple of one of those units, as specified
     *     by ISO 1000.
