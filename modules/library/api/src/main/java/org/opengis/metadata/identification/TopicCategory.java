 ...
 * exhaustive.
 *
 * <p>NOTE: It is understood there are overlaps between general categories and the user is
...
public final class TopicCategory extends CodeList<TopicCategory> {
     ...
     *
     * <p>Examples: agriculture, irrigation, aquaculture, plantations, herding, pests and diseases
     ...
     *
     * <p>Examples: wildlife, vegetation, biological sciences, ecology, wilderness, sealife,
     * wetlands, habitat
     */
     ...
     *
     * <p>Examples: political and administrative boundaries.
     */
     ...
     *
     * <p>Examples: cloud cover, weather, climate, atmospheric conditions, climate change,
     * precipitation.
     */
    @UML(
     ...
     *
     * <p>Examples: production, labour, revenue, commerce, industry, tourism and ecotourism,
     ...
     *
     * <p>Examples: altitude, bathymetry, digital elevation models, slope, derived products.
     */
     ...
     *
     * <p>Examples: environmental pollution, waste storage and treatment, environmental impact
     ...
     *
     * <p>Examples: geophysical features and processes, geology, minerals, sciences dealing with the
     ...
     *
     * <p>Examples: disease and illness, factors affecting health, hygiene, substance abuse, mental
     ...
     *
     * <p>Examples: barracks, training grounds, military transportation, information collection.
     */
    ...
    public static final TopicCategory INTELLIGENCE_MILITARY =
            new TopicCategory("INTELLIGENCE_MILITARY");

    /**
     * Inland water features, drainage systems and their characteristics.
     *
     * <p>Examples: rivers and glaciers, salt lakes, water utilization plans, dams, currents,
     ...
     *
     * <p>Examples: addresses, geodetic networks, control points, postal zones and services, place
     * names.
     */
     ...
     *
     * <p>Examples: tides, tidal waves, coastal information, reefs.
     */
     ...
     *
     * <p>Examples: land use maps, zoning maps, cadastral surveys, land ownership.
     */
     ...
     *
     * <p>Examples: settlements, anthropology, archaeology, education, traditional beliefs, manners
     ...
     *
     * <p>Examples: buildings, museums, churches, factories, housing, monuments, shops, towers.
     */
     ...
     *
     * <p>Examples: roads, airports/airstrips, shipping routes, tunnels, nautical charts, vehicle or
     ...
     *
     * <p>Examples: hydroelectricity, geothermal, solar and nuclear sources of energy, water
