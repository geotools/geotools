...
public final class GeoTiffPCSCodes {
    ...
    /**
     * PCSCitationGeoKey Key ID = 3073 Type = ASCII As with all the "Citation" GeoKeys, this is provided to give an
     * ASCII reference to published documentation on the Projected Coordinate System particularly if this is a
     * "user-defined" PCS.
     */
    public static final int PCSCitationGeoKey = 3073;
    /**
     * ProjAzimuthAngleGeoKey Key ID = 3094 Type = DOUBLE Units: GeogAzimuthUnit Azimuth angle east of true north of the
     * central line passing through the projection center (for elliptical (Hotine) Oblique Mercator). Note that this is
     * the standard method of measuring azimuth, but is opposite the usual mathematical convention of positive
     * indicating counter-clockwise.
     */
    ...
    /**
     * ProjCenterLatGeoKey Key ID = 3089 Type = DOUBLE Units: GeogAngularUnit Latitude of Center of Projection. Note
     * that this is not necessarily the origin of the projection.
     */
    public static final int ProjCenterLatGeoKey = 3089;
    /**
     * ProjCenterLongGeoKey Key ID = 3088 Type = DOUBLE Units: GeogAngularUnit Longitude of Center of Projection. Note
     * that this is not necessarily the origin of the projection.
     */
     ...
     * center. This is NOT the False Northing. NOTE this value is incorrectly named at
     ...
     * http://www.remotesensing.org/geotiff/spec/geotiff6.html#6.3.3.3 Allows specification of the coordinate
     * transformation method used. Note: this does not include the definition of the corresponding Geographic Coordinate
     * System to which the projected CS is related; only the transformation method is defined here. GeoKeys Required for
     * "user-defined" Coordinate Transformations: PCSCitationGeoKey (additional parameter geokeys depending on the
     * Coord. Trans. specified).
     */
     ...
     * specify the projected coordinate system. GeoKey requirements for "user-defined" PCS families: PCSCitationGeoKey
     * ProjectionGeoKey
     */
     ...
     * http://www.remotesensing.org/geotiff/spec/geotiff6.html#6.3.3.2 Allows specification of the coordinate
     * transformation method and projection zone parameters. Note : when associated with an appropriate Geographic
     * Coordinate System, this forms a Projected Coordinate System. GeoKeys Required for "user-defined" Projections:
     * PCSCitationGeoKey ProjCoordTransGeoKey ProjLinearUnitsGeoKey (additional parameters depending on
    ...
    /**
     * ProjLinearUnitsGeoKey Key ID = 3076 Type = SHORT (code) Values: Section 6.3.1.3 codes Defines linear units used
     * by this projection. http://www.remotesensing.org/geotiff/spec/geotiff6.html#6.3.1.3
     */
    public static final int ProjLinearUnitsGeoKey = 3076;
    /**
     * ProjLinearUnitSizeGeoKey Key ID = 3077 Type = DOUBLE Units: meters Defines size of user-defined linear units in
     * meters.
     */
    public static final int ProjLinearUnitSizeGeoKey = 3077;
    /**
     * ProjNatOriginLatGeoKey Key ID = 3081 Type = DOUBLE Units: GeogAngularUnit Alias: ProjOriginLatGeoKey Latitude of
     * map-projection Natural origin.
     */
    public static final int ProjNatOriginLatGeoKey = 3081;
    /**
     * ProjNatOriginLongGeoKey Key ID = 3080 Type = DOUBLE Units: GeogAngularUnit Alias: ProjOriginLongGeoKey Longitude
    ...
    /**
     * ProjScaleAtCenterGeoKey Key ID = 3093 Type = DOUBLE Units: none Scale at Center. This is a ratio, so no units are
     * required.
     */
     ...
     * 0.2) Latitude of primary Standard Parallel.
     */
    ...
    /**
     * ProjStraightVertPoleLongGeoKey Key ID = 3095 Type = DOUBLE Units: GeogAngularUnit Longitude at Straight Vertical
     * Pole. For polar stereographic.
     */
    public static final int ProjStraightVertPoleLongGeoKey = 3095;
    /**
     * 6.3.1.1 Model Type Codes Ranges: 0 = undefined [ 1, 32766] = GeoTIFFWritingUtilities Reserved Codes 32767 =
     * user-defined [32768, 65535] = Private User Implementations GeoTIFFWritingUtilities defined CS Model Type Codes:
     * ModelTypeProjected = 1 Projection Coordinate System ModelTypeGeographic = 2 Geographic latitude-longitude System
     * ModelTypeGeocentric = 3 Geocentric (X,Y,Z) Coordinate System Notes: 1. ModelTypeGeographic and ModelTypeProjected
     * correspond to the FGDC metadata Geographic and Planar-Projected coordinate system types.
     */
