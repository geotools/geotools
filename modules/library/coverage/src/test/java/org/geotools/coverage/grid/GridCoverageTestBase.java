...
public class GridCoverageTestBase extends CoverageTestBase {
    ...
    /**
     * Returns a grid coverage filled with random values. The coordinate reference system default to
  ...
  protected static final List<GridCoverage2D> EXAMPLES =
      new AbstractList<GridCoverage2D>() {
        ...
        /**
         * Loads the image at the given index. This is invoked by {@link #get} the first time a
         * given coverage is requested.
         */
            ...
            case 1:
              {
                ...
                bands =
                    new GridSampleDimension[] {
                      new GridSampleDimension(
                          "Measure", categories, MetricPrefix.MILLI(SI.GRAM).divide(SI.CUBIC_METRE))
                    };
                break;
              }
              /* ------------------------------------------------------------
            ...
            case 4:
              {
                ...
                return factory.create(
                    "Float coverage",
                    raster,
                    new ReferencedEnvelope(35, 35 + 45, -41, -41 + 46,DefaultGeographicCRS.WGS84),
                    null,
                    null,
                    null,
                    new Color[][] {colors},
            ...
            case 5:
              {
                ...
                return factory.create(
                    "UInt16 coverage",
                    image,
                    ReferencedEnvelope.envelope2D(DefaultGeographicCRS.WGS84, 35, -41, 35 + 45, -41 + 46));
              }
          }
          /*
