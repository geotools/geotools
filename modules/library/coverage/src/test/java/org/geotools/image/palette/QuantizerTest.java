...
public class QuantizerTest {
    ...
    /**
     * Checks two images are visually equal given a certain maximum color distance. For a better tool you might want to
     * check out {@link ImageAssert}, but that works only with RGB images, this one is color model independent
     */
