 ...
 *
 * <p>Token class is generated by javacc, this adapter allows reuse this class in different context (Parser, Compiler
 * and FilterBuilder)
 *
 * <p>The token class, used by the specific parser, requires to be adapted to implementing the interface
 * {@link org.geotools.filter.text.commons.IToken} which is used by the {@link CQLFilterBuilder} and {@link ECQL}}.
 *
