 ...
 *
 * <p>The "build..." methods implement that semantic actions making a filter for each syntax rules recognized.
 *
 * <p>Warning: This component is not published. It is part of module implementation. Client module should not use this
 * feature. TODO This module should use the new geometry API, more info in
