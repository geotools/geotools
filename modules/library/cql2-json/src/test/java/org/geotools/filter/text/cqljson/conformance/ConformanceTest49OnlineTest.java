...
/**
 * See <a href="https://docs.ogc.org/is/21-065r2/21-065r2.html#_conformance_test_49">table 16 from section A.12.4
 * Conformance test 49.</a>
 */
public class ConformanceTest49OnlineTest
    ...
    public ConformanceTest49OnlineTest(String dataset, String criteria, int feat) throws CQLException {
    ...
    public static Collection<Object[]> params() {
        return Arrays.asList(new Object[][] {
            {"ne_110m_populated_places_simple", "{\"op\":\"=\",\"args\":[\"København\",{\"property\":\"name\"}]}", 1},
            {"ne_110m_populated_places_simple", "{\"op\":\"<=\",\"args\":[\"København\",{\"property\":\"name\"}]}", 137
            },
            {"ne_110m_populated_places_simple", "{\"op\":\"<\",\"args\":[\"København\",{\"property\":\"name\"}]}", 136},
            {"ne_110m_populated_places_simple", "{\"op\":\">=\",\"args\":[\"København\",{\"property\":\"name\"}]}", 107
            },
            {"ne_110m_populated_places_simple", "{\"op\":\">\",\"args\":[\"København\",{\"property\":\"name\"}]}", 106},
            {
            ...
            {"ne_110m_populated_places_simple", "{\"op\":\"=\",\"args\":[1038288,{\"property\":\"pop_other\"}]}", 1},
            {"ne_110m_populated_places_simple", "{\"op\":\"<=\",\"args\":[1038288,{\"property\":\"pop_other\"}]}", 123},
            {"ne_110m_populated_places_simple", "{\"op\":\"<\",\"args\":[1038288,{\"property\":\"pop_other\"}]}", 122},
            {"ne_110m_populated_places_simple", "{\"op\":\">=\",\"args\":[1038288,{\"property\":\"pop_other\"}]}", 121},
            {"ne_110m_populated_places_simple", "{\"op\":\">\",\"args\":[1038288,{\"property\":\"pop_other\"}]}", 120},
            {
                "ne_110m_populated_places_simple",
            ...
            {"ne_110m_populated_places_simple", "{\"op\":\"like\",\"args\":[\"København\",\"K_benhavn\"]}", 243},
            {
                "ne_110m_populated_places_simple",
            ...
            {
                "ne_110m_admin_0_countries",
                "{\"op\":\"s_intersects\",\"args\":[{\"bbox\": [150,-90,-150,90]},{\"property\":\"geom\"}]}",
                10
            },
            {
                "ne_110m_admin_0_countries",
            ...
            {
                "ne_110m_populated_places_simple",
                "{\"op\":\"s_equals\",\"args\":[{\"type\":\"Point\",\"coordinates\":[6.1300028, 49.6116604]},{\"property\":\"geom\"}]}",
                1
            },
            {
                "ne_110m_admin_0_countries",
                "{\"op\":\"s_touches\",\"args\":[{\"type\":\"Polygon\",\"coordinates\":[[[6.043073357781111, 50.128051662794235], [6.242751092156993, 49.90222565367873], [6.186320428094177, 49.463802802114515], [5.897759230176348, 49.44266714130711], [5.674051954784829, 49.529483547557504], [5.782417433300907, 50.09032786722122], [6.043073357781111, 50.128051662794235]]]},{\"property\":\"geom\"}]}",
                3
            },
            {
                "ne_110m_admin_0_countries",
                "{\"op\":\"s_touches\",\"args\":[{\"type\":\"Point\",\"coordinates\":[6.043073357781111, 50.128051662794235]},{\"property\":\"geom\"}]}",
                3
            },
            {
                "ne_110m_admin_0_countries",
                "{\"op\":\"s_touches\",\"args\":[{\"type\":\"Point\",\"coordinates\":[6.242751092156993, 49.90222565367873]},{\"property\":\"geom\"}]}",
                2
            },
            {
                "ne_110m_admin_0_countries",
                "{\"op\":\"s_touches\",\"args\":[{\"type\":\"LineString\",\"coordinates\":[[6.043073357781111, 50.128051662794235], [6.242751092156993, 49.90222565367873]]},{\"property\":\"geom\"}]}",
                3
            },
            {
                "ne_110m_rivers_lake_centerlines",
