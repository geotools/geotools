...
public class ConformanceTest49OnlineTest extends ATSOnlineTest {
    ...
    public ConformanceTest49OnlineTest(String dataset, String criteria, int expectedFeatures) throws CQLException {
    ...
    public static Collection<Object[]> params() {
        return Arrays.asList(new Object[][] {
            ...
            {"ne_110m_populated_places_simple", "pop_other between pop_min and pop_max", 94},
            {"ne_110m_populated_places_simple", "pop_other not between pop_min and pop_max", 149},
            ...
            {"ne_110m_rivers_lake_centerlines", "S_INTERSECTS(BBOX(-180,-90,0,90),geom)", 4},
            {"ne_110m_admin_0_countries", "S_INTERSECTS(POLYGON((0 40,10 40,10 50,0 50,0 40)),geom)", 8},
            {"ne_110m_admin_0_countries", "S_INTERSECTS(LINESTRING(0 40,10 50),geom)", 4},
            {"ne_110m_populated_places_simple", "S_INTERSECTS(POLYGON((0 40,10 40,10 50,0 50,0 40)),geom)", 7},
            {"ne_110m_rivers_lake_centerlines", "S_INTERSECTS(LINESTRING(-60 -90,-60 90),geom)", 2},
            ...
            {"ne_110m_populated_places_simple", "S_EQUALS(POINT(6.1300028 49.6116604),geom)", 1},
            {
                "ne_110m_admin_0_countries",
            ...
            {"ne_110m_admin_0_countries", "S_TOUCHES(POINT(6.043073357781111 50.128051662794235),geom)", 3},
            {"ne_110m_admin_0_countries", "S_TOUCHES(POINT(6.242751092156993 49.90222565367873),geom)", 2},
            {
                "ne_110m_admin_0_countries",
            ...
            {"ne_110m_rivers_lake_centerlines", "S_CROSSES(LINESTRING(-60 -90,-60 90),geom)", 2},
            ...
            {"ne_110m_populated_places_simple", "t_after(timestamp('2022-04-16T10:13:19Z'),start)", 1},
            {"ne_110m_populated_places_simple", "t_before(timestamp('2022-04-16T10:13:19Z'),start)", 1},
            /* TODO not implemented
            {
                "ne_110m_populated_places_simple",
            ...
            {"ne_110m_populated_places_simple", "t_equals(timestamp('2022-04-16T10:13:19Z'),start)", 1},
            /* TODO not implemented
            {
                "ne_110m_populated_places_simple",
