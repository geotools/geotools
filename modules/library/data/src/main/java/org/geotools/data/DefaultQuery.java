...
public class DefaultQuery extends Query {
    ...
    /**
     * Constructor with typeName and filter. Note that current datasource implementations only have
     * one type per datasource, so the typeName field will likely be ignored.
     *
     * @param typeName the name of the featureType to retrieve.
