...
public abstract class AbstractHttpClient implements HTTPClient {
    ...
    protected static URL encodeURL(URL url) throws MalformedURLException {
        // Not new URI(scheme, authority, path, query, fragment): it quotes '%' too, so an already encoded
        // "citt%C3%A0" becomes "citt%25C3%25A0". Mixed raw and encoded input is the normal case here.
