...
public class MetadataTablePrimaryKeyFinder extends PrimaryKeyFinder {
    ...
    public PrimaryKey getPrimaryKey(JDBCDataStore store, String schema, String table, Connection cx)
        ...
        try {
            ...
            while (rs.next()) {
                ...
                } else if (policy == policy.pfsequence) {
                    columns.add(new PFSequencedPrimaryKeyColumn(colName, columnType, sequence));
                }
            }
    ...
    static Policy getPolicyForPrimaryKey(PrimaryKeyColumn key) {

        if (key instanceof NonIncrementingPrimaryKeyColumn) return Policy.assigned;
        if (key instanceof AutoGeneratedPrimaryKeyColumn) return Policy.autogenerated;
        if (key instanceof SequencedPrimaryKeyColumn) return Policy.sequence;
        if (key instanceof PFSequencedPrimaryKeyColumn) return Policy.pfsequence;
