 ...
 *
 * <p>If the type of the column is integral, new values are generated by selecting the max value of the key and adding 1
 * to it. If the column is character based a random string is generated.
 *
