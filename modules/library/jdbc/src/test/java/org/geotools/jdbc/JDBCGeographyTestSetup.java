...
public abstract class JDBCGeographyTestSetup extends JDBCDelegatingTestSetup {
     ...
     *
     * <p>The table should be populated with the following data: 0 | 'Town' | POINT(-110 30) 1 | 'Forest' | POINT(-109
     * 29) 2 | 'London' | POINT(0 49)
     */
     ...
     *
     * <p>The table should be populated with the following data: 0 | 'theline' | LINESTRING(0 0, 1 1, 2 2, 3 3, 4 4)
     */
    protected abstract void createGeoLineTable() throws Exception;

    protected abstract void dropGeoLineTable() throws Exception;

    /** Subclasses should override if the database connected to the test does not have geography support */
