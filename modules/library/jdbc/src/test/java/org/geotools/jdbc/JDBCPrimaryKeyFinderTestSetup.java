...
public abstract class JDBCPrimaryKeyFinderTestSetup extends JDBCDelegatingTestSetup {
     ...
     *
     * <p>The table is named "gt_pk_metdata". See {@link MetadataTablePrimaryKeyFinder} javadoc for the expected table
     * structure
     */
     ...
     *
     * <p>The table should be populated with the following data: 1, 2, "one" | NULL 2, 3, "two" | NULL 3, 4, "three" |
     * NULL
     */
    protected abstract void createPlainTable() throws Exception;

    /**
     * Creates a view named 'assignedsinglepk' that selects all of the contents of 'plaintable' and registers the key1
     * column as an assigned primary key in the pk metadata table
     */
    protected abstract void createAssignedSinglePkView() throws Exception;

    /**
     * Creates a view named 'assignedmultipk' that selects all of the contents of 'plaintable' and registers the key1,
     * key2 columns as an assigned primary key in the pk metadata table
     */
