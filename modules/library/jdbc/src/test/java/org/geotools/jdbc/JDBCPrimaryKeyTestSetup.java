...
public abstract class JDBCPrimaryKeyTestSetup extends JDBCDelegatingTestSetup {
     ...
     *
     * <p>The table should be populated with the following data: 1, "one" | NULL 2, "two" | NULL 3, "three" | NULL
     */
    protected abstract void createUniqueIndexTable() throws Exception;

    /**
     * Creates a table with a primary key column with an associated sequence, which has the following schema:
     *
    ...
    /**
     * Creates a table with a primary key which is made up of multiple columns, which has the following schema:
     *
     * <p>multi( name:String, geom: Geometry );
     *
     * <p>The table should be populated with the following data: "one" | NULL ; pkey1 = 1, pkey2 = 'x' "two" | NULL ;
     * pkey1 = 1, pkey2 = 'y' "three" | NULL ; pkey1 = 1, pkey2 = 'z'
     */
     ...
     *
     * <p>The table should be populated with the following data: "one", 1, NULL "two", 2, NULL "three", 3, NULL
     */
