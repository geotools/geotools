 ...
 *
 * <p>This interface may be implemented by data stores to provide an additional operation for looking object a "gml
 * object" directly. A gml object is typically a feature or a geometry.
 *
...
public interface GmlObjectStore {
     ...
     *     </code>.
     * @return The gml object, or <code>null</code> if one could not be found matching the specified id.
