 ...
 *
 * <p>Geotools 2.0: As Features always require a FeatureType the best place to implement this is in
 * the FeatureType itself, thus the FeatureType interface extends this interface. Other
 * FeatureFactories may be implemented, but they should probably be constructed with a FeatureType.
 *
 ...
 *     method.
 * @task REVISIT: move these methods directly to FeatureType? This would not allow independent
 *     FeatureFactories, but I'm not sure if those are useful at all.
 */
public interface FeatureFactory {
     ...
     * @throws IllegalAttributeException if the FeatureType does not validate the attributes.
     */
    SimpleFeature create(Object[] attributes, String featureID) throws IllegalAttributeException;
}
