...
public abstract class ExpressionAbstract implements Expression {
     ...
     * conversion to Converters utility class.
     * <p>
     * Subclasses are expected to make use of the {@linkplain Converters} utility class
     * (as the easiest way to provide value morphing in conformance with
