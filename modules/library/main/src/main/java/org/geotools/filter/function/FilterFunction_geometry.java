 ...
 */
public class FilterFunction_geometry  extends FunctionExpressionImpl implements VolatileFunction {

    public static FunctionName NAME = new FunctionNameImpl("geometry", Boolean.class);
    
    public FilterFunction_geometry() {
        super(NAME);
    }
