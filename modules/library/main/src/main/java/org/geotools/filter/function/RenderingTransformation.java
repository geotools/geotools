...
/**
 * An interface to be implemented by processes or by filter functions meant to be integrated as feature collection/grid
 * coverage transformations in a rendering chain.
 *
 * <p>These functions are meant to take one layer (raster or vector) and apply transformations on top of it
 *
 * <p>The method provide information about how the data is altered so that the renderer can query the appropriate part
 * of the input data that will feed the process/function
 *
...
public interface RenderingTransformation extends Function {
     ...
     * function This method will be called only if the input data is a feature collection.
     *
     ...
     * the function involved in rendering. This method will be called only if the input data is a grid coverage or a
     * grid coverage reader
     *
     * @return The transformed query, or null if no inversion is possible/meaningful
     */
     ...
     * taking a raster input. Default implementation return false.
     *
     * @return
     */
