 ...
 * coordinate cloning.
 *
 * <p>This implementation supports the use of addineTransform and has a hard coded decimation stratagy (so you can skip
 * points within the same pixel producing a Shape that is "more simple" than the origional Geometry).
 *
 * @author Andrea Aime
 * @version $Id$
 */
