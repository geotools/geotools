 ...
 * @author iant
 */
public class ChannelSelectionImpl implements org.geotools.api.style.ChannelSelection {
    private SelectedChannelTypeImpl gray;
    private SelectedChannelTypeImpl red;
    private SelectedChannelTypeImpl blue;
    private SelectedChannelTypeImpl green;

    @Override
    public SelectedChannelTypeImpl getGrayChannel() {
        return gray;
    }
     ...
     * SelectedChannelTypeImpl} array will contain null elements.
     *
     * @return {@link SelectedChannelTypeImpl} array that contains the {@link
     *     SelectedChannelTypeImpl} elements for the RGB channels.
     */
    @Override
    public SelectedChannelTypeImpl[] getRGBChannels() {
        if (red == null && green == null && blue == null) {
            return null;
        }
        return new SelectedChannelTypeImpl[] {red, green, blue};
    }

    public void setGrayChannel(SelectedChannelTypeImpl gray) {
        this.gray = gray;
    }
    ...
    public void setRGBChannels(SelectedChannelTypeImpl[] channels) {
        if (channels == null) {
            red = null;
            green = null;
            blue = null;
