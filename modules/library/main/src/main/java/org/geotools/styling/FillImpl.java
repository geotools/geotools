 ...
 */
public class FillImpl implements Cloneable, org.geotools.api.style.Fill {
    private FilterFactory filterFactory;
    private Expression color = null;
    private Expression opacity = null;
    private GraphicImpl graphicFill = null;
    private static final Logger LOGGER = Logger.getLogger(FillImpl.class.getName());
    ...
    public Object clone() {
        try {
            ...
            if (graphicFill != null) {
                clone.graphicFill = (GraphicImpl) ((Cloneable) graphicFill).clone();
            }
            return clone;
