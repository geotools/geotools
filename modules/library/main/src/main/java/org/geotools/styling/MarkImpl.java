 ...
 * @version $Id$
 */
public class MarkImpl implements Cloneable, org.geotools.api.style.Mark, Symbol {

    public static final MarkImpl[] MARKS_EMPTY = new MarkImpl[0];
    ...
    public MarkImpl(FilterFactory filterFactory, ExternalMarkImpl external) {
    ...
    /**
     * This parameter defines which stroke style should be used when rendering the Mark.
     *
