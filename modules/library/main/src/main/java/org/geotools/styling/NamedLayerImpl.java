 ...
 * @author jamesm
 */
public class NamedLayerImpl extends StyledLayerImpl implements org.geotools.api.style.NamedLayer {
    ...
    @Override
    public StyleImpl[] getStyles() {
        return styles.toArray(new StyleImpl[0]);
    }

    public List<StyleImpl> styles() {
        return styles;
    }

    public void addStyle(StyleImpl sl) {
        styles.add(sl);
    }
