...
public class RasterSymbolizerImpl extends AbstractSymbolizer
    ...
    private ChannelSelectionImpl channelSelection = new ChannelSelectionImpl();
     ...
     */
    @Override
    public ChannelSelectionImpl getChannelSelection() {
     ...
     * attributes of a color-map are used for translating between numeric matrices and color rasters
    ...
    public void setImageOutline(org.geotools.api.style.Symbolizer symbolizer) {
        if (symbolizer == null) {
            this.symbolizer = null;
                ...
                || symbolizer instanceof PolygonSymbolizerImpl) {
