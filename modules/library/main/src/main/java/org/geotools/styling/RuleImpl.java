 ...
 * @version $Id$
 */
public class RuleImpl implements Cloneable, org.geotools.api.style.Rule {
    ...
    /** Copy constructor */
    public RuleImpl(org.geotools.api.style.Rule rule) {
    ...
    static RuleImpl cast(org.geotools.api.style.Rule rule) {
        if (rule == null) {
            return null;
