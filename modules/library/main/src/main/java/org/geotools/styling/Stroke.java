 ...
 * @version $Id$
 */
public class Stroke implements org.geotools.api.style.Stroke, Cloneable {
    /**
    ...
    protected Stroke(FilterFactory factory) {
    ...
    public void setGraphicFill(org.geotools.api.style.Graphic fillGraphic) {
        ...
        this.fillGraphic = Graphic.cast(fillGraphic);
    }
    ...
    public void setGraphicStroke(org.geotools.api.style.Graphic strokeGraphic) {
        ...
        this.strokeGraphic = Graphic.cast(strokeGraphic);
    }
    ...
    static Stroke cast(org.geotools.api.style.Stroke stroke) {
        if (stroke == null) {
            return null;
            ...
            copy.setGraphicFill(Graphic.cast(stroke.getGraphicFill()));
            copy.setGraphicStroke(Graphic.cast(stroke.getGraphicStroke()));
