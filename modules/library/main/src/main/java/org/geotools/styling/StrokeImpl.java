 ...
 * @version $Id$
 */
public class StrokeImpl implements org.geotools.api.style.Stroke, Cloneable {
    /**
     ...
     * supplied.
     */
    public static final StrokeImpl DEFAULT =
            new ConstantStroke() {
                @Override
                ...
                public GraphicImpl getGraphicFill() {
                    return ConstantGraphic.DEFAULT;
                }
     ...
     * checking.
     */
    public static final StrokeImpl NULL =
            new ConstantStroke() {
                @Override
                public Expression getColor() {
    ...
    public float[] getDashArray() {
        if (dashArray == null) {
            return StrokeImpl.DEFAULT.getDashArray();
        }
    ...
    public List<Expression> dashArray() {
        if (dashArray == null) {
            return StrokeImpl.DEFAULT.dashArray();
        }
        return dashArray;
    }
    ...
    public Expression getDashOffset() {
        if (dashOffset == null) {
            return StrokeImpl.DEFAULT.getDashOffset();
        }
    ...
    public Expression getLineCap() {
        if (lineCap == null) {
            ...
            return StrokeImpl.DEFAULT.getLineCap();
        }
        return lineCap;
    }
    ...
    public Expression getLineJoin() {
        if (lineCap == null) {
            // ConstantExpression.constant("miter")
            return StrokeImpl.DEFAULT.getLineJoin();
        }
        return lineJoin;
    }
    ...
    public Expression getOpacity() {
        if (lineCap == null) {
            return StrokeImpl.DEFAULT.getOpacity();
        }
        return opacity;
    }
