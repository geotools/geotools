...
public  class TextSymbolizer extends AbstractSymbolizer implements org.geotools.api.style.TextSymbolizer, Cloneable {
    ...
    public void setFont(org.geotools.api.style.Font font) {
        ...
        if (font != null) {
            if (this.fonts.isEmpty()) {
                this.fonts.add(Font.cast(font));
            } else {
                this.fonts.set(0, Font.cast(font));
            }
        }
    }
    ...
    static TextSymbolizer cast(org.geotools.api.style.Symbolizer symbolizer) {
        if (symbolizer == null) {
            return null;
