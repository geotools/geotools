...
public class TextSymbolizerImpl extends AbstractSymbolizer
    ...
    protected TextSymbolizerImpl(
            FilterFactory factory, DescriptionImpl desc, String name, Unit<Length> uom) {
     ...
     */
    public void addFont(FontImpl font) {
        fonts.add(font);
    }
