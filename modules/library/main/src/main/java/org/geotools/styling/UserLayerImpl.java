 ...
 * @author jamesm
 */
public class UserLayerImpl extends StyledLayerImpl implements org.geotools.api.style.UserLayer {
    ...
    public List<StyleImpl> userStyles() {
        return styles;
    }

    public StyleImpl[] getUserStyles() {
        return styles.toArray(new StyleImpl[0]);
    }

    public void setUserStyles(StyleImpl[] styles) {
        this.styles.clear();
        this.styles.addAll(Arrays.asList(styles));
    }

    public void addUserStyle(StyleImpl style) {
        styles.add(style);
    }
