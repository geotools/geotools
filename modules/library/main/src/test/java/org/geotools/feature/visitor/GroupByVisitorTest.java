...
/**
 * This class implement the test that checks the group by visitor behavior with different aggregate visitors. All the
 * computations will be performed in memory. Optimization tests are implemented in the specific stores.
 */
public class GroupByVisitorTest {
    ...
    public static void setup() throws Exception {
        ...
        buildingType = DataUtilities.createType(
                "buildings",
        ...
        SimpleFeature[] buildingFeatures = {
            SimpleFeatureBuilder.build(
                    buildingType,
                    new Object[] {1, "SCHOOL_A", "SCHOOL", "FLOWING_WATER", 50.0, wktParser.read("POINT(-5 -5)")},
                    null),
            SimpleFeatureBuilder.build(
                    buildingType,
                    new Object[] {2, "SCHOOL_A", "SCHOOL", "NUCLEAR", 10.0, wktParser.read("POINT(-5 -5)")},
                    null),
            SimpleFeatureBuilder.build(
                    buildingType,
                    new Object[] {3, "SCHOOL_A", "SCHOOL", "WIND", 20.0, wktParser.read("POINT(-5 -5)")},
                    null),
            SimpleFeatureBuilder.build(
                    buildingType,
                    new Object[] {4, "SCHOOL_B", "SCHOOL", "SOLAR", 30.0, wktParser.read("POINT(5 5)")},
                    null),
            SimpleFeatureBuilder.build(
                    buildingType,
                    new Object[] {5, "SCHOOL_B", "SCHOOL", "FUEL", 60.0, wktParser.read("POINT(5 5)")},
                    null),
            SimpleFeatureBuilder.build(
                    buildingType,
                    new Object[] {6, "SCHOOL_B", "SCHOOL", "NUCLEAR", 10.0, wktParser.read("POINT(5 5)")},
                    null),
            SimpleFeatureBuilder.build(
                    buildingType,
                    new Object[] {7, "FABRIC_A", "FABRIC", "FLOWING_WATER", 500.0, wktParser.read("POINT(-5 5)")},
                    null),
            SimpleFeatureBuilder.build(
                    buildingType,
                    new Object[] {8, "FABRIC_A", "FABRIC", "NUCLEAR", 150.0, wktParser.read("POINT(-5 5)")},
                    null),
            SimpleFeatureBuilder.build(
                    buildingType,
                    new Object[] {9, "FABRIC_B", "FABRIC", "WIND", 20.0, wktParser.read("POINT(5 -5)")},
                    null),
            SimpleFeatureBuilder.build(
                    buildingType,
                    new Object[] {10, "FABRIC_B", "FABRIC", "SOLAR", 30.0, wktParser.read("POINT(5 -5)")},
                    null),
            SimpleFeatureBuilder.build(
                    buildingType,
                    new Object[] {11, "HOUSE_A", "HOUSE", "FUEL", 6.0, wktParser.read("POINT(0 0)")},
                    null),
            SimpleFeatureBuilder.build(
                    buildingType,
                    new Object[] {12, "HOUSE_B", "HOUSE", "NUCLEAR", 4.0, wktParser.read("POINT(0 0)")},
                    null),
        };
    ...
    public void testMergingGroupByResults() throws Exception {
        ...
        FeatureCollection featureCollectionB = DataUtilities.collection(
                SimpleFeatureBuilder.build(
                        buildingType,
                        new Object[] {1, "SCHOOL_C", "SCHOOL", "NUCLEAR", 100.0, wktParser.read("POINT(-15 -15)")},
                        null),
                SimpleFeatureBuilder.build(
                        buildingType,
                        new Object[] {1, "SCHOOL_C", "SCHOOL", "FUEL", 15.0, wktParser.read("POINT(-15 -15)")},
                        null),
                SimpleFeatureBuilder.build(
                        buildingType,
                        new Object[] {2, "FABRIC_C", "FABRIC", "NUCLEAR", 250.0, wktParser.read("POINT(-25 -25)")},
                        null),
                SimpleFeatureBuilder.build(
                        buildingType,
                        new Object[] {2, "FABRIC_C", "FABRIC", "WIND", 75.0, wktParser.read("POINT(-25 -25)")},
                        null),
                SimpleFeatureBuilder.build(
                        buildingType,
                        new Object[] {2, "HOUSE_C", "HOUSE", "WIND", 10.0, wktParser.read("POINT(-35 -35)")},
                        null),
                SimpleFeatureBuilder.build(
                        buildingType,
                        new Object[] {2, "HOUSE_C", "HOUSE", "DARK_MATTER", 850.0, wktParser.read("POINT(-35 -35)")},
                        null),
                SimpleFeatureBuilder.build(
                        buildingType,
                        new Object[] {2, "THEATER_A", "THEATER", "WIND", 200.0, wktParser.read("POINT(-45 -45)")},
                        null));
        // we visit the first feature collection calculating the energy consumption average by
        // building type
        GroupByVisitor visitorA = executeVisitor(featureCollectionA, "energy_consumption", "Average", "building_type");
        ...
        // building type
        GroupByVisitor visitorB = executeVisitor(featureCollectionB, "energy_consumption", "Average", "building_type");
    ...
    public void testMergingGroupByResultsWithNull() throws Exception {
        ...
        FeatureCollection featureCollectionB = DataUtilities.collection(
                ...
                SimpleFeatureBuilder.build(
                        buildingType,
                        new Object[] {13, "MALL_A", "MALL", "GRAVITY", null, wktParser.read("POINT(-45 -45)")},
                        null),
                SimpleFeatureBuilder.build(
                        buildingType,
                        new Object[] {13, "MALL_B", "MALL", "GRAVITY", null, wktParser.read("POINT(-45 -45)")},
                        null));
        // we visit the first feature collection calculating the energy consumption average by
        // building type
        GroupByVisitor visitorA = executeVisitor(featureCollectionA, "energy_consumption", "Average", "building_type");
    ...
    public void testFeatureAttributeVisitor() {
        GroupByVisitor visitor = buildVisitor("energy_consumption", "Average", "building_type");
    ...
    private void testVisitor(
            String aggregateAttribute, String aggregateVisitor, String groupByAttribute, Object[][] expectedResults)
            throws Exception {
    ...
    private void testVisitor(
            String aggregateAttribute, String aggregateVisitor, String[] groupByAttributes, Object[][] expectedResults)
            throws Exception {
        GroupByVisitor visitor =
                executeVisitor(featureCollection, aggregateAttribute, aggregateVisitor, groupByAttributes);
        checkResults(visitor.getResult(), expectedResults);
    }

    /**
     * Helper method that construct the group by visitor and visit the given feature collection. The visitor result is
     * also checked against the expected result.
     */
    private GroupByVisitor executeVisitor(
            ...
            throws Exception {
        GroupByVisitor visitor = buildVisitor(aggregateAttribute, aggregateVisitor, groupByAttributes);
    ...
    /**
     * Helper method that checks if the number of results and the number of expected results are the same and if the
     * expected results are contained in the results.
     */
