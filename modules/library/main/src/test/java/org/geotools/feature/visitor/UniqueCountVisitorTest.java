...
public class UniqueCountVisitorTest {
    ...
    public static void setup() throws Exception {
        ...
        uniqueValuesCountTestType = DataUtilities.createType(
                "uniqueValuesCount", "id:Integer,aStringValue:String," + "aDoubleValue:Double,geo:Geometry");
        // the building features that will be used during the tests
        SimpleFeature[] simpleFeatures = {
            SimpleFeatureBuilder.build(
                    uniqueValuesCountTestType, new Object[] {1, "A", 50.0, wktParser.read("POINT(-5 -5)")}, null),
            SimpleFeatureBuilder.build(
                    uniqueValuesCountTestType, new Object[] {2, "B", 10.0, wktParser.read("POINT(-5 -5)")}, null),
            SimpleFeatureBuilder.build(
                    uniqueValuesCountTestType, new Object[] {3, "C", 20.0, wktParser.read("POINT(-5 -5)")}, null),
            SimpleFeatureBuilder.build(
                    uniqueValuesCountTestType, new Object[] {4, "D", 30.0, wktParser.read("POINT(5 5)")}, null),
            SimpleFeatureBuilder.build(
                    uniqueValuesCountTestType, new Object[] {5, "E", 60.0, wktParser.read("POINT(5 5)")}, null),
            SimpleFeatureBuilder.build(
                    uniqueValuesCountTestType, new Object[] {6, "E", 10.0, wktParser.read("POINT(5 5)")}, null),
            SimpleFeatureBuilder.build(
                    uniqueValuesCountTestType, new Object[] {7, "D", 500.0, wktParser.read("POINT(-5 5)")}, null),
            SimpleFeatureBuilder.build(
                    uniqueValuesCountTestType, new Object[] {8, "C", 150.0, wktParser.read("POINT(-5 5)")}, null),
            SimpleFeatureBuilder.build(
                    uniqueValuesCountTestType, new Object[] {9, "C", 20.0, wktParser.read("POINT(5 -5)")}, null),
            SimpleFeatureBuilder.build(
                    uniqueValuesCountTestType, new Object[] {10, "C", 30.0, wktParser.read("POINT(5 -5)")}, null),
            SimpleFeatureBuilder.build(
                    uniqueValuesCountTestType, new Object[] {11, "A", 500.0, wktParser.read("POINT(0 0)")}, null),
            SimpleFeatureBuilder.build(
                    uniqueValuesCountTestType, new Object[] {12, "F", 500.0, wktParser.read("POINT(0 0)")}, null),
        };
