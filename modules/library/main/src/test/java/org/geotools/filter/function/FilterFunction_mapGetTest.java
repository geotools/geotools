...
public class FilterFunction_mapGetTest extends TestCase {
    ...
    public void testEvaluate() {
        ...
        Function f = FF.function("mapGet", FF.literal("attributes.name"));
        ...
        PropertyIsGreaterThan gt =
                FF.greater(FF.function("mapGet", FF.literal("attributes.score")), FF.literal(80));
        ...
        Function f2 = FF.function("mapGet", FF.literal("attributes.valid"));
        ...
        Function f3 = FF.function("mapGet", FF.literal("attributes.key1"));
