...
public class JsonArrayContainsFunctionTest {
    ...
    public void testArrayContainsString() {
        ...
        assertFalse(
                (boolean) containsFunction(json, "/arrayString", "notpresent").evaluate(null));
        ...
        assertTrue((boolean)
                containsFunction(json, "/onNestedArrayStr/nestedArray", "baz").evaluate(null));
        assertTrue((boolean)
                containsFunction(json, "/onNestedArrayInt/nestedArray", 87).evaluate(null));
        assertFalse(
                (boolean) containsFunction(json, "/nonexistingpointer", "...").evaluate(null));
    }
