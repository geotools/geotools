...
public class DpiRescaleStyleVisitorTestImpl {
    StyleBuilder sb;
    ...
    public void testNoUnit() throws Exception {
        ...
        LineSymbolizerImpl ls = sb.createLineSymbolizer(original);
        ls.accept(visitor);
        StrokeImpl clone = ((LineSymbolizerImpl) visitor.getCopy()).getStroke();
        ...
        ts.accept(visitor);
        TextSymbolizerImpl clonedTs = (TextSymbolizerImpl) visitor.getCopy();
        assertEquals(
                "20.0",
