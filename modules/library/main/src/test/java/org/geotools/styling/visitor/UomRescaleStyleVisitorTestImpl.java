...
/** @author milton */
public class UomRescaleStyleVisitorTestImpl {
    ...
    protected void visitPointSymbolizerTest(double scaleMetersToPixel, Unit<Length> uom) {
        try {
            ...
            PointSymbolizerImpl rescaledPointSymb = (PointSymbolizerImpl) visitor.getCopy();
            double rescaledSize =
    ...
    protected void visitLineSymbolizerTest(double scaleMetersToPixel, Unit<Length> uom) {
        try {
            ...
            LineSymbolizerImpl rescaledLineSymb = (LineSymbolizerImpl) visitor.getCopy();
            double rescaledSize =
    ...
    protected void visitPolygonSymbolizerTest(double scaleMetersToPixel, Unit<Length> uom) {
        try {
            ...
            polySymb.getOptions().put(PolygonSymbolizerImpl.GRAPHIC_MARGIN_KEY, "15");

            UomRescaleStyleVisitor visitor = new UomRescaleStyleVisitor(scaleMetersToPixel);

            polySymb.accept(visitor);
            PolygonSymbolizerImpl rescaledPolySymb = (PolygonSymbolizerImpl) visitor.getCopy();
            double rescaledSize =
    ...
    protected void visitTextSymbolizerTest(double scaleMetersToPixel, Unit<Length> uom) {
        try {
            ...
            TextSymbolizerImpl rescaledTextSymb = (TextSymbolizerImpl) visitor.getCopy();

            double rescaledFontSize =
                    rescaledTextSymb.getFont().getSize().evaluate(null, Double.class);
            PointPlacementImpl rescaledPlacement =
                    (PointPlacementImpl) rescaledTextSymb.getLabelPlacement();
    ...
    public void testVisitPolygonSymbolizer_NullStroke() {
        try {
            ...
            FillImpl fill = styleBuilder.createFill(Color.RED);
            PolygonSymbolizerImpl polySymb =
    ...
    public void testVisitTextSymbolizer_LinePlacement() {
        try {
            ...
            LinePlacementImpl placement = styleBuilder.createLinePlacement(perpOffset);
            ...
            double rescaledFontSize =
                    rescaledTextSymb.getFont().getSize().evaluate(null, Double.class);
            LinePlacementImpl rescaledPlacement =
                    (LinePlacementImpl) rescaledTextSymb.getLabelPlacement();
    ...
    public void testVisitLineSymbolizer_ExpressionWithFeatureAttribute() {
        try {
            ...
            StrokeImpl stroke = styleBuilder.createStroke(color, width);
            LineSymbolizerImpl lineSymb =
                    (LineSymbolizerImpl) styleBuilder.createLineSymbolizer(stroke);
            lineSymb.setUnitOfMeasure(uom);
    ...
    public void testRescaleGraphicFillStrokes() {
        ...
        stroke.setGraphicStroke(
                sb.createGraphic(
                        null,
                        sb.createMark("square", null, (StrokeImpl) sb.createStroke(1)),
                        null));
    ...
    public void testRescaleGraphicPointSymbolizer() {
        ...
        // create a circle
        MarkImpl circle = sb.createMark("circle", null, (StrokeImpl) sb.createStroke(500));
        GraphicImpl g = sb.createGraphic(null, circle, null);

        // a point symbolizer with the specified circle
        PointSymbolizerImpl ps = sb.createPointSymbolizer(g);
        ...
        UomRescaleStyleVisitor visitor = new UomRescaleStyleVisitor(10);
        ps.accept(visitor);
        PointSymbolizerImpl rps = (PointSymbolizerImpl) visitor.getCopy();
        MarkImpl rm = (MarkImpl) rps.getGraphic().graphicalSymbols().get(0);
        ...
        ps.accept(visitor);
        rps = (PointSymbolizerImpl) visitor.getCopy();
        rm = (MarkImpl) rps.getGraphic().graphicalSymbols().get(0);
    ...
    public void visitNullExpression() {
        ...
        StyleImpl style = SLD.createPolygonStyle(Color.YELLOW, null, 0.0f);
