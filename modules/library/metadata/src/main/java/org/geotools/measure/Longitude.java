...
public final class Longitude extends Angle {
    ...
    /**
     * Constructs a newly allocated {@code Longitude} object that represents the longitude value represented by the
     * string. The string should represents an angle in either fractional degrees (e.g. 45.5°) or degrees with minutes
     * and seconds (e.g. 45°30'). The hemisphere (E or W) is optional (default to East).
     *
