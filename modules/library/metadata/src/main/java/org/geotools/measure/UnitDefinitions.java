    ...
    public static List<UnitDefinition> CONSTANTS =
            unmodifiableList(
                    asList(
                            ...
                            UnitDefinition.of(
                                    SI.BOLTZMANN_CONSTANT, emptyList(), "kB", emptyList()),
                            UnitDefinition.of(SI.ELEMENTARY_CHARGE, emptyList(), "e", emptyList()),
                            UnitDefinition.of(
                                    SI.PLANCK_CONSTANT, emptyList(), "\u210E", emptyList())));
    ...
    public static List<UnitDefinition> NON_SI =
            unmodifiableList(
                    asList(
                            ...
                            UnitDefinition.of(
                                    NonSI.UNIFIED_ATOMIC_MASS, emptyList(), "u", emptyList()),
                            UnitDefinition.of(NonSI.DALTON, emptyList(), "Da", emptyList()),
                            UnitDefinition.of(
                                    NonSI.ASTRONOMICAL_UNIT, emptyList(), "UA", emptyList()),
                            ...
                            UnitDefinition.of(
                                    NonSI.KILOGRAM_FORCE, emptyList(), "kgf", emptyList()),
    ...
    public static List<UnitDefinition> US_CUSTOMARY =
            unmodifiableList(
                    asList(
                            ...
                            UnitDefinition.of(
                                    USCustomary.NAUTICAL_MILE, emptyList(), "nmi", emptyList()),
                            UnitDefinition.of(
                                    USCustomary.LIGHT_YEAR, emptyList(), "ly", emptyList()),
                            ...
                            // temperature
                            UnitDefinition.of(
                                    USCustomary.FAHRENHEIT, emptyList(), "°F", emptyList()),

                            // angle
                            UnitDefinition.of(
                                    USCustomary.REVOLUTION, emptyList(), "rev", emptyList()),

                            // speed
                            UnitDefinition.of(
                                    USCustomary.MILE_PER_HOUR, emptyList(), "mph", emptyList()),
                            UnitDefinition.of(USCustomary.KNOT, emptyList(), "kn", emptyList()),

                            // area
                            UnitDefinition.of(
                                    USCustomary.SQUARE_FOOT, emptyList(), "sft", emptyList()),
                            ...
                            // energy
                            UnitDefinition.of(
                                    USCustomary.ELECTRON_VOLT, emptyList(), "eV", emptyList()),

                            // power
                            UnitDefinition.of(
                                    USCustomary.HORSEPOWER, emptyList(), "HP", emptyList()),

                            // volume
                            UnitDefinition.of(USCustomary.LITER, emptyList(), "L", emptyList()),
                            UnitDefinition.of(
                                    USCustomary.CUBIC_INCH, emptyList(), "in³", emptyList()),
                            UnitDefinition.of(
                                    USCustomary.CUBIC_FOOT, emptyList(), "ft³", emptyList()),
                            UnitDefinition.of(
                                    USCustomary.ACRE_FOOT, emptyList(), "ac ft", emptyList()),
                            UnitDefinition.of(
                                    USCustomary.GALLON_DRY, emptyList(), "gal_dry_us", emptyList()),
                            UnitDefinition.of(
                                    USCustomary.GALLON_LIQUID, emptyList(), "gal", emptyList()),
                            UnitDefinition.of(
                                    USCustomary.FLUID_OUNCE, emptyList(), "fl oz", emptyList()),
                            UnitDefinition.of(
                                    USCustomary.GILL_LIQUID, emptyList(), "liq.gi", emptyList()),
                            UnitDefinition.of(
                                    USCustomary.MINIM, emptyList(), "min_us", emptyList()),
                            UnitDefinition.of(
                                    USCustomary.FLUID_DRAM, emptyList(), "fl dr", emptyList()),
                            UnitDefinition.of(USCustomary.CUP, emptyList(), "cup", emptyList()),
                            UnitDefinition.of(
                                    USCustomary.TEASPOON, emptyList(), "tsp", emptyList()),
                            UnitDefinition.of(
                                    USCustomary.TABLESPOON, emptyList(), "Tbsp", emptyList()),
