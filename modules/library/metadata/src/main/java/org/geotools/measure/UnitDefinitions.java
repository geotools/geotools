 ...
 *
 * <p>The individual definitions allow mixing and matching of units definitions as required for each individual unit
...
public final class UnitDefinitions {
    ...
    public static List<UnitDefinition> CONSTANTS = listOf(
    ...
    public static List<UnitDefinition> SI_DERIVED = listOf(
    ...
    public static List<UnitDefinition> NON_SI = listOf(
            ...
            UnitDefinition.of(NonSI.STANDARD_GRAVITY, emptyList(), "g\\u2099", asList("gn")),
            ...
            UnitDefinition.of(MetricPrefix.MEGA(NonSI.TONNE), emptyList(), "Mt", emptyList()));

    public static List<UnitDefinition> US_CUSTOMARY = listOf(
            // length
            UnitDefinition.of(USCustomary.INCH, emptyList(), "in", emptyList()),
            UnitDefinition.of(USCustomary.FOOT, emptyList(), "ft", emptyList()),
            UnitDefinition.of(USCustomary.FOOT_SURVEY, emptyList(), "ft_survey_us", emptyList()),
            ...
            UnitDefinition.of(USCustomary.GALLON_DRY, emptyList(), "gal_dry_us", emptyList()),
    ...
    public static List<UnitDefinition> GEOTOOLS = listOf(
            UnitDefinition.of(DEGREE_MINUTE_SECOND, emptyList(), "DMS", asList("degree minute second")),
            UnitDefinition.of(
                    SEXAGESIMAL_DMS,
                    emptyList(),
                    "D.MS",
                    asList("sexagesimal DMS", "DDD.MMSSsss", "sexagesimal degree DDD.MMSSsss")),
    ...
    public static List<UnitDefinition> EPSG = listOf(
            UnitDefinition.of(DEGREE_MINUTE_SECOND, emptyList(), "DMS", asList("degree minute second")),
            UnitDefinition.of(
                    SEXAGESIMAL_DMS,
                    emptyList(),
    ...
    public static List<UnitDefinition> ESRI = listOf(
            UnitDefinition.of(DEGREE_MINUTE_SECOND, emptyList(), "DMS", asList("degree minute second")),
            UnitDefinition.of(
                    SEXAGESIMAL_DMS,
                    emptyList(),
