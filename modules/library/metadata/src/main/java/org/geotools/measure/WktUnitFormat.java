...
public final class WktUnitFormat {
    ...
    static class WktUnitFormatterImpl extends BaseUnitFormatter implements UnitFormatter {
        ...
        /**
         * Returns an equivalent unit instance based on the provided unit. First, it tries to get one of the reference
         * units defined in the JSR 385 implementation in use. If no equivalent reference unit is defined, it returns
         * the provided unit
         */
