...
final class PropertyTree {
    ...
    /** The object to use for formatting numbers. Will be created only when first needed. */
    private transient NumberFormat numberFormat;

    /** The object to use for formatting dates. Will be created only when first needed. */
     ...
     *
     * @param standard The expected standard implemented by the metadata.
     * @param locale The locale to use for {@linkplain Date date}, {@linkplain Number number} and
     *     {@linkplain InternationalString international string} formatting.
     */
