...
public final class ErrorKeys {
    ...
    public static final String CANT_REDUCE_TO_TWO_DIMENSIONS_$1 =
            "Can't reduce \"{0}\" to a two-dimensional coordinate system.";
    public static final String ILLEGAL_AXIS_ORIENTATION_$2 =
    ...
    public static final String LINE_TOO_SHORT_$2 =
    ...
    public static final String UNSUPPORTED_CRS_$1 =
    ...
    public static final String INVALID_WKT_FORMAT_$1 =
    ...
    public static final String NOT_GREATER_THAN_ZERO_$1 =
            "Number {0} is invalid. Expected a number greater than 0.";
    public static final String NON_INTEGER_CATEGORY =
    ...
    public static final String VARIABLE_NOT_FOUND_IN_FILE_$2 =
            "No variable \"{0}\" found in file \"{1}\".";
    public static final String DISTANCE_OUT_OF_RANGE_$4 =
            "The distance {0} is out of range ({1} to {2} {3})";
    public static final String MISMATCHED_COORDINATE_REFERENCE_SYSTEM =
    ...
    public static final String ILLEGAL_OPERATION_FOR_VALUE_CLASS_$1 =
            "This operation can't be applied to values of class '{0}'.";
    public static final String NOT_TWO_DIMENSIONAL_$1 =
    ...
    public static final String NULL_VALUE_IN_TABLE_$3 =
            "Unexpected null value in record \"{0}\" for the column \"{1}\" in table \"{2}\".";
    public static final String OPERATION_NOT_FOUND_$1 =
            "No such \"{0}\" operation for this processor.";
    public static final String RECURSIVE_CALL_$2 =
    ...
    public static final String TOO_MANY_OCCURENCES_$2 =
    ...
    public static final String UNPARSABLE_STRING_$2 =
            "Can't parse \"{0}\" because \"{1}\" is unrecognized.";
    public static final String PARAMETER_NAME_CLASH_$4 =
            "Name or alias for parameter \"{0}\" at index {1} conflict with name \"{2}\" at index {3}.";
    public static final String UNSUPPORTED_COORDINATE_SYSTEM_$1 =
    ...
    public static final String NONINVERTIBLE_SCALING_TRANSFORM =
    ...
    public static final String ILLEGAL_DESCRIPTOR_FOR_PARAMETER_$1 =
    ...
    public static final String BAD_GRID_RANGE_$3 =
    ...
    public static final String EMPTY_ENVELOPE =
            "Envelope must be at least two-dimensional and non-empty.";
    public static final String OPERATION_ALREADY_BOUND_$1 =
    ...
    public static final String ZVALUE_OUTSIDE_COVERAGE_$2 =
    ...
    public static final String INSUFFICIENT_POINTS_$2 =
            "{0} points were specified, while {1} are required.";
    public static final String UNEXPECTED_TRANSFORM_RESULT =
    ...
    public static final String UNEXPECTED_ROW_LENGTH_$3 =
            "Matrix row {0} has a length of {1}, while {2} was expected.";
    public static final String MISSING_AUTHORITY_$1 =
    ...
    public static final String UNEXPECTED_ARGUMENT_FOR_INSTRUCTION_$1 =
            "Unexpected argument for operation \"{0}\".";
    public static final String UNEXPECTED_DIMENSION_FOR_CS_$1 =
    ...
    public static final String INCONSISTENT_PROPERTY_$1 =
    ...
    public static final String OUT_OF_PROJECTION_VALID_AREA_$1 =
    ...
    public static final String NON_CARTESIAN_COORDINATE_SYSTEM_$1 =
            "Coordinate system \"{0}\" is not cartesian.";
    public static final String INCOMPATIBLE_COORDINATE_SYSTEM_TYPE =
            "Incompatible coordinate system type.";
    public static final String UNEXPECTED_IMAGE_SIZE = "Image doesn't have the expected size.";
    public static final String MISMATCHED_DIMENSION_$2 =
            "Mismatched object dimension: {0}D and {1}D.";
    public static final String MISMATCHED_DIMENSION_$3 =
    ...
    public static final String NON_CONVERTIBLE_UNITS_$2 =
    ...
    public static final String LINE_TOO_LONG_$3 =
    ...
    public static final String NON_EQUILIBRATED_PARENTHESIS_$2 =
            "Unmatched parenthesis in \"{0}\": missing '{1}'.";
    public static final String GEOTOOLS_EXTENSION_REQUIRED_$1 =
    ...
    public static final String NO_TRANSFORM2D_AVAILABLE =
    ...
    public static final String ILLEGAL_COORDINATE_REFERENCE_SYSTEM =
    ...
    public static final String ILLEGAL_OCCURS_FOR_PARAMETER_$4 =
    ...
    public static final String NOT_AN_ANGLE_OBJECT_$1 =
            "Can't format object of class \"{1}\" as an angle.";
    public static final String MIXED_CATEGORIES =
            "Geophysics categories mixed with non-geophysics ones.";
    public static final String NO_SUCH_AUTHORITY_CODE_$2 =
            "No object of type \"{0}\" has been found for code \"{1}\".";
    public static final String ILLEGAL_CS_DIMENSION_$1 =
            "Coordinate system can't have {0} dimensions.";
    public static final String NO_SUCH_AUTHORITY_CODE_$3 =
            "No code \"{0}\" from authority \"{1}\" found for object of type \"{2}\".";
    public static final String NO_TRANSFORMATION_PATH_$2 =
    ...
    public static final String ILLEGAL_ARRAY_LENGTH_FOR_DIMENSION_$1 =
    ...
    public static final String ILLEGAL_COORDINATE_SYSTEM_FOR_CRS_$2 =
    ...
    public static final String CANT_CONCATENATE_TRANSFORMS_$2 =
            "Can't concatenate transforms \"{0}\" and \"{1}\".";
    public static final String NO_TRANSFORM_FOR_CLASSIFICATION_$1 =
            "No transform for classification \"{0}\".";
    public static final String HEADER_UNEXPECTED_LENGTH_$1 =
    ...
    public static final String DATE_OUTSIDE_COVERAGE_$1 =
            "Date {0} is outside the range of available data.";
    public static final String PROJECTION_CHECK_FAILED_$4 =
    ...
    public static final String NUMBER_OF_BANDS_MISMATCH_$3 =
            "The number of image bands ({0}) differs from the number of supplied '{2}' objects ({1}).";
    public static final String CANT_GET_DATASOURCE_$1 =
            "Failed to get the data source for name \"{0}\".";
    public static final String NEGATIVE_COLUMN_$2 =
            "Column number for \"{0}\" ({1}) can't be negative.";
    public static final String COVERAGE_ALREADY_BOUND_$2 =
            "Coverage returned by '{0}' is already the view of coverage \"{1}\".";
    public static final String GRID_LOCATIONS_UNEQUAL =
            "Latitude and Longitude grid locations are not equal";
    public static final String ILLEGAL_CLASS_$2 =
    ...
    public static final String PARSE_EXCEPTION_$2 =
            "Unparsable string: \"{0}\". Please check characters \"{1}\".";
    public static final String CANT_SET_PARAMETER_VALUE_$1 =
            "Can't set a value to the parameter \"{0}\".";
    public static final String MISMATCHED_ENVELOPE_CRS_$2 =
            "The envelope uses an incompatible CRS: was \"{1}\" while we expected \"{0}\".";
    public static final String NULL_PARAMETER_$2 =
            "\"{0}\" parameter should be not null and of type \"{1}\".";
    public static final String CANT_CREATE_FROM_TEXT_$1 =
            "Can't create object of type '{0}' from a text.";
    public static final String INCOMPATIBLE_ELLIPSOID_$2 =
            "Projection parameter \"{0}\" is incompatible with ellipsoid \"{1}\".";
    public static final String ODD_ARRAY_LENGTH_$1 =
            "Bad array length: {0}. An even array length was expected.";
    public static final String INCONSISTENT_AXIS_ORIENTATION_$2 =
    ...
    public static final String NON_AFFINE_TRANSFORM =
    ...
    public static final String NON_LINEAR_UNIT_CONVERSION_$2 =
            "Unit conversion from \"{0}\" to \"{1}\" is non-linear.";
    public static final String NON_PERPENDICULAR_AXIS_$2 =
