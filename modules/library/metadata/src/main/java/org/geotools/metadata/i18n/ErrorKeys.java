...
public final class ErrorKeys {
    ...
    /**
     * The transform result may be {0} meters away from the expected position. Are you sure that the
     * input coordinates are inside this map projection area of validity? The point is located {1}
     * away from the central meridian and {2} away from the latitude of origin. The projection is
     * "{3}".
     */
