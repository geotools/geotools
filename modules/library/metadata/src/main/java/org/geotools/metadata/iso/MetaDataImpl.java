...
public class MetaDataImpl extends MetadataEntity implements MetaData {
    ...
    /**
     * Information about an alternatively used localized character strings for linguistic
     * extensions.
     */
    ...
    /**
     * Date that the metadata was created, in milliseconds ellapsed since January 1st, 1970. If not
     * defined, then then value is {@link Long#MIN_VALUE}.
     */
     ...
     */
    public MetaDataImpl(
            final ResponsibleParty contact,
    ...
    public synchronized void setSpatialRepresentationInfo(
        ...
        spatialRepresentationInfo =
                copyCollection(newValues, spatialRepresentationInfo, SpatialRepresentation.class);
    }
    ...
    public synchronized void setMetadataExtensionInfo(
        ...
        metadataExtensionInfo =
                copyCollection(
                        newValues, metadataExtensionInfo, MetadataExtensionInformation.class);
    }
    ...
    public synchronized void setPortrayalCatalogueInfo(
        ...
        portrayalCatalogueInfo =
                copyCollection(
                        newValues, portrayalCatalogueInfo, PortrayalCatalogueReference.class);
    }
    ...
    public synchronized void setApplicationSchemaInfo(
        ...
        applicationSchemaInfo =
                copyCollection(
                        newValues, applicationSchemaInfo, ApplicationSchemaInformation.class);
    }
