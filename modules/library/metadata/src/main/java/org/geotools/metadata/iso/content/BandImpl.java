...
public class BandImpl extends RangeDimensionImpl implements Band {
     ...
     * band of each pixel. {@code null} if unspecified.
     */
    private Integer bitsPerValue;

    /** Number of discrete numerical values in the grid data. {@code null} if unspecified. */
    private Integer toneGradation;

    /** Scale factor which has been applied to the cell value. {@code null} if unspecified. */
    private Double scaleFactor;

    /** The physical value corresponding to a cell value of zero. {@code null} if unspecified. */
