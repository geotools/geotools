...
public class LineageImpl extends MetadataEntity implements Lineage {
     ...
     * be provided only if {@linkplain ScopeImpl#getLevel scope level} is {@linkplain
     * ScopeCode#DATASET dataset} or {@linkplain ScopeCode#SERIES series}.
     */
    ...
    /**
     * Returns the general explanation of the data producers knowledge about the lineage of a
