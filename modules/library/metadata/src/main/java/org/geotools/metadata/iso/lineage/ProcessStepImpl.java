...
public class ProcessStepImpl extends MetadataEntity implements ProcessStep {
    ...
    /**
     * Date and time or range of date and time on or over which the process step occurred, in
     * milliseconds ellapsed since January 1st, 1970. If there is no such date, then this field is
     * set to the special value {@link Long#MIN_VALUE}.
     */
    private long date;
