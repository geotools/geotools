...
public class Line implements Cloneable, Serializable {
    ...
    /** Value of <var>x</var> at <var>y</var>==0. This value is used for vertical lines. */
    private double x0;
    ...
    /**
     * Construct a line with the specified slope and offset. The linear equation will be
     * <var>y</var>=<var>slope</var>*<var>x</var>+<var>y0</var>.
     *
    ...
    /**
     * Sets the slope and offset for this line. The linear equation will be
     * <var>y</var>=<var>slope</var>*<var>x</var>+<var>y0</var>.
     *
     * @param slope The slope.
     * @param y0 The <var>y</var> value at <var>x</var>==0.
