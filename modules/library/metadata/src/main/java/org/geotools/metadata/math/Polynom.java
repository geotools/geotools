 ...
 *
 * <p>The static method {@link #roots(double[])} can be used for computing the root of a polynomial
...
public class Polynom implements Serializable {
    ...
    /**
     * Evaluates this polynomial equation for the specified <var>x</var> value. More specifically,
     * this method compute <code>c<sub>0</sub> +
     *       c<sub>1</sub>&times;<var>x</var> +
     *       c<sub>2</sub>&times;<var>x</var><sup>2</sup> +
     *       c<sub>3</sub>&times;<var>x</var><sup>3</sup> + ... +
     *       c<sub>n</sub>&times;<var>x</var><sup>n</sup></code>.
    ...
    /**
     * Display to the standard output the roots of a polynomial equation. More specifically, this
     * method solve the following equation:
     *
     * <blockquote>
     *
     * <code>
