...
/**
 * The result of a query for metadata attributes. This object {@linkplain PreparedStatement prepares
 * a statement} once for ever for a given table. When a particular record in this table is fetched,
 * the {@link ResultSet} is automatically constructed. If many attributes are fetched consecutivly
...
final class MetadataResult {
    ...
    /**
     * The identifier (usually the primary key) for current results. If the record to fetch doesn't
    ...
    /**
     * Returns the string value in the first column of the given record. This is used for fetching
     * the name of a code list element.
     *
    ...
    /**
     * Close this statement and free all resources. After this method has been invoked, this object
