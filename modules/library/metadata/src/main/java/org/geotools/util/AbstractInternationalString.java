 ...
 * locales}. This class is used as a replacement for the {@link String} type whenever an attribute
 * needs to be internationalization capable. The default value (as returned by {@link #toString()}
 * and other {@link CharSequence} methods} is the string in the current {@linkplain
 * Locale#getDefault system default}.
 *
 * <p>The {@linkplain Comparable natural ordering} is defined by the string in {@linkplain
 * Locale#getDefault default locale}, as returned by {@link #toString()}. This string also defines
...
public abstract class AbstractInternationalString implements InternationalString {
    /**
     * The string in the {@linkplain Locale#getDefault system default} locale, or {@code null} if
     * this string has not yet been determined. This is the default string returned by {@link
     * #toString()} and others methods from the {@link CharSequence} interface.
     *
     * <p>This field is not serialized because serialization is often used for data transmission
     * between a server and a client, and the client may not use the same locale than the server. We
     * want the locale to be examined again on the client side.
     *
    ...
    /**
     * Returns the character of the string in the {@linkplain Locale#getDefault default locale} at
     * the specified index. This is the character of the string returned by {@link #toString()}.
     *
    ...
    /**
     * Returns a subsequence of the string in the {@linkplain Locale#getDefault default locale}. The
     * subsequence is a {@link String} object starting with the character value at the specified
    ...
    /**
     * Compares this string with the specified object for order. This method compare the string in
     * the {@linkplain Locale#getDefault default locale}, as returned by {@link #toString()}.
     *
