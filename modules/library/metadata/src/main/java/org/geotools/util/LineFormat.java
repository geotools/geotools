...
public class LineFormat extends Format {
    ...
    /**
     * Number of valid data in the {@link #data} array. This is the number of data found last time
     * {@link #setLine(String)} has been invoked.
     */
    private int count;
    ...
    /**
     * Returns the value at the specified index. The index should be in the range 0 inclusively to
     * {@link #getValueCount} exclusively.
     *
