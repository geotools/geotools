 ...
 * elements in an array, as well as resizing the array. This class may be removed if JavaSoft
...
public final class XArray {
    ...
    /**
     * Returns an array containing the same elements as the given {@code array} but specified {@code
     * length}, truncating or padding with zeros if necessary.
     *
     * @param array Array to copy.
     * @param length Length of the desired array.
     * @return A new array of the requested length, or {@code array} if the original array already
     ...
     * @return Array with the same elements than the given {@code array} except for the removed
     *     elements, or {@code array} if {@code length} is 0.
     */
    ...
    /**
     * Returns {@code true} if all elements in the specified array are in increasing order. This
     * method is usefull in assertions.
     */
    ...
    /**
     * Returns {@code true} if all values in the specified array are equals to the specified value,
    ...
    /**
     * Returns {@code true} if the specified array contains at least one {@link Float#NaN NaN}
     * value.
     */
    ...
    /**
     * Returns {@code true} if the specified array contains at least one {@link Double#NaN NaN}
     * value.
     */
    ...
    /**
     * Returns {@code true} if the specified array contains the specified value, ignoring case. This
     * method should be used only for very small arrays.
     *
    ...
    /**
     * Returns {@code true} if the specified array contains the specified value. This method should
     * be used only for very small arrays, or for search to be performed only once, because it
     * performs a linear search. If more than one search need to be done on the same array, consider
     * using {@link java.util.HashSet} instead.
     *
