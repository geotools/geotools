...
public final class Log4J2Logger extends LoggerAdapter {
    ...
    private static org.apache.logging.log4j.Level toLog4JLevel(final Level level) {
        ...
        return switch (n / 100) {
            case 11 -> org.apache.logging.log4j.Level.FATAL;
            case 10 -> org.apache.logging.log4j.Level.ERROR;
            case 9 -> org.apache.logging.log4j.Level.WARN;
            case 8 -> org.apache.logging.log4j.Level.INFO;
            case 7 -> CONFIG;
            case 6, 5 -> org.apache.logging.log4j.Level.DEBUG;
            case 4 -> org.apache.logging.log4j.Level.TRACE;
            case 3 -> FINEST;
            case 2, 1, 0 -> org.apache.logging.log4j.Level.ALL;
            default ->
                switch (n) {
                    case Integer.MIN_VALUE -> org.apache.logging.log4j.Level.ALL;
                    case Integer.MAX_VALUE -> org.apache.logging.log4j.Level.OFF;
                    default -> (n >= 0 ? org.apache.logging.log4j.Level.FATAL : org.apache.logging.log4j.Level.ALL);
                };
        };
    }
