...
public abstract class LoggerFactory<L> {
    /**
     * The logger class. We ask for this information right at construction time in order to force a
     * {@link NoClassDefFoundError} early rather than only the first time a message is logged.
     */
     ...
     *   <li>the implementation instance (Log4J, SLF4J, <cite>etc.</cite>) returned by <code>
