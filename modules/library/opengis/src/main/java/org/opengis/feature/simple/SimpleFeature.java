...
public interface SimpleFeature extends Feature {
     ...
     *
     * <p>This method is a synonym for {@link #getType()}.
     *
     * @see #getType()
     */
    ...
    /**
     * Returns a list of the values of the attributes contained by the feature. <br>
     *
     ...
     *
     * <p>The <tt>values</tt> must be in the order of the attributes defined by the feature type.
     *
     * <p>This method is a convenience for:
     *
     * <pre>
     ...
     * </pre>
     *
     * @return The default geometry, or <code>null</code> if no default geometry attribute exists.
     */
