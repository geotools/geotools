 ...
 *
 * <p>The definition of a "simple feature" can be summed up as the following:
 *
 * <ul>
...
public interface SimpleFeatureType extends FeatureType {
     ...
     *
     * <p>Specifically this method returns <code>getName().getLocalPart().</code>
     *
     ...
     *
     * <p>This method is convenience for <code>getAttributes().size()</code>.
     *
     ...
     * </pre>
     *
     * <p>If there is no such attribute which matches <tt>name</tt>, <code>null</code> is returned.
     *
     * @param name The name of the attribute whose type to return.
     * @return The attribute type matching the specified name, or <code>null</code>.
     */
     ...
     * </pre>
     *
     * @param index The index of the attribute whose type to return.
     ...
     *
     * <p>-1 is returned in the instance there is no attribute matching the specified name.
     *
