 ...
 *
 * <p>Implementations of this interface should not contain any "special logic" for creating types.
 * Method implementations should be straight through calls to a constructor.
 *
...
public interface FeatureTypeFactory {
     ...
     *
     * @param type The type of the described association.
     * @param name The name of the described association.
     * @param minOccurs The minimum number of occurences of the described association.
     * @param maxOCcurs The maximum number of occurences of the described association.
     * @param isNillable Flag indicating wether the association is allowed to be <code>null</code>.
     */
     ...
     * @param name The name of the described attribute.
     ...
     * @param relatedType The type of attributes referenced by the association.
     ...
     *
     * @param name The name of the type.
     * @param binding The class that values of attributes of the type.
     * @param isIdentifiable Flag indicating if the attribute is identifiable.
     * @param isAbstract Flag indicating if the type is abstract.
     ...
     *
     * @param name The name of the type.
     * @param binding The class of values of attributes of the type.
     ...
     *
     * @param name The name of the type.
     * @param schema Collection of property descriptors which define the type.
     * @param isIdentifiable Flag indicating if the attribute is identifiable.
     * @param isAbstract Flag indicating if the type is abstract.
     * @param restrictions Set of restrictions on the attribute.
     * @param superType Parent type.
     ...
     *
     * @param name The name of the type.
     * @param schema List of attribute descriptors which define the type.
     * @param isAbstract Flag indicating if the type is abstract.
     * @param restrictions Set of restrictions on the attribute.
     * @param superType Parent type.
     * @param description A description of the type.
