...
public interface Operator {
     ...
     * with the interfaces defined in org.opengis.filter. Because this binding is formal we should
     * replace Operator here with a CodeList and capture it as part of the GeoAPI project.
     *
