 ...
 * space. In 2-dimensional Cartesian parameter space, (<var>u</var>, <var>v</var>), transforms into
 * a 3-dimensional coordinate reference system, (<var>x</var>, <var>y</var>, <var>z</var>), by using
 * an affine transformation, (<var>u</var>, <var>v</var>) &rarr; (<var>x</var>, <var>y</var>,
 * <var>z</var>), which is defined:
 *
 * <p><center>(TODO: paste the matrix here)</center>
 *
 * <p>Then, given this equation, the {@link #getLocation} method returns the direct position
 * (<var>x</var><sub>0</sub>, <var>y</var><sub>0</sub>, <var>z</var><sub>0</sub>), which is the
 * target position of the origin in (<var>u</var>, <var>v</var>). The two {@linkplain
 * #getReferenceDirection reference directions} (<var>u</var><sub>x</sub>, <var>u</var><sub>y</sub>,
 * <var>u</var><sub>z</sub>) and (<var>v</var><sub>x</sub>, <var>v</var><sub>y</sub>,
 * <var>v</var><sub>z</sub>) are the target directions of the unit basis vectors at the origin in
 * (<var>u</var>, <var>v</var>).
 *
...
public interface AffinePlacement extends Placement {
    /**
     * Gives the target of the parameter space origin. This is the vector (<var>x</var><sub>0</sub>,
     * <var>y</var><sub>0</sub>, <var>z</var><sub>0</sub>) in the formulae in the class description.
     */
