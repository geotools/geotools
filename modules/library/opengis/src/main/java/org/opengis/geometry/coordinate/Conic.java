 ...
 * co-ordinates (&rho;, &phi;) as:
 *
 * <p><center><img src="doc-files/ConicCurve.png"></center>
 *
 * <p>where "<var>P</var>" is semi-latus rectum and "<var>e</var>" is the eccentricity. This gives a
 ...
 *
 * <p>For <var>e</var>=0, this is a circle. For 0&nbsp;&lt;&nbsp;<var>e</var>&nbsp;&lt;&nbsp;1, this
 * is an ellipse. For <var>e</var>=1, this is a parabola. For <var>e</var>&gt;1, this is one branch
 * of a hyperbola.
 *
 ...
 * <var>v</var>=<var>&rho;</var>sin(<var>&phi;</var>). We can then convert this to a 3D coordinate
 * reference system by using an affine transformation, (<var>u</var>,&nbsp;<var>v</var>) &rarr;
 * (<var>x</var>,&nbsp;<var>y</var>,&nbsp;<var>z</var>) which is defined by:
 *
 * <p><center>(TODO: paste the matrix here, same as AffinePlacement)</center>
 *
 * <p>This gives us <var>&phi;</var> as the constructive parameter. The {@linkplain DirectPosition
 * direct position} given by (<var>x</var><sub>0</sub>, <var>y</var><sub>0</sub>,
 * <var>z</var><sub>0</sub>) is the image of the origin in the local coordinate space (<var>u</var>,
 * <var>v</var>) Alternatively, the origin may be shifted to the vertex of the conic as
 *
 * <p><var>u'</var> = <var>&rho;</var>cos(<var>&phi;</var>) - P/(1 + <var>e</var>)
 * &nbsp;&nbsp;and&nbsp;&nbsp; <var>v'</var> = <var>&rho;</var>sin(<var>&phi;</var>)
 *
 * <p>and <var>v</var> can be used as the constructive parameter. In general, conics with small
...
public interface Conic extends CurveSegment {
    ...
    /**
     * Returns the value of the eccentricity parameter "<var>e</var>" used in the defining equation
    ...
    /**
     * Returns the value of the parameter "<var>P</var>" used in the defining equation above. It
