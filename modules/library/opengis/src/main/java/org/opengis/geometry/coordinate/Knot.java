 ...
 * two knot sequences, one for each parameter (<var>u</var>, <var>v</var>). The
 * <var>i</var><sup>th</sup>, <var>j</var><sup>th</sup> would be (<var>u<sub>i</sub></var>,
 * <var>v<sub>j</sub></var>), where the original knot sequences were (<var>u<sub>i</sub></var>) and
 * (<var>v<sub>j</sub></var>). Each knot of a spline curve or surface is described using a {@code
 * Knot}.
 *
