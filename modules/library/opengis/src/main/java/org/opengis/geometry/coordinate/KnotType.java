...
/**
 * The type of a B-spline. A B-spline is uniform if and only if all knots are of {@linkplain
 * Knot#getMultiplicity multiplicity 1} and they differ by a positive constant from the preceding
 * knot. A B-spline is quasi-uniform if and only if the knots are of multiplicity (degree+1) at the
 * ends, of multiplicity 1 elsewhere, and they differ by a positive constant from the preceding
 * knot. This code list is used to describe the distribution of knots in the parameter space of
 * various splines.
 *
 * @source $URL$
