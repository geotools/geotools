 ...
 *
 * <p><strong>Example:</strong> If we take a gridded set of latitudes and longitudes in degrees,
 ...
 * </blockquote></pre>
 *
 * and map these points to 3D using the usual equations (where <var>R</var> is the radius of the
 * required sphere)
 *
 * <blockquote>
 *
 * <var>z</var> = <var>R</var> sin(<var>u</var>) <var>x</var> = <var>R</var> cos(<var>u</var>)
 * sin(<var>v</var>) <var>y</var> = <var>R</var> cos(<var>u</var>) cos(<var>v</var>)
 *
 * </blockquote>
 *
