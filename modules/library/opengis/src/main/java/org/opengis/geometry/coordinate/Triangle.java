 ...
 *
 * <p><strong>Note:</strong> The points in a triangle can be located in terms of their corner points
 ...
 *
 * <p><var>c</var><sub>1</sub> + <var>c</var><sub>2</sub> + <var>c</var><sub>3</sub> = 1.0.
 *
 * <p>Then, each point <var>P</var> in the triangle can be expressed for some set of barycentric
 * coordinates as:
 *
 * <p>
 *
