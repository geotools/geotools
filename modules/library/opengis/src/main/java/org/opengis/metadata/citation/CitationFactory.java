...
/**
 * A factory for metadata from the citation package. All factory methods accept null value for
...
public interface CitationFactory extends Factory {
     ...
     * @param electronicMailAddresses Address of the electronic mailbox of the responsible
     ...
     * @param address Physical and email address at which the organization or individual may be
     *     contacted.
     * @param onLineResource On-line information that can be used to contact the individual or
     *     organization.
     * @param hoursOfService Time period (including time zone) when individuals can contact the
     *     organization or individual.
     * @param contactInstructions Supplemental instructions on how or when to contact the individual
     *     or organization.
     * @return The contact.
     */
     ...
     * @param applicationProfile Name of an application profile that can be used with the online
     *     resource.
     ...
     *
     * @param voice Telephone number by which individuals can speak to the responsible organization
     *     or individual.
     * @param facsimile Telephone number of a facsimile machine for the responsible organization or
     *     individual.
     * @return The telephone.
     */
    Telephone createTelephone(String voice, String facsimile);
}
