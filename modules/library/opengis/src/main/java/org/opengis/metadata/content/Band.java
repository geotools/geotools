...
public interface Band extends RangeDimension {
    ...
    /**
     * Wavelength at which the response is the highest. Returns {@code null} if unspecified.
     *
     ...
     * band of each pixel. Returns {@code null} if unspecified.
     *
    ...
    /**
     * Number of discrete numerical values in the grid data. Returns {@code null} if unspecified.
     *
    ...
    /**
     * Scale factor which has been applied to the cell value. Returns {@code null} if unspecified.
     *
    ...
    /**
     * The physical value corresponding to a cell value of zero. Returns {@code null} if
     * unspecified.
     *
