...
public interface ImageDescription extends CoverageDescription {
    ...
    /**
     * Count of the number the number of lossy compression cycles performed on the image. Returns
     * {@code null} if the information is not provided.
     *
     * @return The number the number of lossy compression cycles performed on the image, or {@code
     *     null} if unknown.
     */
    @UML(
    ...
    /**
     * Indication of whether or not triangulation has been performed upon the image. Returns {@code
     ...
     *
     * @return Whether or not the radiometric calibration information is available, or {@code null}
     *     if unknown.
     */
    @UML(
     ...
     * corrections.
     *
     * @return Whether or not constants are available for camera calibration corrections, or {@code
     *     null} if unknown.
     */
    @UML(
     ...
     *
     * @return Whether or not Calibration Reseau information is available, or {@code null} if
     *     unknown.
     */
    @UML(
     ...
     *
     * @return Whether or not lens aberration correction information is available, or {@code null}
     *     if unknown.
     */
    @UML(
