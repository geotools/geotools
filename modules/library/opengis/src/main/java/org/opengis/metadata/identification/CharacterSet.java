...
public final class CharacterSet extends CodeList<CharacterSet> {
    ...
    /**
     * Constructs an enum with identical name and charset. This is needed for {@link
     ...
     * @see <A
     *     HREF="http://java.sun.com/javase/6/docs/technotes/guides/intl/encoding.doc.html">Supported
     *     encodings</A>
     */
