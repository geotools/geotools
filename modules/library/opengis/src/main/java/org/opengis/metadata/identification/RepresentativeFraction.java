 ...
 *
 * <p>Implementations are encouraged to extend {@link Number} in a manner equivalent to:
 *
 * <blockquote>
 *
 * <pre>
...
public interface RepresentativeFraction {
    ...
    /**
     * Compares this representative fraction with the specified object for equality. {@code
     * RepresentativeFraction} is a data object - {@code equals} is defined acoording to {@link
     * #getDenominator};
     *
     * <p>Implementations should match the following:
     *
     * <blockquote>
     *
     * <pre>
    ...
    /**
     * Returns a hash value for this representative fraction. {@code RepresentativeFraction} is a
     * data object - {@code hashcode} is defined according to {@link #getDenominator}.
     *
     * <p>Implementations should match the following:
     *
     * <blockquote>
