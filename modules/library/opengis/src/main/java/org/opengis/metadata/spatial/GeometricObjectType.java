...
public final class GeometricObjectType extends CodeList<GeometricObjectType> {
    ...
    /**
     * Bounded, connected 3-dimensional geometric primitive, representing the continuous image of a
     * region of space.
     */
    ...
    /**
     * Bounded, connected 2-dimensional geometric, representing the continuous image of a region of
     * a plane.
     */
    ...
    /**
     * Returns the geometric object type that matches the given string, or returns a new one if none
     * match it.
     *
