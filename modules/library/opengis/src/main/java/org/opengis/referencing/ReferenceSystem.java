 ...
 *
 * @departure This interface was initially derived from an ISO 19111 specification published in
 *     2003. Later revisions (in 2005) rely on an interface defined in ISO 19115 instead. The
...
public interface ReferenceSystem extends IdentifiedObject {
     ...
     * to be returned by {@link #getDomainOfValidity}.
     *
     ...
     * Key for the <code>{@value}</code> property to be given to the {@linkplain ObjectFactory
     * object factory} <code>createFoo(&hellip;)</code> methods. This is used for setting the value
     * to be returned by {@link #getScope}.
     *
     * @see #getScope
     */
