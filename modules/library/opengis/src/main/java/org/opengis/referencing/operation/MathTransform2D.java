...
public interface MathTransform2D extends MathTransform {
     ...
     * ptDst} is {@code null}, a new {@link Point2D} object is allocated and then the result of the
     ...
     * @param ptDst the coordinate point that stores the result of transforming {@code ptSrc}, or
     *     {@code null} if a new point should be created.
     ...
     * @return The transformed shape. Some implementations may returns {@code shape} unmodified if
     ...
     * non-translating portion of the approximate affine map at the point.
     *
     ...
     * @return The derivative at the specified point as a 2&times;2 matrix. This method never
     *     returns an internal object: changing the matrix will not change the state of this math
     *     transform.
