 ...
 */
public class Envelope2D extends Rectangle2D.Double implements BoundingBox, Bounds, Cloneable {
     ...
     */
    public Envelope2D(final Bounds envelope) {
        super(
     ...
     * @since 2.4
     */
    public Envelope2D(final Position2D minDP, final Position2D maxDP)
