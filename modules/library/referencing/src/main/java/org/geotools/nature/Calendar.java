...
/**
 * Approximations de quelques calculs astronomiques relatifs aux calendriers terrestres. Les
 * différents cycles astronomiques (notamment le jour, le mois et l'année) ne sont pas constants.
 * Par exemple, la longueur de l'année tropicale (le nombre moyen de jours entre deux équinoxes
 * vernales) était d'environ 365,242196 jours en 1900 et devrait être d'environ 365,242184 jours en
 * 2100, soit un changement d'environ 1 seconde. Cette classe permet de calculer la longueur d'une
 * année ou d'un mois à une date spécifiée. Toutefois, il est important de noter que les intervalles
 * de temps calculés par les méthodes de cette classe sont des <strong>moyennes</strong>. Pour une
 * année en particulier, l'intervalle de temps d'un équinoxe vernale au prochain peut s'écarter de
 * cette moyenne de plusieurs minutes.
 *
 ...
 * Chapront (1988).On peut lire plus de détails au sujet des calendrier terrestre au site <a
...
public final class Calendar {
    /**
     * Nombre de millisecondes dans une journée. Cette constante est utilisée pour convertir des
     * intervalles de temps du Java en nombre de jours.
     */
    private static double MILLIS_IN_DAY = 1000 * 60 * 60 * 24;

    /**
     * Jour julien correspondant à l'époch du Java (1er janvier 1970 à minuit). Cette constante est
     * utilisée pour convertir des dates du Java en jour julien.
     *
     * <p>La valeur {@link #julianDay} du 1er janvier 2000 00:00 GMT est 2451544.5 jours. La valeur
     * {@link Date#getTime} du 1er janvier 2000 00:00 GMT est 10957 jours.
     */
    ...
    /**
     * Retourne le jour julien d'une date. Il ne s'agit pas du jour julien dans une année. Ce jour
     * julien là (nommé ainsi pour <i>Julius Scaliger</i>, et non <i>Julius Caesar</i>) est le
     * nombre de jours écoulés depuis midi le 1er janvier 4713 avant Jésus-Christ.
     */
    ...
    /**
     * Affiche la longueur de l'année tropicale et du mois synodique pour une date donnée. Cette
     * application peut être lancée avec la syntaxe suivante:
     *
