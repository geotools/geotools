...
public class DefaultCoordinateSystemAxis extends AbstractIdentifiedObject
    ...
    public static final DefaultCoordinateSystemAxis X =
            new DefaultCoordinateSystemAxis(-1, "x", AxisDirection.EAST, SI.METER);
    ...
    public static final DefaultCoordinateSystemAxis Y =
            new DefaultCoordinateSystemAxis(-1, "y", AxisDirection.NORTH, SI.METER);
    ...
    public static final DefaultCoordinateSystemAxis Z =
            new DefaultCoordinateSystemAxis(-1, "z", AxisDirection.UP, SI.METER);
    ...
    public static final DefaultCoordinateSystemAxis DISPLAY_X =
            new DefaultCoordinateSystemAxis(-1, "x", AxisDirection.DISPLAY_RIGHT, Unit.ONE);
    ...
    public static final DefaultCoordinateSystemAxis DISPLAY_Y =
            new DefaultCoordinateSystemAxis(-1, "y", AxisDirection.DISPLAY_DOWN, Unit.ONE);
