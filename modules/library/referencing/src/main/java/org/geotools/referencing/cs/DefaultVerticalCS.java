...
public class DefaultVerticalCS extends AbstractCS implements VerticalCS {
    ...
    /**
     * A one-dimensional vertical CS with <var>{@linkplain DefaultCoordinateSystemAxis#ELLIPSOIDAL_HEIGHT ellipsoidal
     * height}</var> axis in metres.
     */
    public static DefaultVerticalCS ELLIPSOIDAL_HEIGHT =
            new DefaultVerticalCS(DefaultCoordinateSystemAxis.ELLIPSOIDAL_HEIGHT);

    /**
     * A one-dimensional vertical CS with <var>{@linkplain DefaultCoordinateSystemAxis#DEPTH depth}</var> axis in
     * metres.
     */
    ...
    /**
     * Constructs a coordinate system with the same properties than the specified axis. The inherited properties include
     * the {@linkplain #getName name} and aliases.
     *
     * @param axis The axis.
     * @since 2.5
     */
     ...
     * implementation accepts only vertical directions (i.e. {@link AxisDirection#UP UP} and {@link AxisDirection#DOWN
     * DOWN}).
     */
    @Override
