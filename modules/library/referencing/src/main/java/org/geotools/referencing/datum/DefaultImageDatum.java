...
public class DefaultImageDatum extends AbstractDatum implements ImageDatum {
    ...
    /**
     * Constructs an image datum from a set of properties. The properties map is given unchanged to the
    ...
    /**
     * Returns a hash value for this image datum. {@linkplain #getName Name}, {@linkplain #getRemarks remarks} and the
     * like are not taken in account. In other words, two image datums will return the same hash value if they are equal
