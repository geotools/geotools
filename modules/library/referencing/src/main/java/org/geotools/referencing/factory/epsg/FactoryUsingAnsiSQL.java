...
public class FactoryUsingAnsiSQL extends FactoryUsingSQL {
     ...
     * @since 2.2
     */
    public FactoryUsingAnsiSQL(final Hints userHints, final Connection connection) {
     ...
     * @since 2.5
     */
    public FactoryUsingAnsiSQL(final Hints userHints, final DataSource dataSource) {
