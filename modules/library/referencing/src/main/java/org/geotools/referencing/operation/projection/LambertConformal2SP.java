...
public class LambertConformal2SP extends LambertConformal {
     ...
     * provider} for a {@linkplain LambertConformal2SP Lambert Conformal 2SP} projection (EPSG code
     * 9802).
     *
     * @since 2.2
     * @version $Id$
    ...
    public static class Provider extends AbstractProvider {
        ...
        protected MathTransform createMathTransform(final ParameterValueGroup parameters)
            ...
            } else if (Utilities.equals(
                            doubleValue(STANDARD_PARALLEL_1, parameters),
