...
public class EnvelopeReprojectorTest {
    ...
    /** Tests the transformations of an envelope when the two CRS have identity transforms but different datum names */
    @Test
    ...
    /**
     * Tests the transformations of a rectangle using a coordinate operation. With assertions enabled, this also test
     * the transformation of an envelope.
     */
    @Test
