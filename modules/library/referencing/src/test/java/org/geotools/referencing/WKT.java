...
/**
 * Predefined CRS as WKT strings. Hard-coded constants are more convenient for debugging than
...
public final class WKT {
    ...
    public static final String SPHERE = "GEOGCS[\"Sphere\",\n"
            + "  DATUM[\"Sphere\",\n"
    ...
    public static final String NAD27 = "GEOGCS[\"NAD27\",\n"
    ...
    public static final String NAD83 = "GEOGCS[\"NAD83\",\n"
    ...
    public static final String WGS84 = "GEOGCS[\"WGS84\",\n"
            + "  DATUM[\"WGS84\",\n"
    ...
    public static final String WGS84_ALTERED = "GEOGCS[\"WGS84\",\n"
            + "  DATUM[\"WGS84_altered\",\n"
            + "    SPHEROID[\"WGS84\", 6378137.0, 298.257223563]],\n"
            + "  PRIMEM[\"Greenwich\", 0.0],\n"
            + "  UNIT[\"degree\", 0.017453292519943295],\n"
    ...
    public static final String WGS84_DMHS = "GEOGCS[\"WGS 84\",\n"
            + "  DATUM[\"WGS_1984\",\n"
    ...
    public static final String GEOGRAPHIC_NTF = "GEOGCS[\"NTF (Paris)\",\n"
    ...
    public static final String MERCATOR = "PROJCS[\"WGS 84 / World Mercator\",\n"
            + "  GEOGCS[\"WGS 84\",\n"
    ...
    /** Google projection. */
    public static final String MERCATOR_GOOGLE = "PROJCS[\"Google Mercator\",\n"
            + "  GEOGCS[\"WGS 84\",\n"
            + "    DATUM[\"World Geodetic System 1984\",\n"
            + "      SPHEROID[\"WGS 84\", 6378137.0, 298.257223563, AUTHORITY[\"EPSG\",\"7030\"]],\n"
            + "      AUTHORITY[\"EPSG\",\"6326\"]],\n"
    ...
    public static final String UTM_10N = "PROJCS[\"NAD_1983_UTM_Zone_10N\",\n"
    ...
    public static final String UTM_58S = "PROJCS[\"IGN53 Mare / UTM zone 58S\",\n"
            + "  GEOGCS[\"IGN53 Mare\",\n"
            + "    DATUM[\"IGN53 Mare\",\n"
    ...
    public static final String POLAR_STEREOGRAPHIC = "PROJCS[\"WGS 84 / Antarctic Polar Stereographic\",\n"
            + "  GEOGCS[\"WGS 84\",\n"
            + "    DATUM[\"World Geodetic System 1984\",\n"
    ...
    public static final String Z = "VERT_CS[\"ellipsoid Z in meters\",\n"
            + ""
    ...
    public static final String HEIGHT = "VERT_CS[\"mean sea level height\",\n"
