 ...
 * @author Roar Brænden
 */
public class ThirdEPSGFactory extends MockCRSAuthorityFactory {

    public ThirdEPSGFactory() {
        super(
                "Third",
                Citations.EPSG,
                MAXIMUM_PRIORITY - 52,
                new Hints(Hints.FORCE_LONGITUDE_FIRST_AXIS_ORDER, Boolean.FALSE, Hints.VERSION, new Version("3.0")));
    }
}
