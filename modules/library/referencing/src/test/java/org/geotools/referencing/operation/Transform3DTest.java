...
public final class Transform3DTest {
    ...
    /**
     * Tries to transforms some points using the specified operation. This method transforms two
     * points from the projected CRS to the geocentric CRS. The first point is on the ellipsoid, and
     * the second point is 10 km above the ellipsoid. After transformation to geocentric CRS using a
     * cartesian CS, the two points should still ten kilometers apart each others.
     *
