...
public class EsriNamedIdentifierAliasesTest{
    ...
    /**
     * Test citations for the ESRI wkt equivalent to EPSG:4398, which uses EPSG:9806 Cassini-Soldner projection method
     */
    @Test
    public void cassiniSoldnerCitation() throws Exception {
        // @formatter:off
        String cassiniSoldnerWkt = "PROJCS[\"Kertau_1968_Kelantan_Grid\","
                + "GEOGCS[\"GCS_Kertau\","
                ...
                + "UNIT[\"Meter\",1.0]]";
        checkCitation(cassiniSoldnerWkt, "PROJECTION[\"Cassini\"]", "PROJECTION[\"Cassini-Soldner\"]");
    }
    
    
    /**
     * Test citations for the ESRI wkt equivalent to EPSG:4087 CRS, which uses EPSG:1028 method - Equidistant Cylindrical [Ellipsoidal]
     */
    @Test
    public void equidistantCylindricalCitation() throws Exception {
        // @formatter:off
        String equidistantCylindricalWkt = "PROJCS[\"WGS_1984_World_Equidistant_Cylindrical\","
                ...
                + "UNIT[\"Meter\",1.0]]";
     // @formatter:on
        checkCitation(equidistantCylindricalWkt, "PROJECTION[\"Equidistant_Cylindrical_Ellipsoidal\"]", "PROJECTION[\"Equidistant Cylindrical\"]");
    }
    ...
    public void equidistantCylindricalSphericalEsriAuthorityCitation() throws Exception {
        ...
        // @formatter:on
        checkCitation(equidistantCylindricalSphericalWkt, "PROJECTION[\"Equidistant_Cylindrical\"]", "PROJECTION[\"Equidistant Cylindrical (Spherical)\"]");
    }
