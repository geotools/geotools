...
public class EsriNamedIdentifierAliasesTest {
    ...
    /**
     * Constructs a CRS by parsing the provided WKT, then checks to format the CRS back to WKT using ESRI and EPSG
     * citations, to ensure the right projection names are used.
     */
    ...
    /**
     * Test citations for the ESRI wkt equivalent to EPSG:4087 CRS, which uses EPSG:1028 method - Equidistant
    ...
    /**
     * Test citations for the ESRI wkt equivalent to EPSG:4088 CRS, which uses EPSG:1029 method - Equidistant
