 ...
 *
 * <p>The following OGC specifications (or working drafts) are the inspiration for this class:
 *
 * <ul>
...
public class MapContext extends MapContent {
     ...
     *
     * <p>This method is used to prevent duplication in classes supporting deprecated
     * getMapContext() methods.
     *
     ...
     *
     * @param featureSource a SimpleFeatureSource with the new layer that will be added.
     */
     ...
     * Add a new layer and trigger a {@link LayerListEvent}
     *
     * @param gridCoverage a GridCoverage with the new layer that will be added.
     */
     ...
     *
     * @param layer a MapLayer that will be added.
     ...
     *
     * <p>This implementation is more forgiving then getMaxBounds() as it is willing to consider the
     ...
     * Set the area of interest. This triggers a MapBoundsEvent to be published.
     *
     * @param bounds the new area of interest
     * @throws IllegalArgumentException if the provided areaOfInterest is {@code null} or does not
     ...
     *
     * <p>If the viewport has not been created, it will be filled in by default based on the layer
     * bounds provided by {@link #getMaxBounds()}.
     *
