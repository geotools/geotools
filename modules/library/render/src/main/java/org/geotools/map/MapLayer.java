 ...
 * interface code.
 *
 * <p>Please note that not all Layer implementations support Query and/or Style.
 *
...
public class MapLayer {
     ...
     */
    public MapLayer(GridCoverage coverage, Style style)
     ...
     * @throws TransformException
     */
    public MapLayer(GridCoverage coverage, Style style, String title)
            throws TransformException, FactoryRegistryException, SchemaException {
     ...
     * is changed.
     *
     * @param selected Set the layer as selected if <code>true</code> or as unselected if <code>
     *     false</code>
     */
     ...
     * returned. It is desirable to not include attributes at all but let the renderer decide which
     * attributes are actually needed to perform its required operation.
     *
     * <p>WARNING: We do not check if your query is suitable for the layer {@code FeatureSource} you
     ...
     */
    //    protected void fireMapLayerListenerLayerChanged(org.geotools.map.event.MapLayerEvent
    // event) {
     ...
     * @param event The event to be fired
     */
    //    protected void fireMapLayerListenerLayerSelected(org.geotools.map.event.MapLayerEvent
    // event) {
    //        internal.fireMapLayerListenerLayerSelected();
    //    }
