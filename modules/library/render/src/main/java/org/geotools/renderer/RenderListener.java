...
/**
 * A RenderListener is notified each time a feature is rendered and each time an error occurs during rendering.
 * Therefore <b>VERY LITTLE WORK</b> should be done in the listener!!!
 *
 * @author jeichar
 */
public interface RenderListener {
    ...
    /**
     * Reports a rendering error. The rendering is not normally stopped on it, a listener that wants to stop it can call
     * {@link GTRenderer#stopRendering()}
     */
