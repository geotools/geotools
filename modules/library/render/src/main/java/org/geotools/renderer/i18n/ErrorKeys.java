...
/** Common error messages/patterns for the {@code org.geotools.renderer} package. */
public final class ErrorKeys {
    ...
    public static String MUST_SHARE_GRIDGEOMETRY_$1 =
            "All the source for the {0} operation must share the same grid geometry.";
    public static String BAD_BAND_NUMBER_$1 = "Band number {0} is not valid.";
    public static String NULL_ARGUMENT_$1 = "Argument \"{0}\" should not be null.";
    public static String ILLEGAL_ARGUMENT_$1 = "Illegal value for argument \"{0}\".";
    public static String ILLEGAL_ARGUMENT_$2 = "Illegal argument: \"{0}\"= \"{1}\".";
    public static String ILLEGAL_STATE = "Illegal state.";
    public static String OPERATION_NOT_FOUND_$1 = "No such \"{0}\" operation for this processor.";
