...
public final class RendererUtilities {
     ...
     * 
     * Defaults to false to avoid disrupting a good number of SLDs out there.
     */
    static boolean SCALE_UNIT_COMPENSATION = Boolean.parseBoolean(System.getProperty("org.geotoools.render.lite.scale.unitCompensation", "false"));
