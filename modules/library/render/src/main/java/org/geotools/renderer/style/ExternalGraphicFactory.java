...
public interface ExternalGraphicFactory {
     ...
     * expressions embedded in the url.<br>
     * The <code>size</code> parameter defines the size of the image (so that vector based symbols
     ...
     * to the SLD spec).<br>
     * <code>null</code> will be returned if this factory cannot handle the provided url.
     */
