...
public class FillImplMarginTest {
    ...
    public void testFillSE11() throws Exception {
        StyleImpl style = RendererBaseTest.loadSEStyle(this, "margin/fill.sld");
    ...
    public void testFillSLD10() throws Exception {
        StyleImpl style = RendererBaseTest.loadStyle(this, "margin/fill10.sld");
    ...
    public void testMarkMargin() throws Exception {
        StyleImpl style = RendererBaseTest.loadStyle(this, "margin/mark-margin.sld");
    ...
    public void testFillSingle() throws Exception {
        StyleImpl style = RendererBaseTest.loadSEStyle(this, "margin/fill-single.sld");
    ...
    public void testMarkMarginAndRotation() throws Exception {
        StyleImpl style = RendererBaseTest.loadStyle(this, "margin/mark-margin-and-rotation.sld");
