...
public class FillImplTest {
    ...
    public void testFTSComposition() throws Exception {
        StyleImpl bgStyle = RendererBaseTest.loadStyle(this, "fillSolid.sld");
        StyleImpl fgStyle = RendererBaseTest.loadStyle(this, "fillSolidFTS.sld");
    ...
    public void testGEOT3111() throws Exception {
        ...
        StyleImpl style = SLD.wrapSymbolizers(sym);
