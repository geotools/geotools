...
public class GraphicsAwareDpiRescaleStyleVisitorTestImpl {
    ...
    public void testResizeMark() {
        ...
        ps.accept(visitor);
        PointSymbolizerImpl resized = (PointSymbolizerImpl) visitor.getCopy();
    ...
    public void testCombinedResizingDpiUom() {
        ...
        double scaleDpi = 2;
        double scaleUom = 3;
        PointSymbolizerImpl symbolizer = sb.createPointSymbolizer();
        ...
        symbolizer = (PointSymbolizerImpl) dpiVisitor.getCopy();
        ...
        symbolizer = (PointSymbolizerImpl) uomVisitor.getCopy();
