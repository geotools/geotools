...
public class LabelSpacingTest extends AbstractLabelLineTest {
    ...
    public void testLabelsIncreaseSpacing() throws Exception {
        ...
        Style style =
                loadParametricStyle(this, "lineStyleTemplate.sld", "VENDOR_KEY", "charSpacing", "VENDOR_VALUE", "10");
        // set the map content
        ...
        File reference =
                new File("./src/test/resources/org/geotools/renderer/lite/test-data/lineLabelsIncreaseSpacing.png");
    ...
    public void testLabelsDecreaseSpacing() throws Exception {
        ...
        Style style =
                loadParametricStyle(this, "lineStyleTemplate.sld", "VENDOR_KEY", "charSpacing", "VENDOR_VALUE", "-5");
        // set the map content
        BufferedImage image = renderNonStraightLines(featureSource, style, 1000, 1000, bounds);
        // let's see if the result image match our expectations
        File reference =
                new File("./src/test/resources/org/geotools/renderer/lite/test-data/lineLabelsDecreaseSpacing.png");
        ImageAssert.assertEquals(reference, image, 3000);
    }
    ...
    public void testLabelsIncreaseWordSpacing() throws Exception {
        ...
        Style style =
                loadParametricStyle(this, "lineStyleTemplate.sld", "VENDOR_KEY", "wordSpacing", "VENDOR_VALUE", "10");
        // set the map content
        BufferedImage image = renderNonStraightLines(featureSource, style, 1000, 1000, bounds);
        // let's see if the result image match our expectations
        File reference =
                new File("./src/test/resources/org/geotools/renderer/lite/test-data/lineLabelsIncreaseWordSpacing.png");
