...
public class RenderUtilitiesTest {
    ...
    /**
     * This tests a fix to handle Geographic CRSes (such as NAD83) whose domain of validity crosses the Date Line.
    ...
    /**
     * The following test is from the tile module where the behavior of RenderUtilities changed between 2.2. and 2.4.
     */
    @Test
