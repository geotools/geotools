...
/** @author jamesm */
public class SLDStyleFactoryTestImpl {
    ...
    public void testCreatePointStyle() {
        ...
        PointSymbolizerImpl pointsym = sf.createPointSymbolizer();
    ...
    public void testCreateCompletePointStyle() {
        // full symbolizer
        PointSymbolizerImpl symb = sf.createPointSymbolizer();
    ...
    public void testCreateDynamicExternalGraphics() throws Exception {
        ...
        PointSymbolizerImpl symb = sf.createPointSymbolizer();
        ExternalGraphicImpl eg = sf.createExternalGraphic(url + "${icon}", "image/png");
    ...
    public void testCreateDynamicExternalFormat() throws Exception {
        ...
        URL url = StreamingRenderer.class.getResource("test-data/");
        PointSymbolizerImpl symb = sf.createPointSymbolizer();
        ExternalGraphicImpl eg = sf.createExternalGraphic(url + "${icon}", "${symb}");
        symb.getGraphic().graphicalSymbols().add(eg);
    ...
    public void testNonExistingExternalGraphic() throws Exception {
        URL url = StreamingRenderer.class.getResource("test-data/");
        PointSymbolizerImpl symb = sf.createPointSymbolizer();
        ExternalGraphicImpl eg = sf.createExternalGraphic(url + "iAmNotThere.png", "image/png");
        symb.getGraphic().graphicalSymbols().add(eg);
    ...
    public void testNonExistingExternalGraphicNoFallback() throws Exception {
        ...
        ExternalGraphicImpl eg = sf.createExternalGraphic(url + "iAmNotThere.png", "image/png");
        symb.getGraphic().graphicalSymbols().add(eg);
        symb.getOptions().put(PointSymbolizerImpl.FALLBACK_ON_DEFAULT_MARK, "false");
    ...
    public void testUnknownFont() throws Exception {
        TextSymbolizerImpl ts = sf.createTextSymbolizer();
    ...
    private void checkSortByParsing(String sortBySpec, SortBy... expected) {
        ...
        options.put(org.geotools.styling.FeatureTypeStyleImpl.SORT_BY, sortBySpec);
    ...
    public void testGEOT5878() {
        ...
        StyleImpl style = sb.createStyle();
