...
public class StyleImplAttributeExtractorTest {
    ...
    public void testPlainFilter() {
        ...
        RuleImpl r = sb.createRule(sb.createPointSymbolizer());
        r.setFilter(f);
    ...
    public void testLineSymbolizer() {
        ...
        LineSymbolizerImpl lineSymbolizer = sb.createLineSymbolizer();
        lineSymbolizer.setPerpendicularOffset(expression);
        RuleImpl r = sb.createRule(lineSymbolizer);
