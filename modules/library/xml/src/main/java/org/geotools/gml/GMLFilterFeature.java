...
public class GMLFilterFeature extends XMLFilterImpl implements GMLHandlerJTS {
    ...
    private final GMLHandlerFeature parent;
     ...
     */
    public GMLFilterFeature(final GMLHandlerFeature parent) {
        super();
        this.parent = parent;
    }

    public void setSchema(final String uri) {}
    ...
    private boolean isFeatureMember(final String localName) {
    ...
    private void handleCharacters() throws SAXException {
        ...
        final String rawAttribute = characters.toString();
        characters.setLength(0);
    ...
    public void endElement(final String namespaceURI, final String localName, final String qName)
        ...
        if (isFeatureMember(localName)) {
            ...
            for (int i = 0, ii = attributes.size(); i < ii; i++) {
                ...
                final Class clazz = attributes.get(i).getClass();
                tb.add(name, clazz);
            }

            final SimpleFeatureType featureType = tb.buildFeatureType();

            try {
                final SimpleFeature feature =
                        SimpleFeatureBuilder.build(featureType, attributes, fid);
                parent.feature(feature);
            } catch (final IllegalAttributeException ife) {
                // TODO: work out what to do in this case!
                // _log.error("Unable to build feature",ife);
                // UNBELIEVABLE !!!!!!!!!!!!!!!!!!!!!!!!!!! - IanS
            }
    ...
    private void endAttribute() {
        final int index = attName.lastIndexOf('/');
