 ...
 * @version $Id$
 */
public class GMLFilterGeometry extends org.xml.sax.helpers.XMLFilterImpl implements GMLHandlerGeometry {
    /** Handler for the JTS elements generated by this filter. */
    private GMLHandlerJTS parent;

    /** Factory for the JTS geometries. */
    private org.locationtech.jts.geom.GeometryFactory geometryFactory = new org.locationtech.jts.geom.GeometryFactory();
    ...
    /**
     * Manages the end of a new main or sub geometry. This method looks at the status of the current handler and either
     * returns the finished JTS object to its parent or passes the element end notification along to the current handler
     * as a sub geometry notice.
     *
     * @param localName The local name of the geometry, which corresponds to an OGC simple feature type.
     * @throws SAXException parser error.
     */
