...
public abstract class XMLElementHandler implements Serializable {
    ...
    /**
     * This method throws a SAXNotSupportedException if it is called and not overwritten. When overridding this method,
     * you should be careful to understand that it may be called more than once per element. Therefore it would be
     * advisable to log the text and handle the text's interpretation at a later time (
     *
    ...
    /**
     * handles SAX end Element events. This matches the end of the element declaration in the document ... and responds
     * to the event generated by the SAX parser. This is an opportunity to complete some post-processing.
     *
    ...
    /**
     * handles SAX start Element events. This matches the start of the element declaration in the document ... and
     * responds to the event generated by the SAX parser. This is an opportunity to complete some pre-processing.
     *
    ...
    /**
     * This will find an appropriate XMLElementHandler for the specified child if appropriate. This method may return or
     * throw an exception, depending on the severity, if an error occurs. This method should be used to complete a SAX
     * parse of a document for which the Schema is known, and parsed.
     *
    ...
    /**
     * This returns the name of the element being represented by this handler. This name matches the name specified in
     * the Schema.
     *
