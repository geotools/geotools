...
public interface Type {
     ...
     * when ignoring data).
     *
     * <p>If the element had #CData (Nested Child Text), this will appear in the first slot, with a
     * null Element.
     *
     ...
     * @param value An Object which may or may not be encodeable by this type. The value may also be
     *     null.
