...
public class SchemaResolverTest {
    ...
    /**
     * Test that the example in the javadoc for {@link SchemaResolver#getSimpleHttpResourcePath(java.net.URI)} does in
     * fact work.
     */
    @Test
    public void exampleHttp() {
        String path = SchemaResolver.getSimpleHttpResourcePath("http://schemas.example.org/exampleml/exml.xsd");
    ...
    public void exampleHttps() {
        String path = SchemaResolver.getSimpleHttpResourcePath("https://schemas.example.org/exampleml/exml.xsd");
        Assert.assertEquals("/org/example/schemas/exampleml/exml.xsd", path);
    }
    ...
    public void portIgnored() {
        String path = SchemaResolver.getSimpleHttpResourcePath("http://schemas.example.org:8080/exampleml/exml.xsd");
        Assert.assertEquals("/org/example/schemas/exampleml/exml.xsd", path);
    }
    ...
    public void queryIgnored() {
        String path =
                SchemaResolver.getSimpleHttpResourcePath("http://schemas.example.org/exampleml/exml.xsd?q=ignored");
        Assert.assertEquals("/org/example/schemas/exampleml/exml.xsd", path);
    }
    ...
    public void getSimpleHttpResourcePath_KeepQueryTrue_ReturnPathHasQueryComponent() {
        String path = SchemaResolver.getSimpleHttpResourcePath(
    ...
    public void ftpReturnsNull() {
        Assert.assertNull(SchemaResolver.getSimpleHttpResourcePath("ftp://schemas.example.org/exampleml/exml.xsd"));
    }

    /** Test that a jar URL (not http/https) returns null. */
    @Test
    public void jarReturnsNull() {
        Assert.assertNull(SchemaResolver.getSimpleHttpResourcePath(
    ...
    public void badlyFormattedUrlReturnsNull() {
        Assert.assertNull(
                SchemaResolver.getSimpleHttpResourcePath("http://schemas.example.org/exampleml/with spaces/exml.xsd"));
    }
}
