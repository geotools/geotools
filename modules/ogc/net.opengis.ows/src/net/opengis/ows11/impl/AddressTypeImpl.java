...
public class AddressTypeImpl extends EObjectImpl implements AddressType {
  ...
  public void setDeliveryPoint(String newDeliveryPoint) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Ows11Package.ADDRESS_TYPE__DELIVERY_POINT, oldDeliveryPoint, deliveryPoint));
  }
  ...
  public void setElectronicMailAddress(String newElectronicMailAddress) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Ows11Package.ADDRESS_TYPE__ELECTRONIC_MAIL_ADDRESS, oldElectronicMailAddress, electronicMailAddress));
  }
