...
public class ServiceIdentificationTypeImpl extends DescriptionTypeImpl implements ServiceIdentificationType {
  ...
  public void setServiceTypeVersion(String newServiceTypeVersion) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Ows11Package.SERVICE_IDENTIFICATION_TYPE__SERVICE_TYPE_VERSION, oldServiceTypeVersion, serviceTypeVersion));
  }
  ...
  public void setProfile(String newProfile) {
    ...
    profile = newProfile;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Ows11Package.SERVICE_IDENTIFICATION_TYPE__PROFILE, oldProfile, profile));
  }
  ...
  public void setAccessConstraints(String newAccessConstraints) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Ows11Package.SERVICE_IDENTIFICATION_TYPE__ACCESS_CONSTRAINTS, oldAccessConstraints, accessConstraints));
  }
