...
public class TelephoneTypeImpl extends EObjectImpl implements TelephoneType {
  ...
  public void setVoice(String newVoice) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Ows11Package.TELEPHONE_TYPE__VOICE, oldVoice, voice));
  }
  ...
  public void setFacsimile(String newFacsimile) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Ows11Package.TELEPHONE_TYPE__FACSIMILE, oldFacsimile, facsimile));
  }
