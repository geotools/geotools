 ...
 * <ul>
 *   <li>{@link net.opengis.wcs20.impl.ExtensionTypeImpl#getAny <em>Any</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExtensionTypeImpl extends EObjectImpl implements ExtensionType {
    ...
    public FeatureMap getAny() {
        if (any == null) {
            any = new BasicFeatureMap(this, Wcs20Package.EXTENSION_TYPE__ANY);
        }
        return any;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case Wcs20Package.EXTENSION_TYPE__ANY:
