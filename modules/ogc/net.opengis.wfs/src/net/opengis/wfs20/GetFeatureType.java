 ...
 * <li>{@link net.opengis.wfs20.GetFeatureType#getViewParams <em>View Params</em>}</li>
...
public interface GetFeatureType extends BaseRequestType {
    /**
     * Returns the value of the '<em><b>Abstract Query Expression Group</b></em>' attribute list. The list contents are of type
     * {@link org.eclipse.emf.ecore.util.FeatureMap.Entry}. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Abstract Query Expression Group</em>' attribute list isn't clear, there really should be more of a description
     * here...
     * </p>
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns the value of the '<em><b>Abstract Query Expression</b></em>' containment reference list. The list contents are of type
     * {@link net.opengis.fes20.AbstractQueryExpressionType}. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Abstract Query Expression</em>' containment reference list isn't clear, there really should be more of a description
     * here...
     * </p>
     * <!-- end-user-doc -->
     * 
     ...
     * @model containment="true" required="true" transient="true" volatile="true" derived="true" extendedMetaData=
     *        "kind='element' name='AbstractQueryExpression' namespace='http://www.opengis.net/fes/2.0' group='http://www.opengis.net/fes/2.0#AbstractQueryExpression:group'"
     * @generated
     */
     ...
     * @model dataType="org.eclipse.emf.ecore.xml.type.NonNegativeInteger" extendedMetaData="kind='attribute' name='count'"
     * @generated
     */
    BigInteger getCount();

    /**
     * Sets the value of the '{@link net.opengis.wfs20.GetFeatureType#getCount <em>Count</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
    ...
    /**
     * Returns the value of the '<em><b>Output Format</b></em>' attribute. The default value is <code>"application/gml+xml; version=3.2"</code>. <!--
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Output Format</em>' attribute isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * Sets the value of the '{@link net.opengis.wfs20.GetFeatureType#getOutputFormat <em>Output Format</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * Unsets the value of the '{@link net.opengis.wfs20.GetFeatureType#getOutputFormat <em>Output Format</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @see #isSetOutputFormat()
     * @see #getOutputFormat()
    ...
    /**
     * Returns the value of the '<em><b>Resolve</b></em>' attribute. The default value is <code>"none"</code>. The literals are from the enumeration
     * {@link net.opengis.wfs20.ResolveValueType}. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Resolve</em>' attribute isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
     ...
     * @model default="none" unsettable="true" extendedMetaData="kind='attribute' name='resolve'"
     * @generated
     */
    ResolveValueType getResolve();

    /**
     * Sets the value of the '{@link net.opengis.wfs20.GetFeatureType#getResolve <em>Resolve</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * Unsets the value of the '{@link net.opengis.wfs20.GetFeatureType#getResolve <em>Resolve</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #isSetResolve()
     * @see #getResolve()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.wfs20.GetFeatureType#getResolve <em>Resolve</em>}' attribute is set. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns the value of the '<em><b>Resolve Depth</b></em>' attribute. The default value is <code>"*"</code>. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Resolve Depth</em>' attribute isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * Sets the value of the '{@link net.opengis.wfs20.GetFeatureType#getResolveDepth <em>Resolve Depth</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * Unsets the value of the '{@link net.opengis.wfs20.GetFeatureType#getResolveDepth <em>Resolve Depth</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @see #isSetResolveDepth()
     * @see #getResolveDepth()
    ...
    /**
     * Returns the value of the '<em><b>Resolve Timeout</b></em>' attribute. The default value is <code>"300"</code>. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Resolve Timeout</em>' attribute isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * Sets the value of the '{@link net.opengis.wfs20.GetFeatureType#getResolveTimeout <em>Resolve Timeout</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * Unsets the value of the '{@link net.opengis.wfs20.GetFeatureType#getResolveTimeout <em>Resolve Timeout</em>}' attribute. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
     * @see #isSetResolveTimeout()
     * @see #getResolveTimeout()
     ...
     * enumeration {@link net.opengis.wfs20.ResultTypeType}. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Result Type</em>' attribute isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
     ...
     * @model default="results" unsettable="true" extendedMetaData="kind='attribute' name='resultType'"
     * @generated
     */
    ResultTypeType getResultType();

    /**
     * Sets the value of the '{@link net.opengis.wfs20.GetFeatureType#getResultType <em>Result Type</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * Unsets the value of the '{@link net.opengis.wfs20.GetFeatureType#getResultType <em>Result Type</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #isSetResultType()
     * @see #getResultType()
    ...
    /**
     * Returns the value of the '<em><b>Start Index</b></em>' attribute. The default value is <code>"0"</code>. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Start Index</em>' attribute isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * Sets the value of the '{@link net.opengis.wfs20.GetFeatureType#getStartIndex <em>Start Index</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * Unsets the value of the '{@link net.opengis.wfs20.GetFeatureType#getStartIndex <em>Start Index</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #isSetStartIndex()
     * @see #getStartIndex()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wfs20.GetFeatureType#getMetadata <em>Metadata</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * Sets the value of the '{@link net.opengis.wfs20.GetFeatureType#getFormatOptions <em>Format Options</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
