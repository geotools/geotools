 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml311.RowType#getPosList <em>Pos List</em>}</li>
 *   <li>{@link net.opengis.gml311.RowType#getGeometricPositionGroup <em>Geometric Position Group</em>}</li>
 *   <li>{@link net.opengis.gml311.RowType#getPos <em>Pos</em>}</li>
 *   <li>{@link net.opengis.gml311.RowType#getPointProperty <em>Point Property</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml311.Gml311Package#getRowType()
...
public interface RowType extends EObject {
     ...
     * @see net.opengis.gml311.Gml311Package#getRowType_PosList()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml311.RowType#getPosList <em>Pos List</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml311.Gml311Package#getRowType_GeometricPositionGroup()
     ...
     * @see net.opengis.gml311.Gml311Package#getRowType_Pos()
     ...
     * @see net.opengis.gml311.Gml311Package#getRowType_PointProperty()
     * @model containment="true" transient="true" volatile="true" derived="true"
