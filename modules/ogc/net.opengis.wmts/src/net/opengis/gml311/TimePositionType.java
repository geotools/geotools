 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml311.TimePositionType#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.gml311.TimePositionType#getCalendarEraName <em>Calendar Era Name</em>}</li>
 *   <li>{@link net.opengis.gml311.TimePositionType#getFrame <em>Frame</em>}</li>
 *   <li>{@link net.opengis.gml311.TimePositionType#getIndeterminatePosition <em>Indeterminate Position</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml311.Gml311Package#getTimePositionType()
...
public interface TimePositionType extends EObject {
     ...
     * @see #setValue(Object)
     * @see net.opengis.gml311.Gml311Package#getTimePositionType_Value()
     * @model dataType="net.opengis.gml311.TimePositionUnion"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml311.TimePositionType#getValue <em>Value</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml311.Gml311Package#getTimePositionType_CalendarEraName()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml311.TimePositionType#getCalendarEraName <em>Calendar Era Name</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #unsetFrame()
     * @see #setFrame(String)
     * @see net.opengis.gml311.Gml311Package#getTimePositionType_Frame()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml311.TimePositionType#getFrame <em>Frame</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.gml311.TimePositionType#getFrame <em>Frame</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetFrame()
     * @see #getFrame()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.gml311.TimePositionType#getFrame <em>Frame</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * The literals are from the enumeration {@link net.opengis.gml311.TimeIndeterminateValueType}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see net.opengis.gml311.TimeIndeterminateValueType
     * @see #isSetIndeterminatePosition()
     * @see #unsetIndeterminatePosition()
     * @see #setIndeterminatePosition(TimeIndeterminateValueType)
     * @see net.opengis.gml311.Gml311Package#getTimePositionType_IndeterminatePosition()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml311.TimePositionType#getIndeterminatePosition <em>Indeterminate Position</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.gml311.TimePositionType#getIndeterminatePosition <em>Indeterminate Position</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetIndeterminatePosition()
     * @see #getIndeterminatePosition()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.gml311.TimePositionType#getIndeterminatePosition <em>Indeterminate Position</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
