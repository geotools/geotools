 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml311.VectorType#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.gml311.VectorType#getAxisLabels <em>Axis Labels</em>}</li>
 *   <li>{@link net.opengis.gml311.VectorType#getSrsDimension <em>Srs Dimension</em>}</li>
 *   <li>{@link net.opengis.gml311.VectorType#getSrsName <em>Srs Name</em>}</li>
 *   <li>{@link net.opengis.gml311.VectorType#getUomLabels <em>Uom Labels</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml311.Gml311Package#getVectorType()
...
public interface VectorType extends EObject {
     ...
     * @see #setValue(List)
     * @see net.opengis.gml311.Gml311Package#getVectorType_Value()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml311.VectorType#getValue <em>Value</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml311.Gml311Package#getVectorType_AxisLabels()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml311.VectorType#getAxisLabels <em>Axis Labels</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml311.Gml311Package#getVectorType_SrsDimension()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml311.VectorType#getSrsDimension <em>Srs Dimension</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml311.Gml311Package#getVectorType_SrsName()
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml311.VectorType#getSrsName <em>Srs Name</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.gml311.Gml311Package#getVectorType_UomLabels()
     * @model dataType="net.opengis.gml311.NCNameList" many="false"
    ...
    /**
     * Sets the value of the '{@link net.opengis.gml311.VectorType#getUomLabels <em>Uom Labels</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
