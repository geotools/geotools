 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.DynamicFeatureTypeImpl#getValidTime <em>Valid Time</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.DynamicFeatureTypeImpl#getHistoryGroup <em>History Group</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.DynamicFeatureTypeImpl#getHistory <em>History</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.DynamicFeatureTypeImpl#getDataSource <em>Data Source</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DynamicFeatureTypeImpl extends AbstractFeatureTypeImpl implements DynamicFeatureType {
    ...
    public void setHistory(HistoryPropertyType newHistory) {
        getHistoryGroup().set(Gml311Package.eINSTANCE.getDynamicFeatureType_History(), newHistory);
    }
