 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml311.impl.ValuePropertyTypeImpl#isBoolean <em>Boolean</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.ValuePropertyTypeImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.ValuePropertyTypeImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.ValuePropertyTypeImpl#getCount <em>Count</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.ValuePropertyTypeImpl#getBooleanList <em>Boolean List</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.ValuePropertyTypeImpl#getCategoryList <em>Category List</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.ValuePropertyTypeImpl#getQuantityList <em>Quantity List</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.ValuePropertyTypeImpl#getCountList <em>Count List</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.ValuePropertyTypeImpl#getCategoryExtent <em>Category Extent</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.ValuePropertyTypeImpl#getQuantityExtent <em>Quantity Extent</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.ValuePropertyTypeImpl#getCountExtent <em>Count Extent</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.ValuePropertyTypeImpl#getCompositeValueGroup <em>Composite Value Group</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.ValuePropertyTypeImpl#getCompositeValue <em>Composite Value</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.ValuePropertyTypeImpl#getObjectGroup <em>Object Group</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.ValuePropertyTypeImpl#getObject <em>Object</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.ValuePropertyTypeImpl#getNull <em>Null</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.ValuePropertyTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.ValuePropertyTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.ValuePropertyTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.ValuePropertyTypeImpl#getRemoteSchema <em>Remote Schema</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.ValuePropertyTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.ValuePropertyTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.ValuePropertyTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link net.opengis.gml311.impl.ValuePropertyTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
