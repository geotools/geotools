...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Get Result Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wps20.GetResultType#getJobID <em>Job ID</em>}</li>
 * </ul>
 *
 * @see net.opengis.wps20.Wps20Package#getGetResultType()
 * @model extendedMetaData="name='GetResult_._type' kind='elementOnly'"
 * @generated
 */
public interface GetResultType extends RequestBaseType {
	 ...
	 * @see #setJobID(String)
	 * @see net.opengis.wps20.Wps20Package#getGetResultType_JobID()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps20.GetResultType#getJobID <em>Job ID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
