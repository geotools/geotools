 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wps20.impl.ComplexDataTypeImpl#getAny <em>Any</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComplexDataTypeImpl extends DataDescriptionTypeImpl implements ComplexDataType {
	...
	protected EClass eStaticClass() {
		return Wps20Package.Literals.COMPLEX_DATA_TYPE;
	}
	...
	public FeatureMap getAny() {
		if (any == null) {
			any = new BasicFeatureMap(this, Wps20Package.COMPLEX_DATA_TYPE__ANY);
		}
		return any;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Wps20Package.COMPLEX_DATA_TYPE__ANY:
