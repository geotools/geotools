 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wps20.impl.ExtensionTypeImpl#getAny <em>Any</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExtensionTypeImpl extends MinimalEObjectImpl.Container implements ExtensionType {
	...
	protected EClass eStaticClass() {
		return Wps20Package.Literals.EXTENSION_TYPE;
	}
	...
	public FeatureMap getAny() {
		if (any == null) {
			any = new BasicFeatureMap(this, Wps20Package.EXTENSION_TYPE__ANY);
		}
		return any;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Wps20Package.EXTENSION_TYPE__ANY:
