...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Get Result Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link net.opengis.wps20.impl.GetResultTypeImpl#getJobID <em>Job ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GetResultTypeImpl extends RequestBaseTypeImpl implements GetResultType {
	/**
	...
	protected EClass eStaticClass() {
		return Wps20Package.Literals.GET_RESULT_TYPE;
	}
	...
	public void setJobID(String newJobID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wps20Package.GET_RESULT_TYPE__JOB_ID, oldJobID, jobID));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Wps20Package.GET_RESULT_TYPE__JOB_ID:
				return getJobID();
		}
