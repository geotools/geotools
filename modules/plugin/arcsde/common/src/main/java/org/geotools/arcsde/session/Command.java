 ...
 *
 * <p>Instances of this class can be sent to {@link Session#issue(Command)} in order to be executed.
 * A {@code Command} has exclusive access to the {@link SeConnection connection} for the duration of
...
public abstract class Command<R> {
     ...
     *
     * <p>Please keep in mind that a Command should be short in duration; you are sharing this
     ...
     */
    public abstract R execute(ISession session, SeConnection connection)
