...
public interface CoverageAccess {
    ...
    /**
     * Returns the {@link Driver} which has been used to connect to this CoverageAccess.
     *
     ...
     * <p>
     *
     * @todo TODO think about the equivalence with StreamMetadata once we define them
     ...
     *
     * @return <code>true</code> when removal of of a new coverage storage is supported, <code>false
     *     </code> otherwise.
     */
     ...
     *
     * @return the parameters used to connect to this live instance of {@link CoverageAccess}.
     */
