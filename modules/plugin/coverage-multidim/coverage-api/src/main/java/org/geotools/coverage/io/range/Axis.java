...
/**
 * Definition of one axis in a field for which we have some measurements/observations/forecasts. The
 * {@link Axis} data structure describes the nature of each control variable for a certain {@link
 * FieldType}, moreover it indicates as {@link Measurable}s the keys used to control each Field
 * subset.
 *
 * <p>Note that in order to comply with the WCS spec we need to have the possibility to encode
 * {@link Measurable}s as {@link String}s.
 *
...
public interface Axis<V, QA extends Quantity> {
     ...
     *
     * <p>In case this {@link Axis} is not made of measurable quantities
     *
     ...
     *
     * <p>In case the coordinate reference system is present the Unit of measure for its single
     * coordinate axis should conform to the global {@link Unit} for this {@link Axis}.
     *
     * @return the coordinate reference system for this {@link Axis} or <code>null</code>, if no
     *     coordinate reference system is know or applicable.
     */
