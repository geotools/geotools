...
public abstract class Measure<V extends Number, Q extends Quantity<Q>> implements Comparable<Measure<V, Q>> {
    ...
    /**
     * Double representation of {@link #getValue()} in the requested unit (values outside of the range {@link Double#MIN_VALUE} -
     * {@link Double#MAX_VALUE} are represented as infinite).
     * 
    ...
    /**
     * Long representation of {@link #getValue()} in the requested unit (clipped to range {@link Long#MIN_VALUE} - {@link Double#MAX_VALUE}).
     * 
     * @param unit to convert to double
     */
