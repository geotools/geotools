 ...
 *
 * <p>Fixed set of strings are represented as an Enumeration in the GeoTools library. This forms a
 * data dictionary (or "formal vocabulary") that is well defined and closed to further additions.
 *
 * <p>This is a great tool for dealing well defined keys such as RGB or CMKY; for most data products
 * you may wish to consider a CodeList instead.
 *
...
public class EnumMeasure<V extends Enum<V>> extends Measure<V, Dimensionless> {
    ...
    public static <E extends Enum<E>> List<Measure<E, Dimensionless>> valueOf(
            Class<E> elementType) {
