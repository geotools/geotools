...
public class SpatialRequestHelperTest {
    ...
    public static void setup() {
        ...
        coverageProperties.setFullResolution(CoverageUtilities.getResolution(
    ...
    public void testHelperSimple() throws DataSourceException {
        ...
        double[] calculatedResolution = {
            XAffineTransform.getScaleX0(requestedGridToWorld), XAffineTransform.getScaleY0(requestedGridToWorld)
        };
    ...
    public void testHelperEmpty() throws DataSourceException {
        ...
        GridCoverage2D coverage2 =
                new GridCoverageFactory(GeoTools.getDefaultHints()).create("testCoverage", image, envelope);
        ...
        coverageProperties2.setFullResolution(CoverageUtilities.getResolution(
                (AffineTransform) coverage2.getGridGeometry().getGridToCRS2D(PixelOrientation.UPPER_LEFT)));
    ...
    public void testHelperWithReprojection()
            throws DataSourceException, NoSuchAuthorityCodeException, TransformException, FactoryException {
        // Initialization of the helper
        SpatialRequestHelper helper = new SpatialRequestHelper();
        // Final GridGeometry
        GridEnvelope2D gridRange = new GridEnvelope2D(0, 0, 1024, 1024);
        ...
        final GeneralBounds temp =
                new GeneralBounds(CRS.transform(gridGeometry.getEnvelope(), coverageProperties.crs2D));
    ...
    public void testHelperWithNoGridGeometry()
        ...
        assertFalse(helper.isEmpty());
        // Check resolution
        assertArrayEquals(helper.getRequestedResolution(), coverageProperties.getFullResolution(), TOLERANCE);
        // Check the same boundingBox
