...
public class DimensionlessAxisTest extends Assert {
     ...
     *
     * <p>This really is a toy example; if you have a formal fixed data dictionary consider the use
     * of a Java Enumeration (and EnumMeasure), if you have an open ended data dictionary consider a
     * CodeList (and CodeMeasure).
     */
    @Test
    public void testTOY() {
        DimensionlessAxis TOY =
                new DimensionlessAxis(
                        new String[] {"A", "B", "C"},
                        new NameImpl("Color"),
    ...
    public void testImage() {
        // Image creation
        RenderedOp constant =
                ConstantDescriptor.create(20f, 20f, new Byte[] {1}, GeoTools.getDefaultHints());
        // Axis creation
        ...
        assertTrue(
                sample.getDescription()
                                .compareTo(new SimpleInternationalString("Axis for GRAY bands"))
                        == 0);
