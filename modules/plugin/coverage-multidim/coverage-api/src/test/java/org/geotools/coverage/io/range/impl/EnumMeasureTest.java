...
public class EnumMeasureTest extends Assert {
    ...
    public void testLandsatAxis() {
        ...
        DefaultEngineeringCRS lightCRS =
                new DefaultEngineeringCRS("wave length", lightDatum, lightCS);
        ...
        Map<Measure<Integer, Dimensionless>, SampleDimension> samples =
                new HashMap<Measure<Integer, Dimensionless>, SampleDimension>();
