...
public class ObjectFactory {
    ...
    private final static QName _EntryId_QNAME = new QName("", "entry_id");
    private final static QName _LastModified_QNAME = new QName("", "last_modified");
    private final static QName _CanonicalUnits_QNAME = new QName("", "canonical_units");
    private final static QName _Description_QNAME = new QName("", "description");
    private final static QName _VersionNumber_QNAME = new QName("", "version_number");
    private final static QName _Amip_QNAME = new QName("", "amip");
    private final static QName _Grib_QNAME = new QName("", "grib");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.geotools.coverageio.netcdf.cf
     * 
     */
