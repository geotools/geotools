...
public class H2Migrate {
    ...
    public static void main(String[] args) {
        ...
        options.addOption(Option.builder("m")
                .desc("Path to the mosaic folder")
                .required()
                .hasArg()
                .build());
        ...
        options.addOption(Option.builder("cl")
                ...
                .hasArg()
                .build());
        options.addOption(Option.builder("ndd")
                .desc("Path to the NetCDF data dir")
                .hasArg()
                .build());
        options.addOption(Option.builder("is")
                .desc(
                ...
                .hasArg()
                .build());
        options.addOption(Option.builder("isn")
                .desc(
        ...
        options.addOption(Option.builder("c")
                .desc("Concurrency level (positive number). If not provided, will use one core")
                .hasArg()
                .build());
        ...
        try {
            ...
            if (cmd.hasOption("ndd")) {
                ...
                if (!file.exists() && !file.isDirectory()) {
                    throw new H2MigrateConfiguration.ConfigurationException(
                            "NetCDF data directory does not exist or is not a directory " + netcdfDataDir);
                }
