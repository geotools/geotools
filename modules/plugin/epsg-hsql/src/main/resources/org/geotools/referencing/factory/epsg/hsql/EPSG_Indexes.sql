...
CREATE INDEX USAGE_OBJECT_CODE                ON EPSG_USAGE                     (OBJECT_CODE);
CREATE INDEX USAGE_EXTENT_CODE                ON EPSG_USAGE                     (EXTENT_CODE);
CREATE INDEX EXTENT_CODE                      ON EPSG_EXTENT                    (EXTENT_CODE);
--------------------------------------------------------------------------------
-- Index for queries used by DirectEpsgFactory.createFoo(epsgCode) methods.   --
...
CREATE INDEX OBJECT_TABLE_NAME   ON EPSG_USAGE                     (OBJECT_TABLE_NAME);
