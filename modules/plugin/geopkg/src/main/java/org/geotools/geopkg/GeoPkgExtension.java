...
public class GeoPkgExtension {
    ...
    /**
     * Returns true if the extension has at least one registration in the geopkg_extensions table. If not registered,
     * the GeoPackage does not really have this extension, but the class could be used to create one (this behavior is
     * extension specific and delegated to sub-classes).
     */
    ...
    /** Returns the list of {@link Association} between this extension and table/columns in the database */
