...
public class GeoPackageTestWriteDatetime {
    ...
    /**
     * For backwards compatibility, this tests the old GT DateTime format ("2024-02-27 00:13:00.0Z"). Older versions of
     * GT stored the value as a "TIMESTAMP" (instead of the correct DateTime).
     *
     * @throws Exception
     */
    @Test
