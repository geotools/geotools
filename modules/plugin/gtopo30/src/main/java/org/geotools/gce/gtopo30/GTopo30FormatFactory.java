...
/**
 * The GTopo30FormatFactory will be discovered by the GridFormatFinder. Use the standard Geotools
 * method of discovering a factory in order to create a format.
 *
