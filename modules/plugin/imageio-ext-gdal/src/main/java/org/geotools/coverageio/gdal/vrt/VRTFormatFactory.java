...
/**
 * Implementation of the {@link Format} service provider interface for VRT
 * files based on {@link org.geotools.coverageio.gdal.nitf.NITFFormatFactory}.
 * 
...
public final class VRTFormatFactory extends BaseGridFormatFactorySPI  implements GridFormatFactorySpi {
	...
	public boolean isAvailable() {
		...
		try {
			Class
					.forName("it.geosolutions.imageio.plugins.vrt.VRTImageReaderSpi");
