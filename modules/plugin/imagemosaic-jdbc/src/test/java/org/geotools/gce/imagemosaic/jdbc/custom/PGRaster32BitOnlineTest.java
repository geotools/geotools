 ...
 * @source $URL$
 */
public class PGRaster32BitOnlineTest extends AbstractTest {
    ...
    public static Test suite() {
        ...
        suite.addTest(new PGRaster32BitOnlineTest("testCreate2"));        
        ...
        suite.addTest(new PGRaster32BitOnlineTest("testDrop"));
        suite.addTest(new PGRaster32BitOnlineTest("testCreate"));
        suite.addTest(new PGRaster32BitOnlineTest("testImage1Joined"));
        suite.addTest(new PGRaster32BitOnlineTest("testFullExtentJoined"));
        suite.addTest(new PGRaster32BitOnlineTest("testNoDataJoined"));
        suite.addTest(new PGRaster32BitOnlineTest("testPartialJoined"));
        suite.addTest(new PGRaster32BitOnlineTest("testViennaJoined"));
        suite.addTest(new PGRaster32BitOnlineTest("testViennaEnvJoined"));
        */
