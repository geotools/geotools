...
/**
 * Class delegated to parse coverageNameCollectors property and setup proper {@link CoverageNameCollector} machinery to
 * be used to return a target coverageName.
 */
