 ...
 *
 * <p>An ImageReaderSpi to create an ImageReader to decode that granule An ImageInputStreamSpi to
 * create a stream for the granule An AbstractGridFormat supporting the type of format of that
 * granule An AbstractGridCoverage2DReader able to read that granule A MaskOverviewProvider with
 * details on mask and overviews for that granule
 */
