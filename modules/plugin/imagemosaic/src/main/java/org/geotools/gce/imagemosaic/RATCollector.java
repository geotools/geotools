...
public class RATCollector {
     ...
     * granule makes differ. A merge that fails, on invalid input, a topology error or lack of memory, collapses the
     * cell to {@link #NO_GEOMETRY}: no extent is better than a wrong one.
     *
    ...
    private void merge(String key, int field, String collectedWkt, String wkt) {
        ...
        } catch (ParseException | TopologyException | OutOfMemoryError e) {
