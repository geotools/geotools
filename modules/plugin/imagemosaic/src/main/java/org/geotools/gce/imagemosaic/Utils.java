...
public class Utils {
    ...
    static {
        ...
        if (localReprojectProp != null && localReprojectProp.equalsIgnoreCase("TRUE")) {
    ...
    static MosaicConfigurationBean loadMosaicProperties(final URL sourceURL, final Set<String> ignorePropertiesSet) {
        ...
        if (!ignoreSome || !ignorePropertiesSet.contains(Prop.RAT_GEOMETRIES)) {
            retValue.setRatGeometries(RATGeometries.fromParameter(properties.getProperty(Prop.RAT_GEOMETRIES)));
        }
