...
public class GranuleAcceptorFactorySPIFinder {
    ...
    public static synchronized Map<String, GranuleAcceptorFactorySPI>
        ...
        final Iterator<GranuleAcceptorFactorySPI> it =
                serviceRegistry.getServiceProviders(GranuleAcceptorFactorySPI.class, true);
        ...
        while (it.hasNext()) {
            ...
            acceptorFactorySPIMap.put(
                    granuleAcceptorFactorySPI.getClass().getName(), granuleAcceptorFactorySPI);
        }
