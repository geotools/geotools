...
public class TimestampFileNameExtractorSPI implements PropertiesCollectorSPI {
    ...
    public static final String INCLUSIVE_PREFIX = INCLUSIVE + "=";
    ...
    public PropertiesCollector create(final Object o, final List<String> propertyNames) {
        ...
        if (o instanceof URL) {
            ...
            try {
                ...
                indexesOf[2] = value.indexOf("," + INCLUSIVE_PREFIX);
        ...
        if (properties != null) {
            ...
            String inclusiveParam = properties.getProperty(INCLUSIVE);
            if (inclusiveParam != null && inclusiveParam.trim().length() > 0) {
                inclusive = Boolean.valueOf(inclusiveParam);
            }
        }
        ...
        if (regex != null) {
            ...
            return new TimestampFileNameExtractor(
                    this, propertyNames, regex, format, fullPath, inclusive);
        }
