...
public class SpatialRequestHelperTest extends Assert {
	 ...
	 * 
	 * The computed resolution should be much coarser and that is it.
	 * 
	 * @throws Exception
	 */
    @Test
    ...
    public void testReprojectQuick() throws Exception {
        ...
        spatialRequestHelper.setRequestedGridGeometry(new GridGeometry2D(
        		...
        		new GeneralEnvelope(new ReferencedEnvelope(
        		-1.9868610903408341,-1.1430930819885086,
        		51.938491047471814,52.705668101075581, 
        		DefaultGeographicCRS.WGS84))));
    ...
    public void testBasicReproject() throws Exception {
        ...
        GeneralEnvelope requestedBBox = (GeneralEnvelope)CRS.transform(sourceBBox, requestCRS);   
		spatialRequestHelper.setRequestedGridGeometry(new GridGeometry2D(
        		requestedRasterArea, 
        		requestedBBox));
    ...
    public void testBasic2Reproject() throws Exception {
		...
		ReferencedEnvelope requestedBBox_ = new ReferencedEnvelope(
        		...
        		0,70, 
        		sourceCRS);   
        GeneralEnvelope requestedBBox = (GeneralEnvelope)CRS.transform(requestedBBox_, requestCRS);   
		spatialRequestHelper.setRequestedGridGeometry(new GridGeometry2D(
        		requestedRasterArea, 
        		requestedBBox));
        ...
        if(Math.abs(computedResolution[1] - computedResolution2[1]) > 1E-6){
            notEquals = true;
        }
