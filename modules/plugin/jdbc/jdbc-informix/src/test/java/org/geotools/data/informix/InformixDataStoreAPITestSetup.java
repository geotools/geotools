...
public class InformixDataStoreAPITestSetup extends JDBCDataStoreAPITestSetup {
    ...
    protected void createRoadTable() throws Exception {
        run("CREATE TABLE road(fid serial PRIMARY KEY, id integer, " + "geom ST_GEOMETRY, name varchar(255) );");
    ...
    protected void createRiverTable() throws Exception {
        run("CREATE TABLE river(fid serial PRIMARY KEY, id integer, "
    ...
    protected void createLakeTable() throws Exception {
        run("CREATE TABLE lake(fid serial PRIMARY KEY, id integer, " + "geom ST_POLYGON, name varchar(255) );");
