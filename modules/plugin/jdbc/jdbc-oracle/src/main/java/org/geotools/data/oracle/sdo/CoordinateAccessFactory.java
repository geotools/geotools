...
public interface CoordinateAccessFactory extends CoordinateSequenceFactory {
     ...
     *
     * <p>Example: (x,y,z,t) getDimension()==2, getNumAttributes()==2
     *
     * <pre><code>
     ...
     * @param attributes an array of Objects which can be null. Column major measure arrays where attributes.length ==
     *     getNumAttributes()
     */
