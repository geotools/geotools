...
public class OracleCurvesTestSetup extends JDBCDelegatingTestSetup {
    ...
    private void createCurvesTable() throws Exception {
        ...
        sql =
                "INSERT INTO CURVES VALUES (4, 'Closed mixed line', "
        ...
        sql =
                "INSERT INTO CURVES VALUES (8, 'Multipolygon with curves', sdo_geometry(2007, 32632, null,"
        ...
        sql =
                "INSERT INTO CURVES VALUES (9, 'Compound polygon 2', "
