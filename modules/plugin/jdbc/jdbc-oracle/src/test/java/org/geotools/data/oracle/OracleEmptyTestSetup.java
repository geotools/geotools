...
public class OracleEmptyTestSetup extends JDBCEmptyTestSetup {
    ...
    protected void createEmptyTable() throws Exception {
        String sql = "CREATE TABLE empty (" + "id INT, geom MDSYS.SDO_GEOMETRY, PRIMARY KEY(id))";
        run(sql);
        ...
        sql =
                "CREATE INDEX EMPTY_GEOMETRY_IDX ON EMPTY(GEOM) INDEXTYPE IS MDSYS.SPATIAL_INDEX" //
