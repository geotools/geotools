...
public class OracleLongNameTestSetup extends JDBCDelegatingTestSetup {
    ...
    protected final void setUpData() throws Exception {
        ...
        run("DELETE FROM USER_SDO_GEOM_METADATA WHERE TABLE_NAME = 'THIS_IS_A_TABLE_WITH_A_VERY_LONG_NAME'");

        // create the table with long names again
        run("CREATE TABLE THIS_IS_A_TABLE_WITH_A_VERY_LONG_NAME("
                + "ID INT, "
        ...
        run("INSERT INTO THIS_IS_A_TABLE_WITH_A_VERY_LONG_NAME VALUES (0," + pointSql(4326, 0, 0) + ", 123)");
    }
