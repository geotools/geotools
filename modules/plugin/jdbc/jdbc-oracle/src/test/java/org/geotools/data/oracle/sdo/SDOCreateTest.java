...
/**
 * Unit tests for {@link SDO} <code>create*</code> methods. These test that the SDO create methods work correctly to
 * read raw Oracle SDO_GEOMETRY structures into {@link Geometry} objects. These tests do not require a connection to
 * Oracle.
 *
 * @author mbdavis
 */
public class SDOCreateTest {
    ...
    public void testXY_Point() throws Exception {
        SDO_GEOMETRY oraGeom = MDSYS.SDO_GEOMETRY(
                2001, NULL, NULL, MDSYS.SDO_ELEM_INFO_ARRAY(1, 1, 1), MDSYS.SDO_ORDINATE_ARRAY(50, 50));
    ...
    public void testXYM_Point() throws Exception {
        SDO_GEOMETRY oraGeom = MDSYS.SDO_GEOMETRY(
                3301, NULL, NULL, MDSYS.SDO_ELEM_INFO_ARRAY(1, 1, 1), MDSYS.SDO_ORDINATE_ARRAY(50, 50, 100));
    ...
    public void testXYZM_Point() throws Exception {
        SDO_GEOMETRY oraGeom = MDSYS.SDO_GEOMETRY(
                4001, NULL, NULL, MDSYS.SDO_ELEM_INFO_ARRAY(1, 1, 1), MDSYS.SDO_ORDINATE_ARRAY(50, 50, 100, 200));
        checkValue(oraGeom, 3, "POINT (50 50 100)");
    }
    ...
    public void testXYZ_LineString() throws Exception {
        SDO_GEOMETRY oraGeom = MDSYS.SDO_GEOMETRY(
                3002, NULL, NULL, MDSYS.SDO_ELEM_INFO_ARRAY(1, 2, 1), MDSYS.SDO_ORDINATE_ARRAY(0, 0, 0, 50, 50, 100));
    ...
    public void testXYM_LineString() throws Exception {
        SDO_GEOMETRY oraGeom = MDSYS.SDO_GEOMETRY(
                3302, NULL, NULL, MDSYS.SDO_ELEM_INFO_ARRAY(1, 2, 1), MDSYS.SDO_ORDINATE_ARRAY(1, 1, 20, 2, 2, 30));
    ...
    public void testXY_Polygon_With_Single_Point_Ring() throws Exception {
        ...
        // of the start point
        SDO_GEOMETRY onePointOraGeom = MDSYS.SDO_GEOMETRY(
                2003, NULL, NULL, MDSYS.SDO_ELEM_INFO_ARRAY(1, 1003, 1), MDSYS.SDO_ORDINATE_ARRAY(0, 0));
    ...
    public void testXY_Polygon_With_Closed_Two_Points_Ring() throws Exception {
        ...
        // of the start point
        SDO_GEOMETRY twoPointsOraGeom = MDSYS.SDO_GEOMETRY(
                2003, NULL, NULL, MDSYS.SDO_ELEM_INFO_ARRAY(1, 1003, 1), MDSYS.SDO_ORDINATE_ARRAY(0, 0, 0, 0));
    ...
    public void testXY_Polygon_With_Closed_Three_Points_Ring() throws Exception {
        ...
        // of the start point
        SDO_GEOMETRY threePointsOraGeom = MDSYS.SDO_GEOMETRY(
                2003, NULL, NULL, MDSYS.SDO_ELEM_INFO_ARRAY(1, 1003, 1), MDSYS.SDO_ORDINATE_ARRAY(0, 0, 50, 0, 0, 0));
        ...
        checkValue(
                MDSYS.SDO_GEOMETRY(
                        ...
                        MDSYS.SDO_ORDINATE_ARRAY(
                                2, 4, 99, 4, 3, 99, 10, 3, 99, 13, 5, 99, 13, 9, 99, 11, 13, 99, 5, 13, 99, 2, 11, 99,
                                2, 4, 99, 7, 5, 99, 7, 10, 99, 10, 10, 99, 10, 5, 99, 7, 5, 99)),
    ...
    public void testXY_PolygonWithTwoHoles_numInteriorRing() throws Exception {
        SDO_GEOMETRY oraGeom = MDSYS.SDO_GEOMETRY(
                ...
                MDSYS.SDO_ELEM_INFO_ARRAY(
                        1, 1005, 2, 1, 2, 1, 5, 2, 2, 11, 2005, 2, 11, 2, 2, 15, 2, 1, 21, 2005, 2, 21, 2, 2, 25, 2, 1),
                MDSYS.SDO_ORDINATE_ARRAY(
                        50000, 100000, 100000, 10000, 140000, 100000, 100000, 140000, 50000, 100000, 70000, 110000,
                        80000, 130000, 90000, 110000, 80000, 90000, 70000, 110000, 100000, 110000, 110000, 130000,
                        120000, 110000, 110000, 90000, 100000, 110000));
    ...
    public void testXYZ_MultiPolygon() throws Exception {
        checkValue(
                MDSYS.SDO_GEOMETRY(
                        ...
                        MDSYS.SDO_ORDINATE_ARRAY(
                                2, 3, 99, 7, 3, 99, 7, 9, 99, 2, 9, 99, 2, 3, 99, 9, 5, 99, 13, 5, 99, 11, 5, 99, 9, 5,
                                99)),
                "MULTIPOLYGON (((2 3, 7 3, 7 9, 2 9, 2 3)), ((9 5, 13 5, 11 5, 9 5)))");
    }
    ...
    public void testXYZM_MultiPolygon() throws Exception {
        checkValue(
                MDSYS.SDO_GEOMETRY(
                        ...
                        MDSYS.SDO_ORDINATE_ARRAY(
                                2, 3, 99, 88, 7, 3, 99, 88, 7, 9, 99, 88, 2, 9, 99, 88, 2, 3, 99, 88, 9, 5, 99, 88, 13,
                                5, 99, 88, 11, 5, 99, 88, 9, 5, 99, 88)),
                "MULTIPOLYGON (((2 3, 7 3, 7 9, 2 9, 2 3)), ((9 5, 13 5, 11 5, 9 5)))");
    }
    ...
    public void testXY_GeometryCollection_Doc() throws Exception {
        checkValue(
                MDSYS.SDO_GEOMETRY(
                        ...
                        MDSYS.SDO_ORDINATE_ARRAY(
                                1, 1, 1, 2, 2, 1, 2, 2, 3, 2, 3, 3, 2, 3, 2, 2, 5, 1, 9, 5, 5, 5, 5, 1, 5, 3, 6, 4, 6,
                                3, 5, 3)),
    ...
    public void testXYM_GeometryCollection_Doc() throws Exception {
        checkValue(
                MDSYS.SDO_GEOMETRY(
                        ...
                        MDSYS.SDO_ORDINATE_ARRAY(
                                1, 1, 99, 1, 2, 99, 2, 1, 99, 2, 2, 99, 3, 2, 99, 3, 3, 99, 2, 3, 99, 2, 2, 99, 5, 1,
                                99, 9, 5, 99, 5, 5, 99, 5, 1, 99, 5, 3, 99, 6, 4, 99, 6, 3, 99, 5, 3, 99)),
                "GEOMETRYCOLLECTION (POINT (1 1), LINESTRING (1 2, 2 1), POLYGON ((2 2, 3 2, 3 3, 2 3, 2 2)), POLYGON ((5 1, 9 5, 5 5, 5 1), (5 3, 6 4, 6 3, 5 3)))");
    }
    ...
    private Geometry create(SDO_GEOMETRY oraGeom, GeometryFactory gf) {
        return SDO.create(gf, oraGeom.gType, oraGeom.srid, oraGeom.ptType, oraGeom.elemInfo, oraGeom.ordinates);
    }
}
