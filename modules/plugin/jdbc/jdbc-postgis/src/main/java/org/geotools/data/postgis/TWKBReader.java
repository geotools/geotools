 ...
 */
/*
 * This class is from the JTS Topology Suite version 1.15.1
 */
...
public class TWKBReader {
  ...
  private MultiLineString readMultiLineString(CodedInputStream is, TWKBMetadata metadata)
  ...
  private MultiPolygon readMultiPolygon(CodedInputStream is, TWKBMetadata metadata)
      throws IOException, ParseException {
    if (!metadata.isEmpty()) {
      int numGeom = is.readInt32();
  ...
  private GeometryCollection readGeometryCollection(CodedInputStream is, TWKBMetadata metadata)
      throws IOException, ParseException {
    if (!metadata.isEmpty()) {
      int numGeom = is.readInt32();
  ...
  private CoordinateSequence readCoordinateSequenceRing(
      CodedInputStream is, int size, TWKBMetadata metadata) throws IOException {
  ...
  private CoordinateSequence readCoordinateSequence(
      CodedInputStream is, int numPts, TWKBMetadata metadata) throws IOException {
