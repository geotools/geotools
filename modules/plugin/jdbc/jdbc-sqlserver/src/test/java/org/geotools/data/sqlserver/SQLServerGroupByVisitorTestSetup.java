    ...
    protected void createBuildingsTable() throws Exception {
        ...
        run(
                "INSERT INTO buildings_group_by_tests VALUES "
                        ...
                        + "(2, 'SCHOOL_A', 'SCHOOL', 'NUCLEAR', NULL, 10.0, CAST('2016-06-03 16:00:00' AS DATETIME), CAST('2016-06-03' AS DATE)),"
                        + "(3, 'SCHOOL_A', 'SCHOOL', 'WIND', NULL, 20.0, CAST('2016-06-03 20:00:00' AS DATETIME), CAST('2016-06-03' AS DATE)),"
                        + "(4, 'SCHOOL_B', 'SCHOOL', 'SOLAR', NULL, 30.0, CAST('2016-06-05 12:00:00' AS DATETIME), CAST('2016-06-05' AS DATE)),"
                        + "(5, 'SCHOOL_B', 'SCHOOL', 'FUEL', NULL, 60.0, CAST('2016-06-06 12:00:00' AS DATETIME), CAST('2016-06-06' AS DATE)),"
                        + "(6, 'SCHOOL_B', 'SCHOOL', 'NUCLEAR', NULL, 10.0, CAST('2016-06-06 14:00:00' AS DATETIME), CAST('2016-06-06' AS DATE)),"
                        + "(7, 'FABRIC_A', 'FABRIC', 'FLOWING_WATER', NULL, 500.0, CAST('2016-06-07 12:00:00' AS DATETIME), CAST('2016-06-07' AS DATE)),"
                        + "(8, 'FABRIC_A', 'FABRIC', 'NUCLEAR', NULL, 150.0, CAST('2016-06-07 18:00:00' AS DATETIME), CAST('2016-06-07' AS DATE)),"
                        + "(9, 'FABRIC_B', 'FABRIC', 'WIND', NULL, 20.0, CAST('2016-06-07 20:00:00' AS DATETIME), CAST('2016-06-07' AS DATE)),"
                        + "(10, 'FABRIC_B', 'FABRIC', 'SOLAR', NULL, 30.0, CAST('2016-06-15 12:00:00' AS DATETIME), CAST('2016-06-15' AS DATE)),"
                        + "(11, 'HOUSE_A', 'HOUSE', 'FUEL', NULL, 6.0, CAST('2016-06-15 19:00:00' AS DATETIME), CAST('2016-06-15' AS DATE)),"
                        + "(12, 'HOUSE_B', 'HOUSE', 'NUCLEAR', NULL, 4.0, CAST('2016-06-15 20:00:00' AS DATETIME), CAST('2016-06-15' AS DATE));");
    }
