...
public class SQLServerPrimaryKeyTestSetup extends JDBCPrimaryKeyTestSetup {
    ...
    protected void createSequencedPrimaryKeyTable() throws Exception {
        ...
        run("CREATE TABLE seq (pkey int PRIMARY KEY DEFAULT NEXT VALUE FOR seq_pkey_sequence, "
        ...
        // use the sequence
        run("INSERT INTO gt_pk_metadata (table_name, pk_column, pk_policy, pk_sequence) "
