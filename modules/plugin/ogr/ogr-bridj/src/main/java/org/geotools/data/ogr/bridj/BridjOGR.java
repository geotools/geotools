...
public class BridjOGR implements OGR {
    ...
    public Object DriverCreateDataSource(Object driver, String dataSourceName, String[] opts) {
        ...
        return OGR_Dr_CreateDataSource(
                (Pointer<?>) driver, pointerToCString(dataSourceName), pointerToCStrings(opts));
    }
    ...
    public Object DataSourceCreateLayer(
        ...
        return OGR_DS_CreateLayer(
                ...
                (Pointer<?>) spatialReference,
                OGRwkbGeometryType.fromValue(geomType),
    ...
    public Object DataSourceExecuteSQL(Object dataSource, String sql, Object spatialFilter) {
        return OGR_DS_ExecuteSQL(
                (Pointer<?>) dataSource, pointerToCString(sql), (Pointer<?>) spatialFilter, null);
    }
    ...
    public ReferencedEnvelope toEnvelope(Object extent, CoordinateReferenceSystem crs) {
        ...
        return new ReferencedEnvelope(
                bounds.MinX(), bounds.MaxX(), bounds.MinY(), bounds.MaxY(), crs);
    }
    ...
    public void FeatureSetFieldDateTime(
        ...
        OGR_F_SetFieldDateTime(
                (Pointer<?>) feature, field, year, month, day, hour, minute, second, tz);
    }
    ...
    public void FeatureGetFieldAsDateTime(
        ...
        OGR_F_GetFieldAsDateTime(
                (Pointer<?>) feature, i, year, month, day, hour, minute, second, timeZone);
