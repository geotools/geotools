...
public class DbaseMixedFilterTest extends TestCaseSupport {
    
    final static String FILTERTEST_SHPFILE = "filter-mixed/filtertest.shp";
    ...
    public void setup() throws IOException {
        ...
        for (String shapeFileName : new String[]{ FILTERTEST_SHPFILE }) {
            ...
            URL url = TestData.url(TestCaseSupport.class, shapeFileName);
            File shpFile = DataUtilities.urlToFile(url);
    ...
    @Test
    public void testMixedFilterInShapeFile() throws Exception {
