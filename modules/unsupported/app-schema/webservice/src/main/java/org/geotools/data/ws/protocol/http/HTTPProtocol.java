 ...
 *
 * <p>This interface provides a mean for plain HTTP conversation. That is, issueing HTTP requests
 * both through GET and POST methods, handling gzip encoding/decoding if supported by the server,
 * URL encoding for query string parameters, and handling HTTP authentication.
 *
