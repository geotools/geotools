...
/**
 * Unit test suite for {@link org.geotools.data.ws.WS_DataStore}
 *
 * @author Russell Petty
 * @version $Id$
 * @since 2.5.x
 *     <p>http://gtsvn.refractions.net/trunk/modules/plugin/wfs/src/test/java/org/geotools/data
...
public class WS_DataStoreTest {
    ...
    /**
     * Test method for {@link org.geotools.data.ws.WS_DataStore#getTypeNames()}.
     *
     * @throws IOException
     */
    @Test
    public void testCreate() throws IOException {
        ...
        properties.put(
                ...
                TEST_DIRECTORY + "ws_capabilities_equals_removed.xml");
