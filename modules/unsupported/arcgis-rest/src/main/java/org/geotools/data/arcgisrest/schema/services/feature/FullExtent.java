...
public class FullExtent {
    ...
    @Expose
    private SpatialReference__ spatialReference;
     ...
     */
    public SpatialReference__ getSpatialReference() {
     ...
     */
    public void setSpatialReference(SpatialReference__ spatialReference) {
