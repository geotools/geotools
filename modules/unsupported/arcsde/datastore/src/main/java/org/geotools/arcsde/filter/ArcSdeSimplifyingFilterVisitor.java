...
/**
 * Custom simplifying filter visitor that also tries to turn multiple or-ed spatial filters into a
 * single spatial filter (since ArcSDE query cannot handle or-ed spatial conditions)
 *
        ...
        public SpatialOperation(BinarySpatialOperator op) {
            ...
            if (op.getExpression1() instanceof Literal) {
                ...
                throw new IllegalArgumentException(
                        "Cannot find literal geometry in the spatial filter");
            }
        }
    }
}
