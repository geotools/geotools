 ...
 * A node in the grid.
 *
 * <p>Data objects are stored in an HashSet.
 *
...
public class GridNode implements Node, Serializable {
    ...
    protected transient RegionNodeIdentifier id = null; // identifier of node

    /**
     * No-arg constructor for serialization purpose. Note: after deserialized you need to call
     * setIdentifier(NodeIdentifier) to setup the node properly.
     */
    protected GridNode() {}
