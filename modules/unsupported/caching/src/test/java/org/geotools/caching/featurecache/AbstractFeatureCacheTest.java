...
public abstract class AbstractFeatureCacheTest extends TestCase {
    ...
    public static final Filter unitsquarefilter;
    public static final Envelope unitsquare;
    protected static int numfilters = 100;

    static {
        Generator gen =
                new Generator(1, 1); // seed 1029 for a set registering outside of unitsquare
    ...
    public void testGetBounds() throws IOException {
        ...
        ReferencedEnvelope bnds =
                new ReferencedEnvelope(
                        dataset.getBounds(), dataset.getSchema().getCoordinateReferenceSystem());
