...
import static org.geotools.dggs.datastore.DGGSDataStore.DEFAULT_CRS;
import static org.geotools.dggs.datastore.DGGSDataStore.DEFAULT_GEOMETRY;
import static org.geotools.dggs.datastore.DGGSDataStore.GEOMETRY;
...
public class DGGSFeatureSourceImpl<I> implements DGGSFeatureSource<I> {
    ...
    public ResourceInfo getInfo() {
        ...
        return new ResourceInfo() {
            ...
            {
                words.add("features");
                words.add(DGGSFeatureSourceImpl.this.getSchema().getTypeName());
            }

            @Override
            public ReferencedEnvelope getBounds() {
                try {
                    return DGGSFeatureSourceImpl.this.getBounds();
                } catch (IOException e) {
                    return null;
                }
            }
            ...
            public CoordinateReferenceSystem getCRS() {
                return DGGSFeatureSourceImpl.this.getSchema().getCoordinateReferenceSystem();
            }
            ...
            public String getName() {
                return DGGSFeatureSourceImpl.this.getSchema().getTypeName();
            }

            @Override
            public URI getSchema() {
                Name name = DGGSFeatureSourceImpl.this.getSchema().getName();
                URI namespace;
                try {
