...
public class DuckDBFilterToSQL extends FilterToSQL {
    ...
    protected FilterCapabilities createFilterCapabilities() {
        ...
        // @TODO(gt-duckdb-function-pushdown): keep SQL function pushdown disabled until
        // DuckDB-specific function mappings are implemented and exposed behind a datastore/dialect
        // switch. Unsupported function expressions are expected to run as post-processed filters.
        return createFilterCapabilities(caps, false);
    }

    @Override
    public Object visit(NativeFilter filter, Object data) {
        throw new UnsupportedOperationException("DuckDB native filters are disabled by the GeoTools security wrapper");
    }
    ...
    protected Object visitBinarySpatialOperator(
        ...
        if (swapped) {
            return visitBinarySpatialOperator(filter, geometry, property, extraData);
        }
