...
public class DXFDimension extends DXFBlockReference {
    ...
    public DXFDimension(DXFDimension newDimension) {
        this(
                newDimension._angle,
                newDimension._dimension,
                newDimension._point_WCS._point.x,
                newDimension._point_WCS._point.y,
                newDimension._refBlock,
                newDimension._blockName,
                newDimension.getRefLayer(),
                0,
                newDimension.getColor(),
                newDimension.getLineType());
