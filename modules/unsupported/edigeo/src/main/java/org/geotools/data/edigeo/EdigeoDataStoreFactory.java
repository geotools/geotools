...
public class EdigeoDataStoreFactory implements DataStoreFactorySpi {
    ...
    public static final Param PARAM_PATH =
            new Param(
                    "path",
                    String.class,
                    "Full path of a single Edigeo file (THF)",
                    true,
                    "c:/data/edigeo/lot.thf");

    public static final Param PARAM_OBJ =
            new Param("obj", String.class, "Edigeo object id", true, "COMMUNE_id");
     ...
     * be read by the EdigeoDataStore implementations.
     *
     * @param params A map of parameters describing the location of a datastore.
     * @return true if params contains a path param which points to an Edigeo file ending in thf
     */
     ...
     *
     * <p>This datastore just checks for the EdigeoDataStore and Geometry implementations.
     *
    ...
    /**
     * Always return Collections#emptyMap(), because no hints are available for now.
     *
