...
public class EdigeoVECTest extends TestCase {
    ...
    public void testGetValue() {
        assertEquals(
                "CHAMBERY should be the value of this line",
                "CHAMBERY",
                eVecS1.getValue("ATVST08:CHAMBERY", "ATVST"));
        // test with a bad number of characters specified
        assertEquals(
                "CHAMBERY should be the value of this line, even if the "
                        + "specified length is out of range",
                "CHAMBERY",
    ...
    public void testGetType() {
        ...
        try {
            ...
            assertTrue(
                    "Face should be componed from at least one Arc",
                    geoms.size() > 0 && geoms.get(0).length > 1);
    ...
    public void testParseCoordinate() {
        if (coord == null) testGetXY();
        Coordinate coordinate = eVecS1.parseCoordinate(coord);
        assertTrue(
                "coordinate should be an instance of Coordinate", coordinate instanceof Coordinate);
    ...
    public void testCreateGeometry() {
        ...
        // Create geometry for a SECTION_id edigeo object with id Objet_434718 Objet_966450
        // (MultiPolygon)
        try {
            idObj = "Objet_966450";
        ...
        try {
            ...
            assertTrue(
                    "Coordinate list should contains at least two edges in order to construct a polygon",
                    coordList.size() > 1);
