 ...
 *
 * <ul>
 *   <li>{@link org.geotools.data.efeature.EFeature#getID <em>ID</em>}
 *   <li>{@link org.geotools.data.efeature.EFeature#getData <em>Data</em>}
 *   <li>{@link org.geotools.data.efeature.EFeature#getSRID <em>SRID</em>}
 *   <li>{@link org.geotools.data.efeature.EFeature#getDefault <em>Default</em>}
 *   <li>{@link org.geotools.data.efeature.EFeature#getStructure <em>Structure</em>}
 * </ul>
 *
...
public interface EFeature extends EObject {
     ...
     * <!-- begin-user-doc -->
     *
     * <p>If the meaning of the '<em>ID</em>' attribute isn't clear, there really should be more of
     * a description here...
     * <!-- end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>SRID</b></em>' attribute. The default value is <code>
     * "EPSG:4326"</code>.
     * <!-- begin-user-doc -->
     *
     * <p>The spatial reference ID (SRID) is an Coordinate Reference System authority code. The code
     ...
     * </code> Hence, changing the SRID affects ALL {@link EFeature}s with the same {@link
     * #getStructure() structure}. All {@link Feature#getBounds() bounds} of all {@link #getData()
     * feature}s is invalidated when the SRID is changed, forcing a bound calculation the first time
     * {@link Feature#getBounds()} is called on every feature with same structure as this.
     *
     ...
     *     instance where axis order is forced to (longitude, latitude).
     *     <!-- end-user-doc -->
     ...
     * <!-- begin-user-doc -->
     *
     * <p>If the meaning of the '<em>Data</em>' attribute isn't clear, there really should be more
    ...
    /**
     * Returns the value of the '<em><b>Default</b></em>' attribute. The default value is <code>
     * "geom"</code>.
     * <!-- begin-user-doc -->
     *
     * <p>If the meaning of the '<em>Default</em>' attribute isn't clear, there really should be
    ...
    /**
     * Sets the value of the '{@link org.geotools.data.efeature.EFeature#getDefault
     ...
     * <!-- begin-user-doc -->
     *
     * <p>If the meaning of the '<em>Structure</em>' attribute isn't clear, there really should be
     * more of a description here...
     * <!-- end-user-doc -->
     *
    ...
    /**
     * Sets the value of the '{@link org.geotools.data.efeature.EFeature#getStructure
     * <em>Structure</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     *
     * <!-- begin-user-doc -->
     * Get all {@link EFeatureAttribute attributes} not containing {@link Geometry geometry data}.
     *
     * <p>
     *
     ...
     *        end-user-doc -->
     * @model
     *     dataType="org.geotools.data.efeature.List<org.geotools.data.efeature.EFeatureAttribute<V>>"
     ...
     *
     * <!-- begin-user-doc -->
     * Get all {@link EFeatureGeometry geometry attributes}.
     *
     * <p>
     *
     ...
     *     <!-- end-user-doc -->
     * @model
     *     dataType="org.geotools.data.efeature.List<org.geotools.data.efeature.EFeatureGeometry<V>>"
     *     required="true" many="false" VBounds="org.geotools.data.efeature.Geometry"
     * @generated
     */
     ...
     *
     * @model dataType="org.geotools.data.efeature.Feature" required="true"
     *     newDataDataType="org.geotools.data.efeature.Feature" newDataRequired="true"
     *     transactionDataType="org.geotools.data.efeature.Transaction" transactionRequired="true"
     * @generated
     */
