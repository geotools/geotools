...
public class EFeatureContextInfo extends EStructureInfo<EFeatureContextInfo> {
    ...
    protected Map<String, EFeaturePackageInfo> ePackageMap =
            new HashMap<String, EFeaturePackageInfo>();
    ...
    /**
     * Get {@link EFeaturePackageInfo package information} mapped to {@link
     * EFeaturePackageInfo#eNsURI() namespace URIs}
     *
     * <p>
     *
     * @throws IllegalStateException If {@link #isDisposed() disposed}, or in{@link #isValid()
     *     valid}.
     */
    ...
    /**
     * Get {@link EFeaturePackageInfo} with given {@link EPackage#getNsURI() namespace URI}.
     *
     * @param eNsURI
    ...
    /**
     * Check if a {@link EFeatureDataStore} with with given {@link EPackage#getNsURI() namespace
     * URI}.
     *
    ...
    /**
     * Get the {@link EFeatureInfo} instance cached for the {@link EClass} defining given {@link
     * EObject}.
     *
     * @param eObject - the {@link EObject} instance
    ...
    /**
     * Get the {@link EFeatureInfo} instance cached for {@link EFeatureFolderInfo folder} and {@link
     * EClass class}.
     *
    ...
    public boolean contains(EFeatureInfo eInfo) {
        return eFeatureInfoCache().contains(eInfo.eNsURI, eInfo.eFolderName, eInfo.eName());
    }

    /**
     * Check if a {@link EFeatureInfo#isPrototype() prototype} instance is cached for given {@link
     * EClass}.
     *
     * <p>Since a {@link EClass}es only contains information about the {@link EPackage#getNsURI()
     * eNsURI} and EFeature {@link EClass#getName() root name}, this method only checks for EFeature
     * prototypes (does not belong to any folder).
     *
     * <p><b>NOTE</b>: This only checks for <i>key equivalence</i>. If two keys are equal within the
     * same {@link EFeatureContext}, the two structures must by definition be equal.
     *
    ...
    /**
     * Adapt given {@link EFeatureInfo structure} to this {@link EFeatureContext#eContext()
     * context}.
     *
     * @param eInfo - {@link EFeatureInfo} to be adapted into this context
     * @param copy - if <code>true</code>, a copy of given {@link EFeatureInfo structure} is
     *     adapted. If <code>false</code>, the structure is claimed from it's context (moved into to
     *     this context).
     ...
     * @param copy - if <code>true</code>, copy {@link EFeatureInfo} instance into this context. If
     *     <code>false</code>, claim it (move into this context).
     ...
     *
     * <p>This enables reuse of {@link EFeatureInfo} instances, and ensures that only one instance
     * exists for each uniquely different {@link EFeatureInfo structure}.
     */
    protected EFeatureInfoCache eFeatureInfoCache() {
    ...
    protected EFeatureListener<EFeatureInfoCache> eFeatureInfoCacheVoter() {
        if (eFeatureInfoCacheVoter == null) {
            eFeatureInfoCacheVoter =
                    new EFeatureListener<EFeatureInfoCache>() {

                        @Override
                        public boolean onChange(
                                EFeatureInfoCache source,
                                int property,
                                Object oldValue,
                                Object newValue) {
                            //
    ...
    /**
     * Create a {@link EFeatureContext} instance from cached {@link EFeatureContext} instance.
     *
     * <p>
     *
     ...
     * @throws IllegalArgumentException If the instance for some reason could not be constructed.
    ...
    /**
     * Synchronize given {@link EFeatureContextInfo structure} with it's {@link
     * EFeatureContextFactory factory} counterpart.
     *
     * <p>This is required since {@link EPackage packages} are allowed to be added to and removed
     * from the context.
     *
     * @param eContextInfo - {@link EFeatureContextInfo structure}
     * @return a {@link Map} from {@link EFeatureContextInfo#eContextID() eContexID} to {@link
     *     EFeatureContextInfo} instances.
     */
    protected static final Map<String, EFeaturePackageInfo> synchronize(
            EFeatureContextInfo eContextInfo) {
        EChange eChange = new EChange();
    ...
    private static class EChange {
         ...
         * EFeatureContextFactory factory} counterpart.
         *
         * <p>This is required since {@link EPackage packages} are allowed to be added to and
         ...
         *     EFeatureContextInfo} instances.
         */
        public final Map<String, EFeaturePackageInfo> synchronize(
                EFeatureContextInfo eContextInfo) {
            //
            ...
            synchronized (eContextInfo.ePackageMap) {
                ...
                //
                Map<String, EFeaturePackageInfo> eNewMap =
                        new HashMap<String, EFeaturePackageInfo>(eNsURIs.size());
