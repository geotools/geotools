...
public class EFeatureDataStore extends ContentDataStore {
     ...
     * @param eURI - {@link URI} formated string to EMF {@link Resource} containing {@link
     *     EFeature}s
     ...
     * </pre>
     *
     * @param eWritable - if <code>true</code> {@link EFeature}s are writable ({@link
     *     EFeatureWriter#UPDATE} | {@link EFeatureWriter#APPEND})
     * @throws IOException
     * @throws IllegalArgumentException If any argument is invalid.
     * @see {@link URI#createURI(String)}
     */
    public EFeatureDataStore(
            String eContextID,
            String eDomainID,
            String eNsURI,
            String eURI,
        ...
        //
        this(
                EFeatureDataStoreFactory.eGetContextFactory().eContext(eContextID),
                eDomainID,
                eNsURI,
                eURI,
                eTypes,
    ...
    public EFeatureDataStore(
        ...
        if (this.ePackageInfo == null) {
            throw new IOException(
                    "EFeatureDataStore structure not "
                            + "found in context: '"
                            + eContextID
                            + "/"
                            + eDomainID
    ...
    public FeatureTypeFactory getFeatureTypeFactory() {
        throw new UnsupportedOperationException(
                "EFeatureDataStore does not support FeatureTypeFactory");
    }
    ...
    public FeatureFactory getFeatureFactory() {
        throw new UnsupportedOperationException(
                "EFeatureDataStore does not support FeatureFactory");
    }
    ...
    public GeometryFactory getGeometryFactory() {
        throw new UnsupportedOperationException(
                "EFeatureDataStore does not support GeometryFactory");
    }
     ...
     */
    public final FeatureWriter<SimpleFeatureType, SimpleFeature> getEFeatureWriter(
            String eType, Filter filter, Transaction tx) throws IOException {
     ...
     * Returns a {@link EFeatureWriter} for the specified type name and transaction.
     *
     * <p>This returns a writer only capable of updating {@link EFeature features}
     *
     * @param eType - (required) {@link EFeature} type name on the format:
     *     <pre>
     * eType := &lt;eFolder&gt;.&lt;eFeature&gt;
     ...
     */
    public final FeatureWriter<SimpleFeatureType, SimpleFeature> getEFeatureWriterUpdate(
            String eType, Filter filter, Transaction tx) throws IOException {
    ...
    /**
     * Convenience method for calling {@link #getFeatureReader(Query, Transaction)} with {@link
     * Transaction#AUTO_COMMIT} as the transaction.
     *
    ...
    @Override
    public EFeatureReader getFeatureReader(Query query, Transaction transaction)
            throws IOException {
    ...
    /**
     * Gets the names of {@link FeatureType feature types} available in this {@code
     * EFeatureDataStore store}.
     *
     * <p>Since {@link EFeatureDataStore}s only have one name space by design, this method is
     * guaranteed to return a list of unique names since the all unqualified type names are present
     * in the same name space. The following naming convention is used:
     *
     * <pre>
    ...
    protected ContentFeatureSource createFeatureSource(ContentEntry entry) throws IOException {
        ...
        //
        return eWritable
                ? new EFeatureStore(entry, eDataStoreQuery)
