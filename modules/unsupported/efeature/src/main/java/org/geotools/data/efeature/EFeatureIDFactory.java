...
public interface EFeatureIDFactory {
    ...
    /**
     * Check if this {@link EFeatureIDFactory factory} contains IDs for given {@link
     * Resource#getURI() URI}.
     *
    ...
    /**
     * Check if this {@link EFeatureIDFactory factory} contains an ID for given {@link EObject
     * object}.
     *
     ...
     * @return an {@link EFeature} {@link EFeature#getID() ID} if found, <code>null</code>
     *     otherwise.
     * @throws IllegalArgumentException If the factory does not create IDs for given {@link EObject}
     * @throws IllegalStateException If given {@link EObject} is not added to an EMF {@link
     *     Resource}.
     */
     ...
     * @return a {@link Map} of IDs for given {@link URI}. If this does not contain any IDs for
     *     given URI, an empty map is returned.
     */
     ...
     *
     * @param eObject - a {@link EFeature} instance or a {@link EObject} containing {@link EFeature}
     *     compatible data.
     * @return <code>true</code> if this factory create IDs for given {@link EFeature} instance.
     */
     ...
     *
     * @param eAttribute - the {@link EClass} implementing {@link EFeature}, or contains {@link
     *     EFeature} compatible data.
     * @return <code>true</code> if this factory create IDs for given {@link EClass} instance.
     */
     ...
     *
     * @param eClass - the {@link EClass} implementing {@link EFeature}, or contains {@link
     *     EFeature} compatible data.
     * @return <code>true</code> if this factory create IDs for given {@link EAttribute} instance.
     */
     ...
     * @throws IllegalArgumentException If {@link EObject} does not contain an attribute with {@link
     *     String} data.
     */
     ...
     *
     * <p>If the class does not contain any, {@link EClass#getEIDAttribute() ID attribute} the first
     * changeable attribute with {@link String} data is selected.
     *
     * @param eClass - the {@link EClass} implementing {@link EFeature}, or contains {@link
     *     EFeature} compatible data.
     * @return the {@link EClass#getEIDAttribute() ID attribute}
     * @throws IllegalArgumentException If {@link EClass} does not contain any changeable attributes
     *     with {@link String} data.
     */
     ...
     * @return the {@link EClass#getEIDAttribute() ID attribute}
     * @throws IllegalArgumentException If {@link EAttribute} is unchangeable or does not contain
     *     {@link String} data.
     */
    ...
    /**
     * Use given ID as a unique {@link EFeature#getID() EFeature ID} for given {@link EObject}
     * instance.
     *
     * @param eObject - a {@link EFeature} instance or a {@link EObject} containing {@link EFeature}
     *     compatible data.
