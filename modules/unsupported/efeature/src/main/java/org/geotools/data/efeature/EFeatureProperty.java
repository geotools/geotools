 ...
 *
 * <p>The following members are supported:
 *
 * <ul>
 *   <li>{@link EFeatureProperty#getValue <em>Value</em>}
 *   <li>{@link EFeatureProperty#getValueType <em>Value Type</em>}
 *   <li>{@link EFeatureProperty#getData <em>Data</em>}
 *   <li>{@link EFeatureProperty#getDataType <em>Data Type</em>}
 * </ul>
 *
...
public interface EFeatureProperty<V, T extends Property> {
    ...
    /**
     * Set {@link Property feature property} instance wrapped by this class.
     *
    ...
    /**
     * Get the actual {@link Property feature property} class
     *
    ...
    /**
     * Get the actual {@link Property#getValue() feature property value} class
     *
    ...
    /**
     * Check if the value of this property is detached from {@link #eObject()}.
     *
     ...
     *
     * <p>This is a convenience method which forwards to {@link #write(Transaction)} using {@link
