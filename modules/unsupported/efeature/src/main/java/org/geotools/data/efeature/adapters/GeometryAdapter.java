...
/**
 * An Adapter class to be used to extract from -adapt- the argument object to some {@link Geometry}
...
public abstract class GeometryAdapter implements IDataTypeAdapter<Geometry> {
    ...
    /**
     * The simplest {@link GeometryAdapter} implementation that represents the case when the
     * argument object to adapt is a
     *
     * <ol>
     *   <li>{@link Geometry}
     *   <li>{@link DataTypes#WKT} formated string
     *   <li>{@link DataTypes#WKB} formated byte array
     * </ol>
     */
    public static final GeometryAdapter DEFAULT =
            new GeometryAdapter() {
                @Override
