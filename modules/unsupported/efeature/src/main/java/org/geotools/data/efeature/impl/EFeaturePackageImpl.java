...
public class EFeaturePackageImpl extends EPackageImpl implements EFeaturePackage {
     ...
     *
     * <p>This method is used to initialize {@link EFeaturePackage#eINSTANCE} when that field is
    ...
    public static EFeaturePackage init() {
        if (isInited)
            return (EFeaturePackage)
                    EPackage.Registry.INSTANCE.getEPackage(EFeaturePackage.eNS_URI);

        // Obtain or create and register package
        EFeaturePackageImpl theEFeaturePackage =
                (EFeaturePackageImpl)
                        (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof EFeaturePackageImpl
                                ? EPackage.Registry.INSTANCE.get(eNS_URI)
                                : new EFeaturePackageImpl());
    ...
    public void initializePackageContents() {
        ...
        ETypeParameter eFeaturePropertyEDataType_T =
                addETypeParameter(eFeaturePropertyEDataType, "T");
        addETypeParameter(eFeatureAttributeEDataType, "V");
        ETypeParameter eFeatureGeometryEDataType_V =
                addETypeParameter(eFeatureGeometryEDataType, "V");
        ...
        initEAttribute(
                ...
                IS_ORDERED);
        initEAttribute(
                getEFeature_Structure(),
                this.getEFeatureInfo(),
                "structure",
                null,
                1,
                1,
        ...
        EOperation op =
                addEOperation(
                        eFeatureEClass, null, "getAttributeList", 1, 1, IS_UNIQUE, IS_ORDERED);
        ...
        op =
                addEOperation(
                        eFeatureEClass, this.getFeature(), "getData", 1, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, this.getTransaction(), "transaction", 1, 1, IS_UNIQUE, IS_ORDERED);

        op =
                addEOperation(
                        eFeatureEClass, this.getFeature(), "setData", 1, 1, IS_UNIQUE, IS_ORDERED);
        ...
        initEDataType(
                ...
                !IS_GENERATED_INSTANCE_CLASS);
        initEDataType(
                transactionEDataType,
                Transaction.class,
                "Transaction",
                !IS_SERIALIZABLE,
                !IS_GENERATED_INSTANCE_CLASS);
        initEDataType(
                geometryAttributeEDataType,
        ...
        initEDataType(
                ...
                !IS_GENERATED_INSTANCE_CLASS);
        initEDataType(
                eStructureInfoEDataType,
                EStructureInfo.class,
                "EStructureInfo",
                !IS_SERIALIZABLE,
                !IS_GENERATED_INSTANCE_CLASS);
        initEDataType(
                eFeatureInfoEDataType,
                EFeatureInfo.class,
                "EFeatureInfo",
                !IS_SERIALIZABLE,
                !IS_GENERATED_INSTANCE_CLASS);
        initEDataType(
                eFeatureAttributeInfoEDataType,
                EFeatureAttributeInfo.class,
                "EFeatureAttributeInfo",
                !IS_SERIALIZABLE,
                !IS_GENERATED_INSTANCE_CLASS);
        initEDataType(
                eFeatureGeometryInfoEDataType,
                EFeatureGeometryInfo.class,
        ...
        initEDataType(
                ...
                !IS_GENERATED_INSTANCE_CLASS);
        initEDataType(
                listEDataType, List.class, "List", !IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
        initEDataType(
                eFeaturePropertyEDataType,
                EFeatureProperty.class,
                "EFeatureProperty",
                !IS_SERIALIZABLE,
                !IS_GENERATED_INSTANCE_CLASS);
        initEDataType(
                eFeatureAttributeEDataType,
                EFeatureAttribute.class,
                "EFeatureAttribute",
                !IS_SERIALIZABLE,
                !IS_GENERATED_INSTANCE_CLASS);
        initEDataType(
                eFeatureGeometryEDataType,
                EFeatureGeometry.class,
                "EFeatureGeometry",
                !IS_SERIALIZABLE,
                !IS_GENERATED_INSTANCE_CLASS);
    ...
    protected void createGenModelAnnotations() {
        ...
        addAnnotation(
                getEFeature_Default(),
                source,
                new String[] {"Doumentation", "Name of default EFeatureGeometry"});
    }
} // EFeaturePackageImpl
