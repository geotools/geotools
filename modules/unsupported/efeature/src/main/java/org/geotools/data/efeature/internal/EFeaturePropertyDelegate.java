...
public abstract class EFeaturePropertyDelegate<V, T extends Property, S extends EStructuralFeature>
    ...
    /**
     * Cached {@link EFeatureInternal} instance containing the {@link Property#getValue() property
     * value}.
     *
     * <p>The {@link #eObject delegate} is stored as a {@link WeakReference weak reference} so it is
    ...
    /**
     * The id of the {@link EStructuralFeature structural feature} of the {@link #eObject
     * implementation} which contains the {@link #getData() property data}
     */
    ...
    public final boolean isDisposed() {
        return eInternal.get() == null || eStructuralFeature.get() == null;
    }
    ...
    /**
     * @throws IllegalStateException If {@link EFeatureInternal internal implementation} is {@link
     *     #isDisposed() disposed}.
     */
    @Override
