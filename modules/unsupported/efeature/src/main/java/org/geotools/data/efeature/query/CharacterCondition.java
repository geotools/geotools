...
/**
 * A {@link Condition} object that tests for {@link Character} arguments. The arguments being
 * evaluated are adapted to a <code>Character</code> first using a {@link CharacterAdapter} and then
 * compared to the initialization value of this <code>CharacterAdapter</code>. It evaluates to
...
public class CharacterCondition extends Condition {
     ...
     * relational operator to apply in comparisons. I assume that inputs are {@link Character}
     * objects.
     *
     * @param c - the {@link Character} object to match against input values
     ...
     * they will be {@link Character} objects. I am, by default, a {@linkplain #BETWEEN between}
     * test.
     *
    ...
    public CharacterCondition(
            boolean between, Character lower, Character upper, CharacterAdapter adapter) {
     ...
     * @since 1.2
     */
    public static CharacterCondition between(
            Character lower, boolean lowerInclusive, Character upper, boolean upperInclusive) {
     ...
     * @since 1.2
     */
    public static CharacterCondition outside(
            Character lower, boolean lowerInclusive, Character upper, boolean upperInclusive) {
