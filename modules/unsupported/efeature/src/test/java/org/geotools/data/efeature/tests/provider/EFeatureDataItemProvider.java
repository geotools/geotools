...
/**
 * This is the item provider adapter for a {@link org.geotools.data.efeature.tests.EFeatureData}
 * object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 ...
 * @source $URL$
 */
public class EFeatureDataItemProvider extends ItemProviderAdapter
        ...
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor(
                        ...
                        getString(
                                ...
                                "_UI_EFeature_SRID_feature",
                                "_UI_EFeature_type"), // $NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addStructurePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor(
                        ...
                        getString(
                                "_UI_PropertyDescriptor_description",
                                "_UI_EFeature_structure_feature",
                                "_UI_EFeature_type"), // $NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addAttributePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor(
                        ...
                        getString(
                                "_UI_PropertyDescriptor_description",
                                "_UI_EFeatureData_attribute_feature",
                                "_UI_EFeatureData_type"), // $NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addGeometryPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor(
                        ...
                        getString(
                                "_UI_PropertyDescriptor_description",
                                "_UI_EFeatureData_geometry_feature",
                                "_UI_EFeatureData_type"), // $NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0
                ? getString("_UI_EFeatureData_type")
                : // $NON-NLS-1$
