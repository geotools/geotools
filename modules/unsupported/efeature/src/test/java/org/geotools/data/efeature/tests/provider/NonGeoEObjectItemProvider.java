 ...
 * @source $URL$
 */
public class NonGeoEObjectItemProvider extends ItemProviderAdapter
    ...
    public Object getImage(Object object) {
        return overlayImage(
                object, getResourceLocator().getImage("full/obj16/NonGeoEObject")); // $NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        ...
        return getString("_UI_NonGeoEObject_type")
                + " "
                + nonGeoEObject.getNonGeoAttribute(); // $NON-NLS-1$ //$NON-NLS-2$
    }
