 ...
 * <copyright>
 *
 * <p>Copyright (c) 2005, 2008 IBM Corporation, Zeligsoft Inc. and others. All rights reserved. This
 * program and the accompanying materials are made available under the terms of the Eclipse Public
 * License v1.0 which accompanies this distribution, and is available at
 * http://www.eclipse.org/legal/epl-v10.html
 *
 * <p>Contributors: IBM - Initial API and implementation Zeligsoft - Bug 234868
 *
 * <p></copyright>
 */
...
public abstract class AbstractResourceTest extends AbstractEFeatureTest {
    ...
    protected <T> AbstractResourceTest(
            String name, String contentType, boolean reuse, boolean delete) {
        super(name);
        this.reuse = reuse;
        this.delete = delete;
    ...
    public final void setUp() throws Exception {
        ...
        try {
            ...
            Resource r =
                    (createNew
                            ? eResourceSet.createResource(eResourceURI, contentType)
     ...
     *
     * <p>Is called by {@link #setUp()}, and always BEFORE {@link
     ...
     *
     * <p>Is called by {@link #setUp()}, and always AFTER {@link #createResourceSet()}.
     *
     ...
     * Create file name.
     *
     * <p>Default implementation is to return {@link Class#getSimpleName() implementing class name}.
    ...
    /**
     * This method is called by {@link #setUp()} immediately after the {@link #eResource} is
     * constructed and just before it is saved to file and reference to it is cached.
     *
