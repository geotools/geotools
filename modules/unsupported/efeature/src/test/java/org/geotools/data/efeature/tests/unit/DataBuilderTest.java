 ...
 *
 * <ol>
 *   <li>{@link GeometryAdapter#DEFAULT}
 *   <li>{@link WKTAdapter#DEFAULT}
 *   <li>{@link WKBAdapter#DEFAULT}
 * </ol>
 *
...
public class DataBuilderTest extends TestCase {
    ...
    public void testWKTAdapter() throws ParseException {
        ...
        assertWKT(
                EFeatureTestData.generateLineStringWKTs(
                        1, Integer.MIN_VALUE, Integer.MAX_VALUE, 50, 100)[0]);
        assertWKT(DataTypes.WKT_POLYGON_EMPTY);
        assertWKT(
                EFeatureTestData.generatePolygonWKTs(
                        1, Integer.MIN_VALUE, Integer.MAX_VALUE, 50, 100, 5, 10)[0]);
    ...
    private static void assertWKT(String wkt) throws ParseException {
        ...
        assertTrue("WKT: [" + s + "] is not equal to [" + wkt + "]", wkt.equals(s));
    }
    ...
    private static void assertWKB(byte[] wkb) throws ParseException {
        ...
        assertTrue(
                "WKB: [" + Arrays.toString(b) + "] is not equal to [" + Arrays.toString(wkb) + "]",
                Arrays.equals(wkb, b));
    }
}
