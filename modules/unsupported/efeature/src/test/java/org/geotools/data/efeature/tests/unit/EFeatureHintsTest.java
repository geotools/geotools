...
public class EFeatureHintsTest extends AbstractResourceTest {
    ...
    //            // Loop over types
    //            //
    //            for(String eType : new
    // String[]{"efeature.EFeatureData","efeature.EFeatureCompatibleData"}) {
    //                //
    ...
    //                assertNotSame("Features are same instances
    // ["+eType+",detached:="+eDetached+",singleton:=false]", f1,f2);
    //                assertNotSame("EObjects are same instances
    // ["+eType+",detached:="+eDetached+",singleton:=false]", f1.eObject(),f2.eObject());
    //                assertNotSame("EFeatures are same instances
    // ["+eType+",detached:="+eDetached+",singleton:=false]", f1.eFeature(),f2.eFeature());
    //                //
    //                // -------------------------------------------------------
    ...
    //                f1 = eReader.next();
    //                f2 = eReader.next();
    //                assertSame("Features are not same instances
    // ["+eType+",detached:="+eDetached+",singleton:=true]", f1,f2);
    //                assertSame("EObjects are not same instances
    // ["+eType+",detached:="+eDetached+",singleton:=true]", f1.eObject(),f2.eObject());
    //                assertSame("EFeatures are not same instances
    // ["+eType+",detached:="+eDetached+",singleton:=true]", f1.eFeature(),f2.eFeature());
    //                //
    //                //
    // -----------------------------------------------------------------------------
    //                //  A.3) Test instance ESimpleFeature mode again, this time ensuring hint
    // resets
    //                //
    // -----------------------------------------------------------------------------
    //                //
    ...
    //                f2 = eReader.next();
    //                assertNotSame("Features are same instances
    // [transitive,"+eType+",detached:="+eDetached+",singleton:=false]", f1,f2);
    //                assertNotSame("EObjects are same instances
    // [transitive,"+eType+",detached:="+eDetached+",singleton:=false]", f1.eObject(),f2.eObject());
    //                assertNotSame("EFeatures are same instances
    // [transitive,"+eType+",detached:="+eDetached+",singleton:=false]",
    // f1.eFeature(),f2.eFeature());
    //                //
    //                // Dispose data store
    //                //
    //                eStore.dispose();
    ...
    //                assertTrue("Feature and EObject values not same
    // [1,"+eType+",singleton:="+eSingleton+",detached:=false]",
    ...
    //                assertTrue("Feature and EObject values not same
    // [2,"+eType+",singleton:="+eSingleton+",detached:=false]",
    //                        eValues.equals(EFeatureUtils.eGetFeatureValues(eStructure, eFeature,
    // Transaction.AUTO_COMMIT)));
    //                //
    //                // ---------------------------------------------------------------------
    ...
    //                eValues = feature.getAttributes();
    //                assertTrue("Feature and EObject values not same
    // [3,"+eType+",singleton:="+eSingleton+",detached:=true]",
    //                        eValues.equals(EFeatureUtils.eGetFeatureValues(eStructure, eFeature,
    // Transaction.AUTO_COMMIT)));
    //                //
    //                // --------------------------------------------------------------------
    ...
    //                eFeature.eSet(eAttr, v);
    //                eValues = feature.getAttributes();
    //                assertFalse("Feature and EObject values same
    // [4,"+eType+",singleton:="+eSingleton+",detached:=true]",
    //                        eValues.equals(EFeatureUtils.eGetFeatureValues(eStructure, eFeature,
    // Transaction.AUTO_COMMIT)));
    //                //
    //                // Dispose data store
