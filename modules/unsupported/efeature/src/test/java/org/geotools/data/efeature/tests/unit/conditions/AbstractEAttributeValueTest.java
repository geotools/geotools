 ...
 * @source $URL$
 */
public abstract class AbstractEAttributeValueTest
        extends AbstractEAttributeFilterTest<EFeatureData<Object, Geometry>> {
    ...
    public static final int NUMBER_OPS =
            EQUAL_TO
                    | NOT_EQUAL_TO
                    | LESS_THAN
     ...
     *
     * <p>This is a unary operation, only requiring a single test value (no filter value).
     */
    public static final Tests IS_NULL_TESTS = new Tests(nameOf(IS_NULL), new Pass(true, 0));

    /**
     * {@link #EQUAL_TO} operation test specification.
     *
     * <p>This is a binary operation requiring two equal values
     */
    public static final Tests EQUAL_TO_TESTS = new Tests(nameOf(EQUAL_TO), new Pass(true, 0, 0));

    /**
     * {@link #NOT_EQUAL_TO} operation test specification.
     *
     * <p>This is a binary operation, requiring two unequal values
     */
    public static final Tests NOT_EQUAL_TO_TESTS =
            new Tests(nameOf(NOT_EQUAL_TO), new Pass(true, 0, 1));

    /**
     * {@link #LESS_THAN} operation test specification.
     *
     * <p>This is a binary operation requiring two values, one less than the other
     */
    public static final Tests LESS_THAN_TESTS = new Tests(nameOf(LESS_THAN), new Pass(true, 0, 1));

    /**
     * {@link #LESS_THAN_OR_EQUAL_TO} operation test specification.
     *
     * <p>This is binary operation requiring two passes. First pass verifies {@link #EQUAL_TO},
     * requiring one unique value. The second pass verifies {@link #LESS_THAN}, requiring two
     * values, one less than the other.
     */
    public static final Tests LESS_THAN_OR_EQUAL_TO_TESTS =
            new Tests(nameOf(LESS_THAN_OR_EQUAL_TO), EQUAL_TO_TESTS, LESS_THAN_TESTS);

    /**
     * {@link #GREATER_THAN} operation test specification.
     *
     * <p>This is a binary operation requiring two values, one greater than the other
     */
    public static final Tests GREATER_THAN_TESTS =
            new Tests(nameOf(GREATER_THAN), new Pass(true, 1, 0));

    /**
     * {@link #GREATER_THAN_OR_EQUAL_TO} operation test specification.
     *
     * <p>This is binary operation requiring two passes. First pass verifies {@link #EQUAL_TO},
     * requiring one unique value. The second pass verifies {@link #GREATER_THAN}, requiring two
     * values, one greater than the other.
     */
    public static final Tests GREATER_THAN_OR_EQUAL_TO_TESTS =
            new Tests(nameOf(GREATER_THAN_OR_EQUAL_TO), EQUAL_TO_TESTS, GREATER_THAN_TESTS);

    /**
     * {@link #IS_LIKE} operation test specification.
     *
     * <p>This is a binary operation requiring two values, where one match the other.
     */
    public static final Tests IS_LIKE_TESTS = new Tests(nameOf(IS_LIKE), new Pass(true, 0, 3));

    /**
     * {@link #BETWEEN} operation test specification.
     *
     * <p>This is a ternary operation requiring three values: two defining a range, and the last
     * inside this range.
     */
    public static final Tests BETWEEN_TESTS = new Tests(nameOf(BETWEEN), new Pass(true, 2, 0, 1));
     ...
     * outside this range.
     */
    public static final Tests OUTSIDE_TESTS = new Tests(nameOf(OUTSIDE), new Pass(true, 0, 2, 1));

    /**
     * {@link #IS_ID} operation test specification.
     *
     * <p>This is a n-ary operation requiring N values, N>0.
     */
    public static final Tests IS_ID_TESTS = new Tests(nameOf(IS_ID), new Pass(true, 2, ALL));

    // -----------------------------------------------------
    //  Cached tests
    // -----------------------------------------------------

    public static final Tests[] TESTS =
            new Tests[] {
                //
                ...
                NOT_EQUAL_TO_TESTS,
                LESS_THAN_TESTS,
                LESS_THAN_OR_EQUAL_TO_TESTS,
                GREATER_THAN_TESTS,
                GREATER_THAN_OR_EQUAL_TO_TESTS,
                IS_LIKE_TESTS,
                //
    ...
    protected static final Values NULLS[] =
            new Values[] {new Values(IS_NULL, Object.class, null, null, null)};

    /** Cached boolean values */
    protected static final Values BOOLEANS[] =
            new Values[] {
                new Values(BOOLEAN_OPS, Boolean.class, Boolean.TRUE, Boolean.FALSE, Boolean.FALSE)
            };

    /** Cached primitive values */
    protected static final Values NUMBERS[] =
            new Values[] {
                new Values(
                        NUMBER_OPS,
                        Integer.class,
                ...
                new Values(
                        ...
                        new Double(1.0)),
                new Values(
                        NUMBER_OPS, Float.class, Float.MIN_VALUE, Float.MAX_VALUE, new Float(1.0F)),
                new Values(
                        NUMBER_OPS, Byte.class, Byte.MIN_VALUE, Byte.MAX_VALUE, new Byte((byte) 1)),
                new Values(
                        NUMBER_OPS,
                        Short.class,
                        Short.MIN_VALUE,
    ...
    /** Cached date values */
    protected static final Values DATES[] =
            new Values[] {
                new Values(
                        DATE_OPS,
                        Integer.class,
    ...
    protected static final Values CHARACTERS[] =
            new Values[] {
                new Values(
                        CHARACTER_OPS,
                        Character.class,
    ...
    protected static final Values STRINGS[] =
            new Values[] {new Values(STRING_OPS, String.class, "ax", "az", "ay", "a*")};

    /** Cached ID values */
    public static final Values IDS[] =
            new Values[] {new Values(IS_ID, Set.class, "F1", "F100", "F50")};

    /** Concatenation of all cached values */
    protected static final Values VALUES[] =
            EFeatureUtils.concat(
                    Values.class, NULLS, BOOLEANS, NUMBERS, DATES, CHARACTERS, STRINGS, IDS);

    /** Cached {@link EAttribute} reference */
    protected static final EAttribute eAttribute =
    ...
    @Override
    protected final void updateFixture(
            EFeatureData<Object, Geometry> eFixture, int value, int pass) {
        //
        // Update values
        //
    ...
    protected abstract Condition createCondition(int value, Object filter)
