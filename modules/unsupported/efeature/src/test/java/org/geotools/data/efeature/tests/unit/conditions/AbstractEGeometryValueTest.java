 ...
 * @source $URL$
 */
public abstract class AbstractEGeometryValueTest
    ...
    public static final int GEOMETRY_OPS =
            BBOX
                    | BEYOND
                    | CONTAINS
                    | CROSSES
     ...
     *
     * <p>This is a binary operation requiring two unique geometries, one having a boundary that
     * overlaps the boundary of the other.
     */
    public static final Tests BBOX_TESTS = new Tests(nameOf(BBOX), new Pass(true, 0, 1));

    /**
     * {@link #BEYOND} operation test specification.
     *
     * <p>This is a ternary operation requiring three unique geometries, two unique geometries, and
     * the last which is the minimum separating distance between given geometries.
     */
    public static final Tests BEYOND_TESTS = new Tests(nameOf(BEYOND), new Pass(true, 0, 1, 2));

    /**
     * {@link #CONTAINS} operation test specification.
     *
     * <p>This is a binary operation requiring two unique geometries, one completely containing the
     * other.
     */
    public static final Tests CONTAINS_TESTS = new Tests(nameOf(CONTAINS), new Pass(true, 0, 1));
     ...
     */
    public static final Tests CROSSES_TESTS = new Tests(nameOf(CROSSES), new Pass(true, 0, 1));

    /**
     * {@link #DISJOINT} operation test specification.
     *
     * <p>This is binary operation requiring two unique geometries, where none of them have a
     * overlapping boundary.
     */
    public static final Tests DISJOINT_TESTS = new Tests(nameOf(DISJOINT), new Pass(true, 0, 1));

    /**
     * {@link #DWITHIN} operation test specification.
     *
     * <p>This is a ternary operation requiring three geometries, one greater than the other
     */
    public static final Tests DWITHIN_TESTS = new Tests(nameOf(DWITHIN), new Pass(true, 0, 1, 2));

    /**
     * {@link #EQUALS} operation test specification.
     *
     * <p>This is binary operation requiring two equal geometries.
     */
    public static final Tests EQUALS_TESTS = new Tests(nameOf(EQUALS), new Pass(true, 0, 0));

    /**
     * {@link #INTERSECTS} operation test specification.
     *
     * <p>This is a binary operation requiring two geometries, one intersecting the other.
     */
    public static final Tests INTERSECTS_TESTS =
            new Tests(
                    nameOf(INTERSECTS),
                    //
     ...
     *
     * <p>This is a binary operation requiring two unique geometries, one overlapping the other.
     */
    public static final Tests OVERLAPS_TESTS =
            new Tests(
                    nameOf(OVERLAPS),
                    //
     ...
     *
     * <p>This is a binary operation requiring two unique geometries, one touching the other.
     */
    public static final Tests TOUCHES_TESTS = new Tests(nameOf(TOUCHES), new Pass(true, 0, 1));

    /**
     * {@link #WITHIN} operation test specification.
     *
     * <p>This is a binary operation requiring two unique geometries, one within the other
     */
    public static final Tests WITHIN_TESTS = new Tests(nameOf(WITHIN), new Pass(true, 0, 1));
    ...
    protected static final Object[] POINTS =
            new Point[] {
                create(Point.class, "POINT (30 30)"), create(Point.class, "POINT (40 40)")
            };

    protected static final Object[] LINESTRINGS =
            new LineString[] {create(LineString.class, "LINESTRING (20 20, 40 20)")};

    protected static final Object[] POLYGONS =
            new Polygon[] {
                //
    ...
    protected static final EAttribute eAttribute =
            EFeatureTestsPackage.eINSTANCE.getEFeatureData_Geometry();
