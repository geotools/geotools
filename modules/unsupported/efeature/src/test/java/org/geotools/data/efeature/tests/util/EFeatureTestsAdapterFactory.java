...
public class EFeatureTestsAdapterFactory extends AdapterFactoryImpl {
     ...
     * is an instance object of the model.
     * <!-- end-user-doc -->
     *
    ...
    protected EFeatureTestsSwitch<Adapter> modelSwitch =
            new EFeatureTestsSwitch<Adapter>() {
                ...
                @Override
                public <A, G extends Geometry> Adapter caseEFeatureCompatibleData(
                        EFeatureCompatibleData<A, G> object) {
     ...
     * org.geotools.data.efeature.tests.EFeatureData <em>EFeature Data</em>}'.
     * <!-- begin-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link
     * org.geotools.data.efeature.tests.NonGeoEObject <em>Non Geo EObject</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases; it's useful to
     * ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.geotools.data.efeature.EFeature
     * <em>EFeature</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases; it's useful to
     * ignore a case when inheritance will catch all the cases anyway.
