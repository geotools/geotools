...
public class GeohashUtilTest {
    ...
    public void testComputePrecision() {
        ...
        assertEquals(
                6, GeohashUtil.computePrecision(new ReferencedEnvelope(-180, 180, -90, 90, null), (long) 1e9, 0.9));
    ...
    public void updatePrecisionLower() {
        final Map<String, Object> geohashGridAgg = new HashMap<>(ImmutableMap.of("field", "name", "precision", 4));
        ...
        final Map<String, Object> expected = ImmutableMap.of(
                "first", ImmutableMap.of("geohash_grid", ImmutableMap.of("field", "name", "precision", 2)));
    ...
    public void updatePrecisionHigher() {
        final Map<String, Object> geohashGridAgg = new HashMap<>(ImmutableMap.of("field", "name", "precision", 1));
        final Map<String, Map<String, Map<String, Object>>> aggregations =
                ImmutableMap.of("first", ImmutableMap.of("geohash_grid", geohashGridAgg));
        final Map<String, Object> expected = ImmutableMap.of(
                "first", ImmutableMap.of("geohash_grid", ImmutableMap.of("field", "name", "precision", 1)));
        GeohashUtil.updateGridAggregationPrecision(aggregations, 2);
        assertEquals(expected, aggregations);
    }
}
