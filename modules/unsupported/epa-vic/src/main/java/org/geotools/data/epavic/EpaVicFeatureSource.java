...
public class EpaVicFeatureSource extends ContentFeatureSource {
    ...
    public EpaVicFeatureSource(ContentEntry entry, Query query) throws IOException {
        super(entry, query);
    ...
    public static SimpleFeatureType buildType(URL ns) throws URISyntaxException, FactoryException {
