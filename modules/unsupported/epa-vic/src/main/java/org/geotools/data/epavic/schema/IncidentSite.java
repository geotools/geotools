...
public class IncidentSite {
  ...
  @Override
  public int hashCode() {
    return new HashCodeBuilder().append(eMVUrl).append(incidentIcon).append(additionalProperties).toHashCode();
  }
  ...
  public boolean equals(Object other) {
    ...
    return new EqualsBuilder().append(eMVUrl, rhs.eMVUrl).append(incidentIcon, rhs.incidentIcon)
