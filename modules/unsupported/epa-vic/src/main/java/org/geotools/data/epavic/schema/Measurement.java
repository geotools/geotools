...
public class Measurement {
    ...
    @JsonUnwrapped private AQICategoryThreshold aQICategoryThreshold = new AQICategoryThreshold();
    ...
    public int hashCode() {
        return new HashCodeBuilder()
                .append(aQICategoryThreshold.getaQIBackgroundColour())
                .append(aQICategoryThreshold.getaQICategoryAbbreviation())
                .append(aQICategoryThreshold.getaQICategoryDescription())
                .append(aQICategoryThreshold.getaQIForegroundColour())
                .append(aQIIndex)
                .append(dateTimeRecorded)
                ...
                .append(monitorId)
                .append(monitorName)
                .append(monitorShortName)
                .append(monitorTimeBasis)
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder()
                .append(
                        aQICategoryThreshold.getaQIBackgroundColour(),
                        rhs.aQICategoryThreshold.getaQIBackgroundColour())
                .append(
                        aQICategoryThreshold.getaQICategoryAbbreviation(),
                        rhs.aQICategoryThreshold.getaQICategoryAbbreviation())
                .append(
                        aQICategoryThreshold.getaQICategoryDescription(),
                        rhs.aQICategoryThreshold.getaQICategoryDescription())
                .append(
                        aQICategoryThreshold.getaQIForegroundColour(),
                        rhs.aQICategoryThreshold.getaQIForegroundColour())
                .append(aQIIndex, rhs.aQIIndex)
                .append(dateTimeRecorded, rhs.dateTimeRecorded)
                .append(dateTimeStart, rhs.dateTimeStart)
                .append(equipmentType, rhs.equipmentType)
                .append(
                        healthCategoryThreshold.getHealthCategoryBackgroundColour(),
                        rhs.healthCategoryThreshold.getHealthCategoryBackgroundColour())
                .append(
                        healthCategoryThreshold.getHealthCategoryDescription(),
                        rhs.healthCategoryThreshold.getHealthCategoryDescription())
                .append(
                        healthCategoryThreshold.getHealthCategoryForegroundColour(),
                        rhs.healthCategoryThreshold.getHealthCategoryForegroundColour())
                .append(
                        healthCategoryThreshold.getHealthCategoryLevel(),
                        rhs.healthCategoryThreshold.getHealthCategoryLevel())
                .append(
                        healthCategoryThreshold.getHealthCategoryMessage(),
                        rhs.healthCategoryThreshold.getHealthCategoryMessage())
                .append(
                        healthCategoryThreshold.getHealthCategoryValueRangeText(),
                        rhs.healthCategoryThreshold.getHealthCategoryValueRangeText())
                .append(
                        healthCategoryThreshold.getHealthCategoryVisibilityText(),
                ...
                .append(monitorId, rhs.monitorId)
                .append(monitorName, rhs.monitorName)
                .append(monitorShortName, rhs.monitorShortName)
                .append(monitorTimeBasis, rhs.monitorTimeBasis)
