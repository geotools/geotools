...
public enum MeasurementFields {
    ...
    HEALTH_CATEGORY_VISIBILITY_TEXT(
            HealthCategoryThreshold.HEALTH_CATEGORY_VISIBILITY_TEXT, String.class),
    HEALTH_CATEGORY_VALUE_RANGE_TEXT(
            HealthCategoryThreshold.HEALTH_CATEGORY_VALUE_RANGE_TEXT, String.class),
    ...
    HEALTH_CATEGORY_FOREGROUND_COLOUR(
            HealthCategoryThreshold.HEALTH_CATEGORY_FOREGROUND_COLOUR, String.class),
    HEALTH_CATEGORY_DESCRIPTION(HealthCategoryThreshold.HEALTH_CATEGORY_DESCRIPTION, String.class),
    HEALTH_CATEGORY_BACKGROUND_COLOUR(
            HealthCategoryThreshold.HEALTH_CATEGORY_BACKGROUND_COLOUR, String.class),
