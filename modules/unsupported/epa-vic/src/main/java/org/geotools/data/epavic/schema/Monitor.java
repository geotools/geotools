...
@JsonPropertyOrder({
    Monitor.COMMON_NAME,
    Monitor.EPA_DESCRIPTION_URL,
    Monitor.EQUIPMENT_TYPE,
    Monitor.MONITOR_ID,
    Monitor.PRESENTATION_PRECISION,
    Monitor.SHORT_NAME,
    "SiteId",
    Monitor.UNIT_OF_MEASURE
})
public class Monitor {
    ...
    public int hashCode() {
        return new HashCodeBuilder()
                .append(commonName)
                .append(ePADescriptionURL)
                .append(equipmentType)
                .append(monitorId)
                .append(presentationPrecision)
                .append(shortName)
                .append(siteId)
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder()
                ...
                .append(ePADescriptionURL, rhs.ePADescriptionURL)
                .append(equipmentType, rhs.equipmentType)
                .append(monitorId, rhs.monitorId)
                .append(presentationPrecision, rhs.presentationPrecision)
                .append(shortName, rhs.shortName)
                .append(siteId, rhs.siteId)
                .append(unitOfMeasure, rhs.unitOfMeasure)
