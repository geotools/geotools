...
public class MonitorTimeBasis {
    ...
    public int hashCode() {
        return new HashCodeBuilder()
                .append(aQIPollutantStandard)
                .append(calcAQI)
                .append(calcHealthCategory)
                .append(incidentType)
                .append(monitorId)
                .append(presentationOrder)
                .append(timeBasisId)
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder()
                .append(aQIPollutantStandard, rhs.aQIPollutantStandard)
                .append(calcAQI, rhs.calcAQI)
                .append(calcHealthCategory, rhs.calcHealthCategory)
                .append(incidentType, rhs.incidentType)
                .append(monitorId, rhs.monitorId)
                .append(presentationOrder, rhs.presentationOrder)
