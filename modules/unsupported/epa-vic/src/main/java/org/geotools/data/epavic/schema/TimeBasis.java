...
public class TimeBasis {
    ...
    public int hashCode() {
        return new HashCodeBuilder()
                .append(description)
                .append(isRollingAverage)
                .append(minDataPercent)
                .append(monitorId)
                .append(monitorName)
                .append(monitorShortName)
                .append(monitorTimeBasis)
                .append(rollingAveragePeriod)
                .append(siteId)
                .append(timeBaseId)
                .append(timeBasisDescURL)
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder()
                ...
                .append(isRollingAverage, rhs.isRollingAverage)
                .append(minDataPercent, rhs.minDataPercent)
                ...
                .append(rollingAveragePeriod, rhs.rollingAveragePeriod)
                .append(siteId, rhs.siteId)
                .append(timeBaseId, rhs.timeBaseId)
                .append(timeBasisDescURL, rhs.timeBasisDescURL)
