...
public class Aqi {
    ...
    private List<Object> sampleData24Hr = new ArrayList<Object>();
    ...
    @JsonProperty("SampleData24Hr")
    public List<Object> getSampleData24Hr() {
        return sampleData24Hr;
    }

    @JsonProperty("SampleData24Hr")
    public void setSampleData24Hr(List<Object> sampleData24Hr) {
    ...
    public int hashCode() {
        return new HashCodeBuilder()
                .append(aqiIndex)
                .append(healthCategoryLevel)
                .append(id)
                .append(idString)
                .append(pIndexValue)
                .append(pValue)
                .append(sampleData1Hr)
                .append(sampleData24Hr)
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Aqi) == false) {
            return false;
        }
        Aqi rhs = ((Aqi) other);
        return new EqualsBuilder()
                .append(aqiIndex, rhs.aqiIndex)
                .append(healthCategoryLevel, rhs.healthCategoryLevel)
                .append(id, rhs.id)
                .append(idString, rhs.idString)
                .append(pIndexValue, rhs.pIndexValue)
                .append(pValue, rhs.pValue)
                .append(sampleData1Hr, rhs.sampleData1Hr)
                .append(sampleData24Hr, rhs.sampleData24Hr)
                .append(serviceProvider, rhs.serviceProvider)
                .append(uOM, rhs.uOM)
