...
@JsonPropertyOrder({ "AQIValue", "Abbreviation", "BackgroundColour", "Description", "ForegroundColour", "HealthMessage",
    "Precision", "ShortName", "TimeBasisID", "Value" })
public class Measurement {
  ...
  @Override
  public int hashCode() {
    return new HashCodeBuilder().append(aQIValue).append(abbreviation).append(backgroundColour).append(description)
        .append(foregroundColour).append(healthMessage).append(precision).append(shortName).append(timeBasisID)
  ...
  public boolean equals(Object other) {
    ...
    return new EqualsBuilder().append(aQIValue, rhs.aQIValue).append(abbreviation, rhs.abbreviation)
        .append(backgroundColour, rhs.backgroundColour).append(description, rhs.description)
        .append(foregroundColour, rhs.foregroundColour).append(healthMessage, rhs.healthMessage)
        .append(precision, rhs.precision).append(shortName, rhs.shortName).append(timeBasisID, rhs.timeBasisID)
