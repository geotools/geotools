...
public class SitesHourlyAirQuality {
    ...
    public int hashCode() {
        return new HashCodeBuilder()
                .append(dateTime)
                .append(incidentMonitors)
                .append(incidentSites)
                .append(nonIncidentMonitors)
                .append(nonIncidentSites)
                .append(serviceName)
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder()
                ...
                .append(incidentMonitors, rhs.incidentMonitors)
                .append(incidentSites, rhs.incidentSites)
                .append(nonIncidentMonitors, rhs.nonIncidentMonitors)
                .append(nonIncidentSites, rhs.nonIncidentSites)
