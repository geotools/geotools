...
public class GeoJSONWriteTest {
	...
	public void transactionExample() throws Exception {
		...
		SimpleFeature feature = SimpleFeatureBuilder.build(type, new Object[] { 45.52, -122.681944, "Portland", 800, 2014 },
		    "locations-fid10");
	...
	public void replaceAll() throws Exception {
		...
		f = SimpleFeatureBuilder.build(type, new Object[] { 45.52, -122.681944, "Portland", 800, 2014, portland },
		    "locations.1");
		collection.add(f);
