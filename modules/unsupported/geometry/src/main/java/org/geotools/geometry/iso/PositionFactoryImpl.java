 ...
 *   <li>createPositionList( double, int, int) is a custom efficient implementation that does not
 *       support add
 *   <li>createPositionList( float, int, int ) will copy the array contents into individual
 *       DirectPositions.
 * </ul>
 *
 * @author Jody Garnett
...
public class PositionFactoryImpl implements Serializable, Factory, PositionFactory {
    ...
    /**
     * This is just here so FactorySPI can find us. We have set it up with a default (undocumented)
     ...
     * </ul>
     *
     * There is no default for these values - you must describe your data source for us if we are to
     * make useful Geometry object for you.
     *
    ...
    public DoublePointArray createPointArray(final double[] array, final int start, final int end) {
