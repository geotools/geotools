...
/**
 * A separate class for composite point, CompositePoint (Figure 27) is included for completeness. It
...
public class CompositePointImpl extends CompositeImpl<PointImpl> implements CompositePoint {
    ...
    /**
     * The association role Composition::generator associates this Composite Point to the single
     * primitive in this complex. CompositePoint::generator [1] : Point
     *
