...
/**
 * A composite surface, CompositeSurface (Figure 29) shall be a Complex with all the geometric
 * properties of a surface, and thus can be considered as a type of orientable surface
 * (OrientableSurface). Essentially, a composite surface is a collection of oriented surfaces that
 * join in pairs on common boundary curves and which, when considered as a whole, form a single
 * surface.
 *
...
public class CompositeSurfaceImpl extends CompositeImpl<OrientableSurfaceImpl>
    ...
    /**
     * Generator The association role Composition::generator associates this CompositeSurface to the
     * primitive Surfaces and OrientableSurfaces in its generating set, a list of the Surfaces that
     * form the core of this complex. CompositeSurface::generator : Set<OrientableSurface>
     *
    ...
    public SurfaceBoundary getBoundary() {
        ...
        // The result must be a Complex again, could it be a CompositeCurve which contains all
        // (exterior and interior)Rings of the SurfaceBoundaries of the Surfaces which are contained
        // by the CompositeSurface?
        return null;
    }
