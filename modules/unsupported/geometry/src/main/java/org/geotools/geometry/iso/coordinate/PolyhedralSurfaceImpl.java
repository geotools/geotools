...
/**
 * A PolyhedralSurface (Figure 21) is a Surface composed of polygon surfaces (Polygon) connected
 * along their common boundary curves. This differs from Surface only in the restriction on the
...
public class PolyhedralSurfaceImpl extends SurfaceImpl implements PolyhedralSurface {
    ...
    /**
     * The constructor for a PolyhedralSurface takes the facet Polygons and creates the necessary
     * aggregate surface.
     *
