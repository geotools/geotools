 ...
 *     <p>The data type Position is a union type consisting of either a DirectPosition2D or of a
 *     reference to a Point from which a DirectPosition2D is obtained. The use of this data type
 *     allows the identification of a position either directly as a coordinate (variant direct) or
...
public class PositionImpl implements Position, Serializable {
     ...
     *
     * @param directPosition an <code>DirectPosition2D</code> value
     */
     ...
     * Creates a new <code>Position</code> instance.
     *
     * @param pointRef an <code>PointRef</code> value
     */
    ...
    /**
     * Returns true, if the Position is representated as a PointReference. Returns false, if the
     * Position is representated as a DirectPoint.
     *
     ...
     *
     * @return the Point if the position is of type Point. If position is an instance of
     *     DirectPositionImpl, return a new Point if force is true and null is force is false
     */
    ...
    public int getCoordinateDimension() {
        return this.hasPoint()
                ? ((PointImpl) this.position).getCoordinateDimension()
