 ...
 * It will automatically expand to accomodate any extent of dataset.
 *
 * <p>This data structure is also known as an <i>MX-CIF quadtree</i> following the usage of Samet
 * and others.
 */
public class Quadtree implements SpatialIndex {
    ...
    /**
     * minExtent is the minimum envelope extent of all items inserted into the tree so far. It is
     * used as a heuristic value to construct non-zero envelopes for features with zero X and/or Y
     * extent. Start with a non-zero extent, in case the first feature inserted has a zero extent in
     * both directions. This value may be non-optimal, but only one feature will be inserted with
     * this value.
     */
