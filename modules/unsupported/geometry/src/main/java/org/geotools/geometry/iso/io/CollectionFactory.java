...
/**
 * A CollectionFactory creates lists of different GM_Objects or Coordinates. The original objective
 * of this encapsulating is the possibility of persistence support, that is that the returned lists
