 ...
 *
 * <UL>
 *   <LI>A Geometry is simple iff the only self-intersections are at boundary points.
 * </UL>
 *
 * Simplicity is defined for each {@link Geometry} subclass as follows:
 *
 * <ul>
 *   <li>Valid polygonal geometries are simple by definition, so <code>isSimple</code> trivially
 *       returns true.
 *   <li>Linear geometries are simple iff they do not self-intersect at points other than boundary
 *       points.
