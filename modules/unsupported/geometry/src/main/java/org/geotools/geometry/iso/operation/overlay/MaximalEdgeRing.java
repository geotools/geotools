...
/**
 * A ring of {@link org.geotools.geometry.iso.topograph2D.Edge}s which may contain nodes of degree >
 * 2. A MaximalEdgeRing may represent two different spatial entities:
 *
 * <ul>
...
public class MaximalEdgeRing extends EdgeRing {
    ...
    public MaximalEdgeRing(DirectedEdge start, CoordinateReferenceSystem crs, CGAlgorithms cga) {
        super(start, crs, cga);
    }
