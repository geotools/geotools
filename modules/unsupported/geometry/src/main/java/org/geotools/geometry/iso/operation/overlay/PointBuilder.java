...
public class PointBuilder {
     ...
     *
     * <p>A node is covered if it is contained in another element Geometry with higher dimension
     * (e.g. a node point might be contained in a polygon, in which case the point can be eliminated
     * from the result).
     *
