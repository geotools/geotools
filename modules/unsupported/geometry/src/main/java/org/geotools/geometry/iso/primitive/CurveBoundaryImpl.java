...
public class CurveBoundaryImpl extends PrimitiveBoundaryImpl implements CurveBoundary {
     ...
     *
     * <p>CurveBoundary::startPoint : Reference<Point>; CurveBoundary::endPoint : Reference<Point>;
     */
    ...
    public CurveBoundaryImpl(CoordinateReferenceSystem crs, Point start, Point end) {
        ...
        if (start.equals(end))
            throw new IllegalArgumentException(
                    "Start- and Endpoint of the CurveBoundary cannot be equal");
    ...
    public String toString() {
        return "[CurveBoundary: StartPoint: "
                + this.startPoint
    ...
    public int getDimension(final DirectPosition point) {
        ...
        // The dimension of a CurveBoundary is the dimension of two Points. So we return the
        // dimension value 0.
        return 0;
    }
    ...
    public EnvelopeImpl getEnvelope() {
        ...
        // EnvelopeImpl tmpEnv = new EnvelopeImpl(this.startPoint.getDirectPosition(),
        // this.startPoint.getDirectPosition());
    ...
    public boolean equals(Object obj) {
        ...
        if (startPoint == null) {
            if (other.startPoint != null) return false;
        } else if (!startPoint.equals(other.startPoint)) return false;
        return true;
    }
}
