...
public class PointImpl extends PrimitiveImpl implements Point {
     ...
     *
     * <p>Point::position : DirectPosition
     *
     * <p>Point is the only subclass of Primitive that cannot use Positions to represent its
     * defining geometry. A Position is either a DirectPostion or a reference to a Point (from which
     * a DirectPosition2D may be obtained).
     *
     * <p>By not allowing Point to use this technique, infinitely recursive references are
     * prevented. Applications may choose another mechanism to prevent this logical problem.
     *
     * <p>NOTE In most cases, the state of a Point is fully determined by its position attribute.
     * The only exception to this is if the Point has been subclassed to provide additional
     * non-geometric information such as symbology.
     */
    ...
    public PointImpl clone() throws CloneNotSupportedException {
        ...
        // return
        // this.getGeometryFactory().getPrimitiveFactory().createPoint(this.getPosition().getCoordinates());
    }
    ...
    /**
     * The operation "bearing" returns the bearing, as a unit vector, of the tangent (at this Point)
     * to the curve between this Point and a passed Position.
     *
     * <p>Point::bearing(toPoint : Position) : Bearing
     *
     * <p>The choice of the curve type for defining the bearing is dependent on the SC_CRS in which
     * this Point is defined. For example, in the Mercator projection, the curve is the rhumb line.
     * In 3D, geocentric coordinate system, the curve may be the geodesic joining the two points
     * along the surface of the geoid or ellipsoid in use. Implementations that support this
     * function shall specify the nature of the curve to be used.
     *
    ...
    /**
     * The method <code>getDimension</code> returns the inherent dimension of this Object, which is
     ...
     *
     * @param point a <code>DirectPosition</code> value
    ...
    /**
     * The method <code>getEnvelope</code> returns the minimum bounding box for this Object. There
     * are cases for which the min and max positions would be outside the domain of validity of the
     * object's coordinate reference system. This method is included here only as an interface, as
    ...
    public Envelope getEnvelope() {
        ...
        // return
        // this.getGeometryFactory().getGeometryFactoryImpl().createEnvelope(this.position.getCoordinates());
    }

    /**
     * The operation "getBoundary" is a specialization of the boundary operation at Object, and
     * returns a NULL value indication an empty set.
     *
     * <p>Point::boundary() : NULL
     *
     * @return null
     */
    ...
    public boolean equals(TransfiniteSet pointSet) {
        ...
        // In that way, we do not need to build a topological graph to compare this trivial
        // coordinates
    ...
    public Geometry transform(CoordinateReferenceSystem newCRS, MathTransform transform)
        ...
        PositionFactory newPositionFactory =
