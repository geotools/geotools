...
/**
 * PrimitiveBoundary The abstract class Primitive boundary is the root for the various return types
 * of the boundary operator for subtypes of Primitive. Since points have no boundary, no special
