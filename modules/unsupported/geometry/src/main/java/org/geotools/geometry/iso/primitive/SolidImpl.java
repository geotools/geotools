...
/**
 * Solid , a subclass of Primitive, is the basis for 3-dimensional geometry. The globelExtent of a
...
public class SolidImpl extends PrimitiveImpl implements Solid {
    ...
    /**
     * The operation "area" shall return the sum of the surface areas of all of the boundary
     * components of a solid.
     *
     * <p>Solid::area() : Area
     *
     * <p>The class Set<Surface> has a "column operation" called "area" that accumulates the area of
     * the components of the set. Using this, it can be said that for a Solid; Solid: area() =
     * boundary().area()
     *
     * @return Area
     */
    ...
    /**
     * The operation "volume" shall return the volume of this Solid. This is the volume interior to
     * the exterior boundary shell minus the sum of the volumes interior to any interior boundary
     * shell.
     *
     ...
     * bound a solid shall be oriented outward  that is, the "top" of each Surface as defined by
