...
/**
 * GeometryImpl is the root class of the geometric object taxonomy and supports methods common to
 * all geographically referenced geometric objects. GeometryImpl instances are sets of direct
 * positions in a particular coordinate reference system. A GeometryImpl can be regarded as an
 * infinite set of points that satisfies the set operation interfaces for a set of direct positions,
 * TransfiniteSet&lt;DirectPosition&gt;. Since an infinite collection class cannot be implemented
 * directly, a boolean test for inclusion is provided by this class.
 *
...
public abstract class GeometryImpl implements Geometry, Serializable {
    ...
    public Geometry transform(CoordinateReferenceSystem newCRS, MathTransform transform)
        ...
        throw new UnsupportedOperationException(
                "Transform not implemented for this geometry type yet.");
    }
    ...
    public boolean contains(DirectPosition position) {
        ...
        if (!((EnvelopeImpl) this.getEnvelope()).intersects(position)) return false;
    ...
    /**
     * This operator tests, whether an object overlaps with this object. That is that a part of the
     * object lies within this object and another part lies without this object, e.g. the other
     * object intersects with the interior, boundary and exterior of this object
     *
     * @param pointSet The other object
    ...
    public Complex getClosure() {
        if (this instanceof ComplexImpl) {
            ...
            // CompositePoint, CompositeCurve, CompositeSurface, Ring, CurveBoundary,
            // SurfaceBoundary
            return (Complex) this;
        } else if (this instanceof CurveImpl) {
            ...
            Assert.isTrue(
                    false, "The closure operation is not implemented for this geometry object");
        return null;
    }
    ...
    /**
     * Use this function to cast Geometry instances to a GeometryImpl instance. In that way we can
     * control the illegal injection of other instances at a central point.
     *
