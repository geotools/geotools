...
public class Edge extends GraphComponent {
    ...
    public static void updateIM(Label label, IntersectionMatrix im) {
        im.setAtLeastIfValid(
                label.getLocation(0, Position.ON), label.getLocation(1, Position.ON), 1);
        if (label.isArea()) {
            im.setAtLeastIfValid(
    ...
    /**
     * An Edge is collapsed if it is an Area edge and it consists of two segments which are equal
     ...
     *
     * <p>e1 equals e2 <b>iff</b> the coordinates of e1 are the same or the reverse of the
     * coordinates in e2
     */
