...
public class EdgeList {
     ...
     *
     * <p>a Quadtree is used, because this index needs to be dynamic (e.g. allow insertions after
     * queries). An alternative would be to use an ordered set based on the values of the edge
     * coordinates
     */
