...
public abstract class GraphComponent {
    ...
    /**
     * An isolated component is one that does not intersect or touch any other component. This is
     * the case if the label has valid locations for only a single Geometry.
     *
