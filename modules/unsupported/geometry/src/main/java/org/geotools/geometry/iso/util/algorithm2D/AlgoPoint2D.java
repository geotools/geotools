...
public class AlgoPoint2D {
    ...
    public static Point2D normalize(Point2D p0) {
        ...
        return (len > 0.0) ? AlgoPoint2D.scale(p0, 1.0 / len) : new Point2D.Double(0.0, 0.0);
    }

    public static Point2D evaluate(Point2D p0, Point2D p1, double r) {
        return new Point2D.Double(
                (1.0 - r) * p0.getX() + r * p1.getX(), (1.0 - r) * p0.getY() + r * p1.getY());
    }

    public static Point2D evaluate(Point2D p0, Point2D p1, Point2D eval) {
        return new Point2D.Double(
                (1.0 - eval.getX()) * p0.getX() + eval.getX() * p1.getX(),
                (1.0 - eval.getY()) * p0.getY() + eval.getY() * p1.getY());
    }
    ...
    public static double getAngle2D(Point2D p0, Point2D p1) {
        ...
        //         *------>*
        //       (0,0)    p0
        double angle = Math.atan2(p1.getY(), p1.getX()) - Math.atan2(p0.getY(), p0.getX());
    ...
    public static double minAngle2D(Point2D p, Point2D p1, Point2D p2) {
        double ang0 =
                AlgoPoint2D.getAngle2D(AlgoPoint2D.subtract(p1, p), AlgoPoint2D.subtract(p2, p));
        double ang1 =
                AlgoPoint2D.getAngle2D(AlgoPoint2D.subtract(p2, p1), AlgoPoint2D.subtract(p, p1));
        return Math.min(Math.min(ang0, ang1), Math.min(ang0, Math.PI - ang0 - ang1));
    }
