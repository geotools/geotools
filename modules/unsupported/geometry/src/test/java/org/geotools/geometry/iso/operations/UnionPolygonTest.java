...
public class UnionPolygonTest extends TestCase {
    ...
    public void testMain() {
        ...
        String wktExpectedResult =
                "POLYGON((110 0, 0 0, 0 260, 110 260, 220 260, 220 0, 110 0), (110 260, 40 220, 110 180, 180 220, 110 260), (110 100, 40 60, 110 60, 180 60, 110 100))";
