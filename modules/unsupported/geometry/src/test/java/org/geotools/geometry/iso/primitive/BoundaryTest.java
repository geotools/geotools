...
public class BoundaryTest extends TestCase {
    ...
    private void _testSurfaceBoundary1(GeometryBuilder builder) {
        ...
        SurfaceBoundary surfaceBoundary1 =
                tPrimFactory.createSurfaceBoundary(exteriorring1, interiors);
        ...
        if (surfaceBoundary1.getInteriors().size() > 0) {
            assertTrue(
                    surfaceBoundary1.getInteriors().get(0)
                            != surfaceBoundary2.getInteriors().get(0));
        }
