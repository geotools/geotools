...
public class PicoSurfaceTest extends TestCase {
    ...
    private List<Triangle> _testTriangle1(
    ...
    public void _testOhterSurfaceMethods(
        ...
        // test obj equals
        assertTrue(
                surfaceBoundary1.equals(
                        (Object) tPrimFactory.createSurfaceBoundary(exteriorRing, interiors)));
        ...
        // Following is commented-out because we are supposed to have a TriangulatedSurface, not
        // plain Surface.
        // This Surface is built above in this test case, so its seems to be something to fix in the
        // test suite.
