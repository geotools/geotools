...
class GeoParquetDataStoreFactoryDelegate extends AbstractDuckDBDataStoreFactory implements DataStoreFactorySpi {
    ...
    static final String DEFAULT_PRIMARY_KEY_ID = "id";
    ...
    protected JDBCDataStore setupDataStore(JDBCDataStore dataStore, Map<String, ?> params) throws IOException {
        ...
        if ((pkId = (String) PRIMARY_KEY_ID.lookUp(params)) != null) {
            ...
            finder = new PrimaryKeyFinder() {
                ...
                public PrimaryKey getPrimaryKey(JDBCDataStore store, String schema, String table, Connection cx)
                        throws SQLException {
                    if (!hasColumn(store, schema, table, cx, DEFAULT_PRIMARY_KEY_ID)) {
                        return null;
                    }
                    List<PrimaryKeyColumn> columns =
                            List.of(new AutoGeneratedPrimaryKeyColumn(DEFAULT_PRIMARY_KEY_ID, String.class));
                    return new PrimaryKey(table, columns);
                }
            };
        }
    ...
    private boolean hasColumn(JDBCDataStore store, String schema, String table, Connection cx, String columnName)
            throws SQLException {
