 ...
 * 
 *
 * @source $URL: http://svn.osgeo.org/geotools/trunk/modules/plugin/jdbc/jdbc-GeoPkg/src/test/java/org/geotools/data/GeoPkg/GeoPkgBooleanTestSetup.java $
 */
public class GeoPkgEmptyGeometryTestSetup extends JDBCEmptyGeometryTestSetup {
    ...
    protected void createEmptyGeometryTable() throws Exception {
        ...
        run("CREATE TABLE \"empty_"+type.toLowerCase()+"\"(" //
