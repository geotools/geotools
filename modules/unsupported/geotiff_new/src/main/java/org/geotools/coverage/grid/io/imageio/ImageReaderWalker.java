...
/** @source $URL$ */
public abstract class ImageReaderWalker extends AbstractList<RasterManager>
        implements List<RasterManager> {
    ...
    public ImageReaderWalker(
            Map<String, Serializable> sourceParams,
            Hints hints,
            ImageInputStreamSpi inStreamSPI,
