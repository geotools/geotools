...
/**
 * This enum can be used to distinguish between different read methods, namely, JAI ImageRead based
...
enum ReadType {
        ...
        RenderedImage read(
            ...
            try {
                ...
                if (LOGGER.isLoggable(Level.WARNING)) {
                    LOGGER.log(
                            Level.WARNING,
                            "Unable to compute sourceFile area for file "
    ...
    /**
     * Load the raster data from the underlying sourceFile with the specified read type.
     *
