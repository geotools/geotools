...
public class XmlStreamGeometryReaderParameterizedTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            ...
            {"linestring.gml", LineString.class, "LINESTRING (-1.28 -0.11, -0.63 0.38, -0.22 0.09, -0.45 -0.36)", false
            },
            {
                "curve.gml",
                CompoundCurve.class,
            ...
            {"multipoint.gml", MultiPoint.class, "MULTIPOINT ((-23 11), (-24 9), (-22 9), (-24 8))", false},
            {"multipoint2.gml", MultiPoint.class, "MULTIPOINT ((-23 11), (-24 9))", false},
            {"multilinestring.gml", MultiLineString.class, "MULTILINESTRING ((-27 -5, -11 -5), (-20 1, -19 -12))", false
            },
            {
                "multipolygon.gml",
                MultiPolygon.class,
    ...
    public XmlStreamGeometryReaderParameterizedTest(
            String gmlResource, Class expectedGeometryClass, String expectedWKT, boolean compareXSD) {
    ...
    public void test() throws Exception {
        ...
        try (InputStream gmlBytes =
                getClass().getClassLoader().getResourceAsStream("org/geotools/gml/stream/" + gmlResource)) {

            gml = new BufferedReader(new InputStreamReader(gmlBytes, StandardCharsets.UTF_8))
                    .lines()
         ...
         */
        String gml3_2 = gml.replaceAll(Pattern.quote("http://www.opengis.net/gml"), "http://www.opengis.net/gml/3.2");
