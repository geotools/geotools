...
public class ImageCollectionReaderTest extends Assert {
    ...
    public void testReader()
        ...
        final ParameterValue<double[]> background =
                ImageCollectionFormat.BACKGROUND_VALUES.createValue();
    ...
    public void testForbiddenPath()
        ...
        final String string =
                "PATH='" + absolutePath + "/folder1/../../forbiddenFolder/classifiedFile.tif'";
        Filter filter = CQL.toFilter(string);
