...
public final class H2GISNativeFilterTestSetup extends JDBCNativeFilterTestSetup {

    public H2GISNativeFilterTestSetup(JDBCTestSetup delegate) {
        super(delegate);
    }
    ...
    protected void createMeasurementsTable() throws Exception {
        ...
        run("Create Spatial Index spIdx ON \"geotools\".\"gt_jdbc_test_measurements\"(\"location\");");
    }
