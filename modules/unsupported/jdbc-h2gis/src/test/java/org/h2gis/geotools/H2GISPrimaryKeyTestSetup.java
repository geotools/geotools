...
public class H2GISPrimaryKeyTestSetup extends JDBCPrimaryKeyTestSetup {

    protected H2GISPrimaryKeyTestSetup() {
    ...
    protected void createAutoGeneratedPrimaryKeyTable() throws Exception {
        ...
        run("INSERT INTO \"auto\" (\"name\",\"geom\" ) VALUES ('three',ST_GeomFromText('POINT(0 0)',4326))");
    }

    @Override
    protected void createUniqueIndexTable() throws Exception {
        run("CREATE TABLE \"uniq\" ( \"key\" int, " + "\"name\" VARCHAR, \"geom\" GEOMETRY(GEOMETRY, 4326))");
        ...
        run("INSERT INTO \"uniq\" VALUES (3, 'three',ST_GeomFromText('POINT(0 0)',4326))");
    }
    ...
    protected void createSequencedPrimaryKeyTable() throws Exception {
        ...
        run("INSERT INTO \"seq\" (\"key\", \"name\",\"geom\" ) VALUES ("
                + "(SELECT NEXTVAL('SEQ_KEY_SEQUENCE')),'three',ST_GeomFromText('POINT(0 0)',4326))");
    }
    ...
    protected void createNonIncrementingPrimaryKeyTable() throws Exception {
        ...
        run("INSERT INTO \"noninc\" VALUES (3, 'three', ST_GeomFromText('POINT(0 0)',4326))");
    }
    ...
    protected void createMultiColumnPrimaryKeyTable() throws Exception {
        ...
        run("INSERT INTO \"multi\" VALUES (3, 'z', 'three', ST_GeomFromText('POINT(0 0)',4326))");
    }
    ...
    protected void createNonFirstColumnPrimaryKey() throws Exception {
        run(
                "CREATE TABLE \"nonfirst\" (\"name\" VARCHAR, \"key\" int AUTO_INCREMENT(1) PRIMARY KEY, \"geom\" GEOMETRY(GEOMETRY, 4326))");

        run("INSERT INTO \"nonfirst\" (\"name\",\"geom\" ) VALUES ('one',NULL)");
        run("INSERT INTO \"nonfirst\" (\"name\",\"geom\" ) VALUES ('two',NULL)");
        run("INSERT INTO \"nonfirst\" (\"name\",\"geom\" ) VALUES ('three',ST_GeomFromText('POINT(0 0)',4326))");
    }
