...
public class SingleStorePrimaryKeyFinderTestSetup extends JDBCPrimaryKeyFinderTestSetup {

    public SingleStorePrimaryKeyFinderTestSetup() {
    ...
    protected void createPlainTable() throws Exception {
        run("CREATE ROWSTORE TABLE plaintable (key1 int, key2 int, name varchar(255), geom GEOGRAPHY)");
    ...
    protected void createSequencedPrimaryKeyTable() throws Exception {
        // SingleStore does not have sequences
    }
