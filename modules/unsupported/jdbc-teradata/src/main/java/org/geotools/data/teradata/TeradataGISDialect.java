...
public class TeradataGISDialect extends BasicSQLDialect {
    ...
    public Object getLastAutoGeneratedValue(String schemaName, String tableName, String columnName,
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                createIndex(schemaName, tableName, id, stmt, cx);
                return id;
            } else {
    ...
    protected String getPrimaryKeyName(String schemaName, String tableName,
            Connection cx) throws SQLException {
        try {
    ...
    protected void createIndex(String schemaName, String tableName, int id, Statement stmt,
            Connection cx) throws SQLException {
        if (tableName == null) {
            return;
        }
