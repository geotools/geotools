 ...
 * This class put no restriction on the axis order, i.e. it doesn't ensure that the value stored in
 * the {@linkplain #x x} field increases toward {@linkplain AxisDirection#EAST East} and the value
 * in the {@linkplain #y y} field toward {@linkplain AxisDirection#NORTH North}. The rational is
 * that other {@link DirectPosition} implementation do not have restriction on axis order, and
...
public class DirectPosition2D extends Point2D.Double implements DirectPosition, Serializable {
    ...
    /**
     * Construct a position initialized to (0,0) with a {@code null} coordinate reference system.
     */
    ...
    /**
     * Returns a string representation of this coordinate. The returned string is implementation
    ...
    static String toString(final Object owner, final double[] ordinates) {
        final StringBuffer buffer =
                new StringBuffer(
                        owner.toString()); // new StringBuffer(Utilities.getShortClassName(owner));
        buffer.append('[');
