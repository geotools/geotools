 ...
 * common boundary curves and which, when considered as a whole, form a single surface. @UML type
 * GM_CompositeSurface
 *
 ...
 *     Concequently, there is a clash in the semantics of some set theoretic operation.
 *     Specifically, {@code Primitive.contains(...)} (returns FALSE for end points) is different
 *     from {@code Complex.contains(...)} (returns TRUE for end points).
 */
public class CompositeSurfaceImpl extends CompositeImpl
        implements CompositeSurface { // , OrientableSurface {
     ...
     *
     * <p>To get a full representation of the elements in the {@linkplain Complex complex}, the
     * {@linkplain org.opengis.geometry.primitive.Curve curves} and {@link
     ...
     * the generator list.
     *
     * @return The list of orientable surfaces in this composite. @UML association generator
     */
     ...
     * <blockquote>
     *
     * <font size=2> <strong>NOTE:</strong> The concept of exterior boundary for a surface is really
     ...
     * valid definition of exterior that covers all cases. </font>
     *
     * </blockquote>
     *
     * @return The sets of positions on the boundary. @UML operation boundary
     */
     ...
     *
     * @return The owner of this orientable surface, or {@code null} if none. @UML association
     *     composite
     * @revisit I'm not sure to interpret correctly the ISO specification. Sound like ISO returns an
     *     array (or a sequence) here.
     */
     ...
     *
     * @return +1 for a positive orientation, or -1 for a negative orientation. @UML operation
     *     orientation
     * @revisit The UML specify a {@code Sign} return type. Should we create a {@code Sign} class?
     */
    ...
    /**
     * Returns the primitive associated with this {@code OrientablePrimitive}. Each {@linkplain
     * Primitive primitive} of dimension 1 or 2 is associated to two {@code OrientablePrimitive}s,
     * one for each possible orientation. For curves and surfaces, there are exactly two orientable
     * primitives for each geometric object.
     *
     * @return The primitive, never {@code null}. @UML association primitive
     ...
     * applications to override the {@link org.opengis.geometry.coordinate.TransfiniteSet
     ...
     *
     * @return The set of primitives contained into this primitive. @UML association
     *     containedPrimitive
     * @revisit Using a {@link Set} returns type allows the user to add or remove element in this
     *     set at his convenience. Is it the right interpretation of this specification?
     ...
     *
     * @return The set of primitives which contains this primitive. @UML association
     *     containingPrimitive
     * @revisit Using a {@link Set} returns type allows the user to add or remove element in this
     *     set at his convenience. Is it the right interpretation of this specification?
     *     <p>Should we stretch out some relation with contained primitive? For example should we
     ...
     *
     * @return The set of complexex which contains this primitive. @UML association complex
     * @revisit Does it means that {@code Primitive} can't be immutable, since adding this primitive
     *     to a complex will change this set?
     */
