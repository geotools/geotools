 ...
 * signatures. @UML type GM_GenericSurface
 *
 ...
 *     org.opengis.geometry.primitive.SurfacePatch}) belong to that package?
 */
public abstract class GenericSurfaceImpl implements GenericSurface {
     ...
     * @return The upNormal unit vector. @UML operation upNormal
     */
     ...
     * @unitof Length @UML operation perimeter
     */
