...
public abstract class OGRDataStoreFactory implements DataStoreFactorySpi {
     ...
     *
     * @return String a human readable description of the type of restore supported by this datastore.
     */
    @Override
     ...
     * @task REVISIT: I'm just adding this method to compile, maintainer should revisit to check for any libraries that
     *     may be necessary for datastore creations.
     */
    @Override
     ...
     *
     * <p>Specifying true for <tt>handleError</tt> will cause any exceptions to be caught and logged, and return false
     */
