...
public class PolyLabellerTest extends TestCase {
	...
	public void testDoubleDiamond() throws ParseException {
		...
		// This is also a valid result, but the algorithm at this point prefers the first.
	...
	/*
	 * @Ignore @Test //awaiting valid data set public void testGetPolylabel()
	 * throws FileNotFoundException, IOException { File water1 =
	 * TestData.file(this, "water1.json");
	 * 
	 * Polygon p = fetchPoly(water1); Coordinate expected = new
	 * Coordinate(3865.85009765625, 2124.87841796875); Coordinate c =
	 * PolyLabeller.getPolylabel(p, 1); double delta = 0.0001;
	 * assertEquals(expected.x, c.x, delta); assertEquals(expected.y, c.y, delta);
	 * 
	 * }
	 * 
	 * @Ignore @Test //awaiting valid data set public void
	 * testGetPolylabelPrecision() throws FileNotFoundException, IOException {
	 * File water1 = TestData.file(this, "water1.json");
	 * 
	 * Polygon p = fetchPoly(water1); Coordinate expected = new
	 * Coordinate(3854.296875, 2123.828125); Coordinate c =
	 * PolyLabeller.getPolylabel(p, 50); double delta = 0.0001;
	 * assertEquals(expected.x, c.x, delta); assertEquals(expected.y, c.y, delta);
	 * 
	 * }
	 * 
	 * @Ignore @Test //awaiting valid data set public void testGetPolylabel2()
	 * throws FileNotFoundException, IOException {
	 * 
	 * File water2 = TestData.file(this, "water2.json"); Polygon p =
	 * fetchPoly(water2); Coordinate expected = new Coordinate(3263.5, 3263.5);
	 * Coordinate c = PolyLabeller.getPolylabel(p, 1); double delta =
	 * 0.0001; assertEquals(expected.x, c.x, delta); assertEquals(expected.y, c.y,
	 * delta);
	 * 
	 * }
	 */
