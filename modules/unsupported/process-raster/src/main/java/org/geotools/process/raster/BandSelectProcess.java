 ...
 * </ul>
 *
 * The output of this process is a {@link GridCoverage2D} object containing only the {@link SampleDimension}s indicated
 * by the input array.
 *
...
public class BandSelectProcess implements RasterProcess {
    ...
    public GridCoverage2D execute(
            ...
            @DescribeParameter(name = "SampleDimensions", description = "Input sample dimension indexes", min = 1)
                    int[] sampleDims,
            @DescribeParameter(
