 ...
 * 
 */
@DescribeProcess(title = "Jiffle Script List", description = "Returns a raster algebra output from a Coverage and a list of Jiffle scripts.The Process executes the scripts on the input coverage bands.")
public class JiffleScriptListProcess implements RasterProcess {
