 ...
 */
@DescribeProcess(title = "Jiffle Script", description = "Returns a raster algebra output from a Coverage and a Jiffle script.The Process executes the script on the input coverage.")
public class JiffleScriptProcess implements RasterProcess {
