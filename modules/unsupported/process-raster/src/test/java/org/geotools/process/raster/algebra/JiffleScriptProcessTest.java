 ...
 */
package org.geotools.process.raster.algebra;
 ...
 * 
 */
public class JiffleScriptProcessTest {
    ...
    private static final String JIFFLE_SCRIPT_PATH = "script_jiffle";

    private static final String JIFFLE_SCRIPT_2_PATH = "script_jiffle_2";
    ...
    public static void setup() throws FileNotFoundException, IOException {
        ...
        if (testCoverage1 == null) {
            ...
            try {
                final File input = new File(JiffleScriptProcessTest.class.getResource(IMAGE_NAME_1).getPath());
        ...
        if (testCoverage2 == null) {
            ...
            try {
                final File input = new File(JiffleScriptProcessTest.class.getResource(IMAGE_NAME_2).getPath());
                reader = format.getReader(input);
        ...
        if (testCoverage3 == null) {
            ...
            try {
                final File input = new File(JiffleScriptProcessTest.class.getResource(IMAGE_NAME_3).getPath());
                reader = format.getReader(input);
    ...
    public void testSimpleScript() throws Exception {
        if (testCoverage1 != null) {
            // Script selection
            String script = FileUtils.readFileToString(new File(JiffleScriptProcessTest.class.getResource(JIFFLE_SCRIPT_PATH).getPath()));
            // Process calculation
    ...
    public void testOnAllBandsMultiScripts() throws Exception {
        ...
        if (testCoverage3 != null) {
            ...
            String script = FileUtils.readFileToString(new File(JiffleScriptProcessTest.class.getResource(JIFFLE_SCRIPT_PATH).getPath()));
            // Script2 selection
            String script2 = FileUtils.readFileToString(new File(JiffleScriptProcessTest.class.getResource(JIFFLE_SCRIPT_2_PATH).getPath()));
            // Process calculation
            List<String> scripts = new ArrayList<String>(1);
            scripts.add(script);
            scripts.add(script2);
