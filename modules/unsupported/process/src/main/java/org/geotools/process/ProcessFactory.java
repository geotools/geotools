...
public interface ProcessFactory extends OptionalFactory {
     ...
     *
     * <p>This name is used to advertise the availability of a Process in a WPS; while the Title and Description will
     * change depending on the users locale; this name will be consistent. It is up to the implementor to ensure this
     * name is unique
     *
     ...
     *
     * <p>Please note that this title is *not* stable across locale; if you want to remember a ProcessFactory between
     * runs please use getName (which is dependent on the implementor to guarantee uniqueness) or use the classname
     *
    ...
    /**
     * It is up to the process implementors to implement progress on the task, this method is used to see if the process
     * has progress monitoring implemented
     *
     * @param name the process identifier
