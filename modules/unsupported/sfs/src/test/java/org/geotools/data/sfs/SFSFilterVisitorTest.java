...
public class SFSFilterVisitorTest extends TestCase {
    ...
    public void testBBOX() throws Exception {
        ...
        assertEquals(
                URL_LAYER_ASIA + "?bbox=0.0,0.0,10.0,10.0",
    ...
    public void testDWithin() throws Exception {
        ...
        visitor.finish(builder, false);
        assertEquals(
                URL_LAYER_ASIA + "?epsg=&lat=0.1&lon=100.1&tolerance=10.0",
                URLDecoder.decode(builder.toString(), "UTF-8"));
    }
    ...
    public void testIntersect() throws Exception {
        ...
        visitor.finish(builder, false);
        assertEquals(
                URL_LAYER_ASIA + "?geometry={\"type\":\"Point\",\"coordinates\":[100.1,0.1]}",
                URLDecoder.decode(builder.toString(), "UTF-8"));
    }
    ...
    public void testPropertyIsLike() throws Exception {
        ...
        PropertyIsLike filter =
                FF.like(FF.property(PROPERTY_NAME), PROPERTY_VALUE, "%", "_", "\\", true);
        visitor.visit(filter, null);
        visitor.finish(builder, false);
        assertEquals(
                URL_LAYER_ASIA
    ...
    public void testHints() throws Exception {
        ...
        assertEquals(
                "aProperty__lt=342&queryable=aProperty&hints=first:a%3Db;second:a%25b", result);
    }
}
