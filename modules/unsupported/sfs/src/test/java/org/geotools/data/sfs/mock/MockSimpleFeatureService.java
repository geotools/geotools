 ...
 *
 * <p>http://localhost:8082/simplefeatureservice/capabilities
 ...
 *
 * <p>----- Following commands can be used to test mockup-service at terminal curl -i -H "Accept:
 * application/json" http://localhost:8082/simplefeatureservice/data/layerAsia?mode=features curl -i
 * -H "Accept: application/json"
 * http://localhost:8082/simplefeatureservice/data/layerAsia?mode=count curl -i -H "Accept:
 * application/json" http://localhost:8082/simplefeatureservice/data/layerAsia?mode=bounds curl -i
 * -H "Accept: application/json" -X POST -d "mode=bounds"
 * http://localhost:8082/simplefeatureservice/data/layerAsia curl -i -H "Accept: application/json"
 * http://localhost:8082/simplefeatureservice/data/layerAsia/tiger_roads.1
 *
 * <p>-----
 *
 * <p>There are not test cases for this project as you can just fire up your favorite browser and
...
public class MockSimpleFeatureService extends Application {
                ...
                new Restlet() {
                    ...
                    public void handle(Request request, Response response) {
                        ...
                        stringBuilder.append(
                                "<head><title>Mockup Service to test OpenDataStore</title></head>");
                        ...
                        response.setEntity(
                                new StringRepresentation(
                                        stringBuilder.toString(), MediaType.APPLICATION_JSON));
                    }
                };
    ...
    public static void main(String[] args) {
        try {
            ...
            component
                    .getDefaultHost()
                    .attach("/simplefeatureservice", new MockSimpleFeatureService());
