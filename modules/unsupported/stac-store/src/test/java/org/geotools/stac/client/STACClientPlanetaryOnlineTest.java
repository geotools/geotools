...
public class STACClientPlanetaryOnlineTest extends AbstractSTACClientOnlineTest {
    ...
    /**
     * Funny enough, there are several images recorded at the same time, down to the microsecond.
     * Using a BBOX too to filter them down to one. The image is also split into quadrants, so there
     * is like 9 of them anyways
     *
     * @throws IOException
     */
    @Test
