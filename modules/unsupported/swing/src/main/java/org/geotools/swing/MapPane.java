...
public interface MapPane {
    ...
    /**
     * Gets the {@code MapConent} instance containing the layers being displayed by this map pane.
     *
    ...
    /**
     * Sets the {@code MapContent} instance containing the layers to display.
     *
