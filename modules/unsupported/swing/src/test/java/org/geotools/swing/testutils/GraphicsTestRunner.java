...
/**
 * A test runner that will skip tests if the build is headless or if the {@code
 * org.geotools.test.interactive} system property is {@code false} or undefined. To use this runner,
