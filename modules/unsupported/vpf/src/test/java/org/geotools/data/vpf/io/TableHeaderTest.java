...
/**
 * File <code>TableHeaderTest.java</code> is automaticaly generated by 'unittestsgen' application.
 * Code generator is created for java sources and for 'junit' package by "Artur Hefczyc"
 * <kobit@users.sourceforge.net><br>
 * You should fulfil test methods with proper code for testing purpose. All methods where you should
 * put your code are below and their names starts with 'test'.<br>
 ...
 * </pre>
 *   <li>But the most prefered way is to run all tests from <em>Ant</em> just after compilation
 *       process finished.<br>
 *       To do it. You need:
 *       <ol>
 *         <li>Ant package from <a href="http://jakarta.apache.org/">Ant</a>
 *         <li>JUnit package from <a href="http://www.junit.org/">JUnit</a>
 *         <li>Put some code in your <code>build.xml</code> file to tell Ant how to test your
 *             package. Sample code for Ant's <code>build.xml</code> you can find in created file:
 *             <code>sample-junit-build.xml</code>. And remember to have <code>junit.jar</code> in
 *             CLASSPATH <b>before</b> you run Ant. To generate reports by ant you must have <code>
