...
public final class DataTestSupport {
    ...
    public static final TestDataType GEOS_CURVE_ROADS = new TestDataType(
            "geoserver", new QName("http://www.openplans.org/spearfish",
                    "curveroads"), "sf:curveroads", "EPSG:26713");
