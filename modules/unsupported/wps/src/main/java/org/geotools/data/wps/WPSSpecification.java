...
public abstract class WPSSpecification extends Specification {
    ...
    /**
     * Creates a DescribeProcess request which can be used to retrieve information about a specific
     * process on the WPS Server.
     *
    ...
    public abstract DataType createBoundingBoxInputValue(
            String crs, int dimensions, List<Double> lowerCorner, List<Double> upperCorner);

    public abstract ResponseFormType createResponseForm(
            ResponseDocumentType responseDoc, OutputDefinitionType rawOutput);

    public abstract ResponseDocumentType createResponseDocumentType(
