...
public class WPSUtils {
    ...
    public static Map<String, Parameter<?>> createInputParamMap(ProcessDescriptionType processDesc,
        ...
        while (iterator.hasNext()) {
            ...
            InternationalString title = Text.text(idt
                    .getTitle().getValue());
            InternationalString description = Text.text( isAbstractNull(idt) ? "" :
            		idt.getAbstract().getValue());
    ...
    public static Map<String, Parameter<?>> createOutputParamMap(
        ...
        while (iterator.hasNext()) {
            ...
            // create the parameter
            InternationalString description = Text.text(isAbstractNull(odt)? "" : 
            		odt.getAbstract().getValue());
